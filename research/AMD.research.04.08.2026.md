...
Signed file: `AMD.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $518.58 (2026-08-04, ~15-min delayed) |
| Market cap | — |
...
|---|---|---|
| Technical momentum | High | 1Y +202.03%; price +64.86% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 37.26, EV/Sales 20.87. |
...
| Dow Jones Futures: SpaceX, AMD, Arista Lead Earnings Movers After S&P 500 Jumps To High | Investor's Business Daily | 2026-08-04 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $518.58; 52w high $580.91 (-10.73%); 52w low $151.14 (+243.11%) |
| Trend | +64.86% vs SMA200, +0.83% vs SMA50, +1.32% vs SMA20 |
| Momentum | RSI(14) 52.3 (neutral) |
| Volatility | ATR(14) 40.39 (~7.8% of price); beta 2.49 |
...
| Valuation | P/E 172.86, forward P/E 37.26, P/S —, P/B 13.11 | EV/Sales 20.87, EV/EBITDA 105.22 |
...
- **Valuation risk:** Forward P/E 37.26, EV/Sales 20.87. Multiple compression is the main downside if growth disappoints.
...
| P/B | 13.11 | Analyst rec (1=buy..5=sell) | 1.5 |
