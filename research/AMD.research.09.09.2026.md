...
Signed file: `AMD.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $521.09 (2026-09-09, ~15-min delayed) |
| Market cap | $850.67B |
...
|---|---|---|
| Dow Jones Futures: Oil Prices Keep Rising But Market Hasn't Broken Yet. Inflation Data Due. | Investor's Business Daily | 2026-09-09 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $521.09; 52w high $580.91 (-10.30%); 52w low $155.67 (+234.74%) |
| Trend | +51.54% vs SMA200, +4.51% vs SMA50, +8.71% vs SMA20 |
| Momentum | RSI(14) 60.4 (neutral) |
| Volatility | ATR(14) 23.22 (~4.5% of price); beta 2.48 |
...
|---|---|---|---|
| Price | $521.09 | EV/Sales | 19.77 |
| Market cap | $850.67B | EV/EBITDA | 85.42 |
| Beta | 2.48 | Gross margin | 55.72% |
| RSI(14) | 60.4 | Operating margin | 17.25% |
| ATR(14) | 23.22 | Profit margin | 15.58% |
| SMA20 dist | +8.71% | ROA | 5.13% |
| SMA50 dist | +4.51% | ROE | 10.20% |
| SMA200 dist | +51.54% | Revenue (ttm) | $41.31B |
