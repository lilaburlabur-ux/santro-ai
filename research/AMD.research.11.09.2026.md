...
Signed file: `AMD.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $516.13 (2026-09-11, ~15-min delayed) |
| Market cap | $842.57B |
...
|---|---|---|
| Technical momentum | High | 1Y +223.51%; price +48.78% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 33.28, EV/Sales 19.69. |
| Risk level | High | Beta 2.48, ATR 4.4% of price, short float 2.57%. |
...
| The Better Nvidia Killer: Broadcom or AMD? | 24/7 Wall St. | 2026-09-11 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $516.13; 52w high $580.91 (-11.15%); 52w low $155.67 (+231.55%) |
| Trend | +48.78% vs SMA200, +3.94% vs SMA50, +7.07% vs SMA20 |
| Momentum | RSI(14) 58.0 (neutral) |
| Volatility | ATR(14) 22.64 (~4.4% of price); beta 2.48 |
...
- **Valuation risk:** Forward P/E 33.28, EV/Sales 19.69. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.48, ATR 4.4% of price, short float 2.57%. Size positions accordingly.
...
|---|---|---|---|
| Price | $516.13 | EV/Sales | 19.69 |
| Market cap | $842.57B | EV/EBITDA | 85.05 |
| Beta | 2.48 | Gross margin | 55.72% |
| RSI(14) | 58.0 | Operating margin | 17.25% |
| ATR(14) | 22.64 | Profit margin | 15.58% |
| SMA20 dist | +7.07% | ROA | 5.13% |
| SMA50 dist | +3.94% | ROE | 10.20% |
| SMA200 dist | +48.78% | Revenue (ttm) | $41.31B |
| 52W high | $580.91 | Revenue growth y/y | 50.10% |
| 52W low | $155.67 | Inst. ownership | 75.39% |
| P/E (ttm) | 131.33 | Insider ownership | 0.42% |
| Forward P/E | 33.28 | Short float | 2.57% |
| PEG (trailing) | 0.51 | Avg volume | 25,687,543 |
| P/S | 20.40 | Employees | 31,000 |
| P/B | 12.53 | Analyst rec (1=buy..5=sell) | 1.5 |
