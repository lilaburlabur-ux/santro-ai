...
Signed file: `AMD.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $493.41 (2026-09-14, ~15-min delayed) |
| Market cap | $805.48B |
...
|---|---|---|
| Technical momentum | High | 1Y +216.96%; price +41.66% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 31.81, EV/Sales 20.18. |
| Risk level | High | Beta 2.48, ATR 4.8% of price, short float 2.57%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $493.41; 52w high $580.91 (-15.06%); 52w low $157.39 (+213.50%) |
| Trend | +41.66% vs SMA200, -0.53% vs SMA50, +2.58% vs SMA20 |
| Momentum | RSI(14) 51.5 (neutral) |
| Volatility | ATR(14) 23.58 (~4.8% of price); beta 2.48 |
...
| Valuation | P/E 125.87, forward P/E 31.81, P/S 19.50, P/B 11.98 | EV/Sales 20.18, EV/EBITDA 87.19 |
...
- **Valuation risk:** Forward P/E 31.81, EV/Sales 20.18. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.48, ATR 4.8% of price, short float 2.57%. Size positions accordingly.
...
|---|---|---|---|
| Price | $493.41 | EV/Sales | 20.18 |
| Market cap | $805.48B | EV/EBITDA | 87.19 |
| Beta | 2.48 | Gross margin | 55.72% |
| RSI(14) | 51.5 | Operating margin | 17.25% |
| ATR(14) | 23.58 | Profit margin | 15.58% |
| SMA20 dist | +2.58% | ROA | 5.13% |
| SMA50 dist | -0.53% | ROE | 10.20% |
| SMA200 dist | +41.66% | Revenue (ttm) | $41.31B |
| 52W high | $580.91 | Revenue growth y/y | 50.10% |
| 52W low | $157.39 | Inst. ownership | 75.38% |
| P/E (ttm) | 125.87 | Insider ownership | 0.42% |
| Forward P/E | 31.81 | Short float | 2.57% |
| PEG (trailing) | 0.53 | Avg volume | 25,485,840 |
| P/S | 19.50 | Employees | 31,000 |
| P/B | 11.98 | Analyst rec (1=buy..5=sell) | 1.5 |
