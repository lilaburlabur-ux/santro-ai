...
Signed file: `AMD.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $559.82 (2026-09-18, ~15-min delayed) |
| Market cap | $913.89B |
...
|---|---|---|
| Technical momentum | High | 1Y +251.73%; price +57.86% vs SMA200. |
| Fresh setup quality | Moderate / wait | -3.63% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 15.58%, revenue growth 50.10%. |
| Value attractiveness | Low (expensive) | Forward P/E 35.95, EV/Sales 21.33. |
| Risk level | High | Beta 2.48, ATR 4.3% of price, short float 2.57%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $559.82; 52w high $580.91 (-3.63%); 52w low $157.39 (+255.69%) |
| Trend | +57.86% vs SMA200, +12.90% vs SMA50, +14.07% vs SMA20 |
| Momentum | RSI(14) 65.4 (neutral) |
| Volatility | ATR(14) 24.00 (~4.3% of price); beta 2.48 |
| Setup perspective | -3.63% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 142.81, forward P/E 35.95, P/S 22.13, P/B 13.59 | EV/Sales 21.33, EV/EBITDA 92.14 |
...
- **Valuation risk:** Forward P/E 35.95, EV/Sales 21.33. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.48, ATR 4.3% of price, short float 2.57%. Size positions accordingly.
...
|---|---|---|---|
| Price | $559.82 | EV/Sales | 21.33 |
| Market cap | $913.89B | EV/EBITDA | 92.14 |
| Beta | 2.48 | Gross margin | 55.72% |
| RSI(14) | 65.4 | Operating margin | 17.25% |
| ATR(14) | 24.00 | Profit margin | 15.58% |
| SMA20 dist | +14.07% | ROA | 5.13% |
| SMA50 dist | +12.90% | ROE | 10.20% |
| SMA200 dist | +57.86% | Revenue (ttm) | $41.31B |
| 52W high | $580.91 | Revenue growth y/y | 50.10% |
| 52W low | $157.39 | Inst. ownership | 75.39% |
| P/E (ttm) | 142.81 | Insider ownership | 0.42% |
| Forward P/E | 35.95 | Short float | 2.57% |
| PEG (trailing) | 0.56 | Avg volume | 24,838,788 |
| P/S | 22.13 | Employees | 31,000 |
| P/B | 13.59 | Analyst rec (1=buy..5=sell) | 1.5 |
