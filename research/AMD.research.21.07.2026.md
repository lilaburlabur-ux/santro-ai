...
Signed file: `AMD.research.21.07.2026`

| Field | Value |
|---|---|
| Current price | $544.43 (2026-07-21, ~15-min delayed) |
| Market cap | $887.75B |
...
|---|---|---|
| Technical momentum | High | 1Y +246.79%; price +81.30% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 40.43, EV/Sales 21.70. |
| Risk level | High | Beta 2.47, ATR 6.9% of price, short float 2.56%. |
...
| Advanced Micro Devices (AMD) Following Microsoft AI Deal Faces A Fully Valued Debate | Simply Wall St. | 2026-07-21 |
| Chip Stocks Are Rebounding - Should Investors Buy Intel (INTC) Before Q2 Earnings? | Zacks | 2026-07-21 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $544.43; 52w high $580.91 (-6.28%); 52w low $151.14 (+260.22%) |
| Trend | +81.30% vs SMA200, +8.14% vs SMA50, +2.54% vs SMA20 |
| Momentum | RSI(14) 54.8 (neutral) |
| Volatility | ATR(14) 37.47 (~6.9% of price); beta 2.47 |
...
| Valuation | P/E 180.27, forward P/E 40.43, P/S —, P/B 13.77 | EV/Sales 21.70, EV/EBITDA 109.37 |
| Growth expectations | Earnings growth 91.20%, EPS q/q 95.10% | Analyst mean target $541.66 (47 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 73.29% |
...
- **Valuation risk:** Forward P/E 40.43, EV/Sales 21.70. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.47, ATR 6.9% of price, short float 2.56%. Size positions accordingly.
...
|---|---|---|---|
| Price | $544.43 | EV/Sales | 21.70 |
| Market cap | $887.75B | EV/EBITDA | 109.37 |
| Beta | 2.47 | Gross margin | 53.06% |
| RSI(14) | 54.8 | Operating margin | 14.40% |
| ATR(14) | 37.47 | Profit margin | 13.37% |
| SMA20 dist | +2.54% | ROA | 3.65% |
| SMA50 dist | +8.14% | ROE | 8.06% |
| SMA200 dist | +81.30% | Revenue (ttm) | $37.45B |
| 52W high | $580.91 | Revenue growth y/y | 37.80% |
| 52W low | $151.14 | Inst. ownership | 73.29% |
| P/E (ttm) | 180.27 | Insider ownership | 0.40% |
| Forward P/E | 40.43 | Short float | 2.56% |
| PEG (trailing) | 1.18 | Avg volume | 35,523,326 |
| P/S | — | Employees | 31,000 |
| P/B | 13.77 | Analyst rec (1=buy..5=sell) | 1.5 |
