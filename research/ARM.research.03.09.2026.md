...
Signed file: `ARM.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $242.59 (2026-09-03, ~15-min delayed) |
| Market cap | $259.09B |
...
|---|---|---|
| Technical momentum | High | 1Y +84.59%; price +20.56% vs SMA200. |
| Fresh setup quality | Poor / broken | -44.80% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 20.25%, revenue growth 22.40%. |
| Value attractiveness | Low (expensive) | Forward P/E 79.26, EV/Sales 47.99. |
| Risk level | High | Beta 3.91, ATR 6.9% of price, short float 12.57%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $242.59; 52w high $439.46 (-44.80%); 52w low $104.55 (+132.03%) |
| Trend | +20.56% vs SMA200, -11.94% vs SMA50, -4.82% vs SMA20 |
| Momentum | RSI(14) 43.2 (neutral) |
| Volatility | ATR(14) 16.85 (~6.9% of price); beta 3.91 |
| Setup perspective | -44.80% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 245.04, forward P/E 79.26, P/S 50.25, P/B 30.02 | EV/Sales 47.99, EV/EBITDA 232.61 |
...
- **Valuation risk:** Forward P/E 79.26, EV/Sales 47.99. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 3.91, ATR 6.9% of price, short float 12.57%. Size positions accordingly.
...
|---|---|---|---|
| Price | $242.59 | EV/Sales | 47.99 |
| Market cap | $259.09B | EV/EBITDA | 232.61 |
| Beta | 3.91 | Gross margin | 97.54% |
| RSI(14) | 43.2 | Operating margin | 7.60% |
| ATR(14) | 16.85 | Profit margin | 20.25% |
| SMA20 dist | -4.82% | ROA | 5.42% |
| SMA50 dist | -11.94% | ROE | 13.35% |
| SMA200 dist | +20.56% | Revenue (ttm) | $5.16B |
| 52W high | $439.46 | Revenue growth y/y | 22.40% |
| 52W low | $104.55 | Inst. ownership | 96.22% |
| P/E (ttm) | 245.04 | Insider ownership | 0.07% |
| Forward P/E | 79.26 | Short float | 12.57% |
| PEG (trailing) | 1.93 | Avg volume | 7,076,826 |
| P/S | 50.25 | Employees | 9,584 |
| P/B | 30.02 | Analyst rec (1=buy..5=sell) | 2.0 |
