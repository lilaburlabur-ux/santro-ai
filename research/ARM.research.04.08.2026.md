...
Signed file: `ARM.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $280.56 (2026-08-04, ~15-min delayed) |
| Market cap | $299.64B |
...
|---|---|---|
| Technical momentum | High | 1Y +103.92%; price +47.06% vs SMA200. |
| Fresh setup quality | Poor / broken | -36.16% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 20.25%, revenue growth 22.40%. |
| Value attractiveness | Low (expensive) | Forward P/E 91.41, EV/Sales 48.86. |
| Risk level | High | Beta 3.91, ATR 9.8% of price, short float 12.02%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $280.56; 52w high $439.46 (-36.16%); 52w low $104.55 (+168.35%) |
| Trend | +47.06% vs SMA200, -13.39% vs SMA50, +2.76% vs SMA20 |
| Momentum | RSI(14) 49.8 (neutral) |
| Volatility | ATR(14) 27.46 (~9.8% of price); beta 3.91 |
| Setup perspective | -36.16% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 286.29, forward P/E 91.41, P/S 58.11, P/B 36.03 | EV/Sales 48.86, EV/EBITDA 236.83 |
...
- **Valuation risk:** Forward P/E 91.41, EV/Sales 48.86. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 3.91, ATR 9.8% of price, short float 12.02%. Size positions accordingly.
...
|---|---|---|---|
| Price | $280.56 | EV/Sales | 48.86 |
| Market cap | $299.64B | EV/EBITDA | 236.83 |
| Beta | 3.91 | Gross margin | 97.54% |
| RSI(14) | 49.8 | Operating margin | 7.60% |
| ATR(14) | 27.46 | Profit margin | 20.25% |
| SMA20 dist | +2.76% | ROA | 5.42% |
| SMA50 dist | -13.39% | ROE | 13.35% |
| SMA200 dist | +47.06% | Revenue (ttm) | $5.16B |
| 52W high | $439.46 | Revenue growth y/y | 22.40% |
| 52W low | $104.55 | Inst. ownership | 95.42% |
| P/E (ttm) | 286.29 | Insider ownership | 0.07% |
| Forward P/E | 91.41 | Short float | 12.02% |
| PEG (trailing) | 1.97 | Avg volume | 10,387,034 |
| P/S | 58.11 | Employees | 9,584 |
| P/B | 36.03 | Analyst rec (1=buy..5=sell) | 1.9 |
