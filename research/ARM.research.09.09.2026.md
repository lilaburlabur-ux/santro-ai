...
Signed file: `ARM.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $264.23 (2026-09-09, ~15-min delayed) |
| Market cap | $282.20B |
...
|---|---|---|
| Technical momentum | High | 1Y +89.90%; price +30.14% vs SMA200. |
| Fresh setup quality | Poor / broken | -39.87% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 20.25%, revenue growth 22.40%. |
| Value attractiveness | Low (expensive) | Forward P/E 86.24, EV/Sales 53.51. |
| Risk level | High | Beta 3.89, ATR 6.2% of price, short float 12.57%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $264.23; 52w high $439.46 (-39.87%); 52w low $104.55 (+152.73%) |
| Trend | +30.14% vs SMA200, -2.33% vs SMA50, +4.53% vs SMA20 |
| Momentum | RSI(14) 53.4 (neutral) |
| Volatility | ATR(14) 16.30 (~6.2% of price); beta 3.89 |
| Setup perspective | -39.87% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 272.40, forward P/E 86.24, P/S 54.73, P/B 32.70 | EV/Sales 53.51, EV/EBITDA 259.39 |
| Growth expectations | Earnings growth 108.30%, EPS q/q 107.70% | Analyst mean target $288.42 (39 analysts) |
...
- **Valuation risk:** Forward P/E 86.24, EV/Sales 53.51. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 3.89, ATR 6.2% of price, short float 12.57%. Size positions accordingly.
...
|---|---|---|---|
| Price | $264.23 | EV/Sales | 53.51 |
| Market cap | $282.20B | EV/EBITDA | 259.39 |
| Beta | 3.89 | Gross margin | 97.54% |
| RSI(14) | 53.4 | Operating margin | 7.60% |
| ATR(14) | 16.30 | Profit margin | 20.25% |
| SMA20 dist | +4.53% | ROA | 5.42% |
| SMA50 dist | -2.33% | ROE | 13.35% |
| SMA200 dist | +30.14% | Revenue (ttm) | $5.16B |
| 52W high | $439.46 | Revenue growth y/y | 22.40% |
| 52W low | $104.55 | Inst. ownership | 96.23% |
| P/E (ttm) | 272.40 | Insider ownership | 0.07% |
| Forward P/E | 86.24 | Short float | 12.57% |
| PEG (trailing) | 2.15 | Avg volume | 6,625,853 |
| P/S | 54.73 | Employees | 9,584 |
