...
Signed file: `ARM.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $254.18 (2026-09-10, ~15-min delayed) |
| Market cap | $271.46B |
...
|---|---|---|
| Technical momentum | High | 1Y +80.53%; price +24.82% vs SMA200. |
| Fresh setup quality | Poor / broken | -42.16% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 20.25%, revenue growth 22.40%. |
| Value attractiveness | Low (expensive) | Forward P/E 82.96, EV/Sales 54.07. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $254.18; 52w high $439.46 (-42.16%); 52w low $104.55 (+143.12%) |
| Trend | +24.82% vs SMA200, -5.34% vs SMA50, +0.90% vs SMA20 |
| Momentum | RSI(14) 48.6 (neutral) |
| Volatility | ATR(14) 16.06 (~6.3% of price); beta 3.89 |
| Setup perspective | -42.16% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 259.37, forward P/E 82.96, P/S 52.65, P/B 31.45 | EV/Sales 54.07, EV/EBITDA 262.10 |
...
- **Valuation risk:** Forward P/E 82.96, EV/Sales 54.07. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $254.18 | EV/Sales | 54.07 |
| Market cap | $271.46B | EV/EBITDA | 262.10 |
| Beta | 3.89 | Gross margin | 97.54% |
| RSI(14) | 48.6 | Operating margin | 7.60% |
| ATR(14) | 16.06 | Profit margin | 20.25% |
| SMA20 dist | +0.90% | ROA | 5.42% |
| SMA50 dist | -5.34% | ROE | 13.35% |
| SMA200 dist | +24.82% | Revenue (ttm) | $5.16B |
| 52W high | $439.46 | Revenue growth y/y | 22.40% |
| 52W low | $104.55 | Inst. ownership | 96.23% |
| P/E (ttm) | 259.37 | Insider ownership | 0.07% |
| Forward P/E | 82.96 | Short float | 12.57% |
| PEG (trailing) | 2.17 | Avg volume | 6,549,477 |
| P/S | 52.65 | Employees | 9,584 |
| P/B | 31.45 | Analyst rec (1=buy..5=sell) | 2.0 |
