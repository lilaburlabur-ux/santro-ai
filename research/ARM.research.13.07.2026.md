...
Signed file: `ARM.research.13.07.2026`

| Field | Value |
|---|---|
| Current price | $298.99 (2026-07-13, ~15-min delayed) |
| Market cap | $319.34B |
...
|---|---|---|
| Technical momentum | High | 1Y +101.27%; price +64.17% vs SMA200. |
| Fresh setup quality | Poor / broken | -31.96% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 18.37%, revenue growth 20.10%. |
| Value attractiveness | Low (expensive) | Forward P/E 97.05, EV/Sales 69.57. |
| Risk level | High | Beta 3.77, ATR 10.5% of price, short float 11.85%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $298.99; 52w high $439.46 (-31.96%); 52w low $104.55 (+185.98%) |
| Trend | +64.17% vs SMA200, -3.91% vs SMA50, -15.63% vs SMA20 |
| Momentum | RSI(14) 43.1 (neutral) |
| Volatility | ATR(14) 31.36 (~10.5% of price); beta 3.77 |
| Setup perspective | -31.96% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 355.94, forward P/E 97.05, P/S 64.91, P/B 38.40 | EV/Sales 69.57, EV/EBITDA 321.50 |
...
- **Valuation risk:** Forward P/E 97.05, EV/Sales 69.57. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 3.77, ATR 10.5% of price, short float 11.85%. Size positions accordingly.
...
|---|---|---|---|
| Price | $298.99 | EV/Sales | 69.57 |
| Market cap | $319.34B | EV/EBITDA | 321.50 |
| Beta | 3.77 | Gross margin | 97.54% |
| RSI(14) | 43.1 | Operating margin | 29.53% |
| ATR(14) | 31.36 | Profit margin | 18.37% |
| SMA20 dist | -15.63% | ROA | 5.78% |
| SMA50 dist | -3.91% | ROE | 11.95% |
| SMA200 dist | +64.17% | Revenue (ttm) | $4.92B |
| 52W high | $439.46 | Revenue growth y/y | 20.10% |
| 52W low | $104.55 | Inst. ownership | 95.94% |
| P/E (ttm) | 355.94 | Insider ownership | 0.07% |
| Forward P/E | 97.05 | Short float | 11.85% |
| PEG (trailing) | 2.67 | Avg volume | 11,085,239 |
| P/S | 64.91 | Employees | 9,584 |
| P/B | 38.40 | Analyst rec (1=buy..5=sell) | 1.9 |
