...
Signed file: `ARM.research.14.07.2026`

| Field | Value |
|---|---|
| Current price | $281.17 (2026-07-14, ~15-min delayed) |
| Market cap | $300.31B |
...
|---|---|---|
| Technical momentum | High | 1Y +92.66%; price +53.80% vs SMA200. |
| Fresh setup quality | Poor / broken | -36.02% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 18.37%, revenue growth 20.10%. |
| Value attractiveness | Low (expensive) | Forward P/E 91.25, EV/Sales 64.28. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $281.17; 52w high $439.46 (-36.02%); 52w low $104.55 (+168.93%) |
| Trend | +53.80% vs SMA200, -10.04% vs SMA50, -19.52% vs SMA20 |
| Momentum | RSI(14) 40.0 (neutral) |
| Volatility | ATR(14) 31.57 (~11.2% of price); beta 3.77 |
| Setup perspective | -36.02% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 334.73, forward P/E 91.25, P/S 61.04, P/B 36.11 | EV/Sales 64.28, EV/EBITDA 297.02 |
...
- **Valuation risk:** Forward P/E 91.25, EV/Sales 64.28. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $281.17 | EV/Sales | 64.28 |
| Market cap | $300.31B | EV/EBITDA | 297.02 |
| Beta | 3.77 | Gross margin | 97.54% |
| RSI(14) | 40.0 | Operating margin | 29.53% |
| ATR(14) | 31.57 | Profit margin | 18.37% |
| SMA20 dist | -19.52% | ROA | 5.78% |
| SMA50 dist | -10.04% | ROE | 11.95% |
| SMA200 dist | +53.80% | Revenue (ttm) | $4.92B |
| 52W high | $439.46 | Revenue growth y/y | 20.10% |
| 52W low | $104.55 | Inst. ownership | 95.94% |
| P/E (ttm) | 334.73 | Insider ownership | 0.07% |
| Forward P/E | 91.25 | Short float | 11.85% |
| PEG (trailing) | 2.47 | Avg volume | 11,068,255 |
| P/S | 61.04 | Employees | 9,584 |
| P/B | 36.11 | Analyst rec (1=buy..5=sell) | 1.9 |
