...
Signed file: `ARM.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $243.98 (2026-09-16, ~15-min delayed) |
| Market cap | $260.57B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +58.57%; price +18.47% vs SMA200. |
| Fresh setup quality | Poor / broken | -44.48% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 20.25%, revenue growth 22.40%. |
| Value attractiveness | Low (expensive) | Forward P/E 80.01, EV/Sales 49.43. |
| Risk level | High | Beta 3.89, ATR 6.7% of price, short float 11.52%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $243.98; 52w high $439.46 (-44.48%); 52w low $104.55 (+133.36%) |
| Trend | +18.47% vs SMA200, -7.17% vs SMA50, -1.32% vs SMA20 |
| Momentum | RSI(14) 45.2 (neutral) |
| Volatility | ATR(14) 16.25 (~6.7% of price); beta 3.89 |
| Setup perspective | -44.48% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 246.44, forward P/E 80.01, P/S 50.54, P/B 30.19 | EV/Sales 49.43, EV/EBITDA 239.61 |
...
- **Valuation risk:** Forward P/E 80.01, EV/Sales 49.43. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 3.89, ATR 6.7% of price, short float 11.52%. Size positions accordingly.
...
|---|---|---|---|
| Price | $243.98 | EV/Sales | 49.43 |
| Market cap | $260.57B | EV/EBITDA | 239.61 |
| Beta | 3.89 | Gross margin | 97.54% |
| RSI(14) | 45.2 | Operating margin | 7.60% |
| ATR(14) | 16.25 | Profit margin | 20.25% |
| SMA20 dist | -1.32% | ROA | 5.42% |
| SMA50 dist | -7.17% | ROE | 13.35% |
| SMA200 dist | +18.47% | Revenue (ttm) | $5.16B |
| 52W high | $439.46 | Revenue growth y/y | 22.40% |
| 52W low | $104.55 | Inst. ownership | 96.21% |
| P/E (ttm) | 246.44 | Insider ownership | 0.07% |
| Forward P/E | 80.01 | Short float | 11.52% |
| PEG (trailing) | 1.99 | Avg volume | 6,008,819 |
| P/S | 50.54 | Employees | 9,584 |
| P/B | 30.19 | Analyst rec (1=buy..5=sell) | 2.0 |
