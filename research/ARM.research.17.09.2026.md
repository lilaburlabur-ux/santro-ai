...
Signed file: `ARM.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $264.90 (2026-09-17, ~15-min delayed) |
| Market cap | $282.91B |
...
|---|---|---|
| Technical momentum | High | 1Y +72.18%; price +28.23% vs SMA200. |
| Fresh setup quality | Poor / broken | -39.72% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 20.25%, revenue growth 22.40%. |
| Value attractiveness | Low (expensive) | Forward P/E 86.72, EV/Sales 49.88. |
| Risk level | High | Beta 3.89, ATR 6.3% of price, short float 11.52%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $264.90; 52w high $439.46 (-39.72%); 52w low $104.55 (+153.37%) |
| Trend | +28.23% vs SMA200, +1.07% vs SMA50, +6.81% vs SMA20 |
| Momentum | RSI(14) 54.0 (neutral) |
| Volatility | ATR(14) 16.73 (~6.3% of price); beta 3.89 |
| Setup perspective | -39.72% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 270.31, forward P/E 86.72, P/S 54.87, P/B 32.78 | EV/Sales 49.88, EV/EBITDA 241.77 |
...
- **Valuation risk:** Forward P/E 86.72, EV/Sales 49.88. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 3.89, ATR 6.3% of price, short float 11.52%. Size positions accordingly.
...
|---|---|---|---|
| Price | $264.90 | EV/Sales | 49.88 |
| Market cap | $282.91B | EV/EBITDA | 241.77 |
| Beta | 3.89 | Gross margin | 97.54% |
| RSI(14) | 54.0 | Operating margin | 7.60% |
| ATR(14) | 16.73 | Profit margin | 20.25% |
| SMA20 dist | +6.81% | ROA | 5.42% |
| SMA50 dist | +1.07% | ROE | 13.35% |
| SMA200 dist | +28.23% | Revenue (ttm) | $5.16B |
| 52W high | $439.46 | Revenue growth y/y | 22.40% |
| 52W low | $104.55 | Inst. ownership | 96.21% |
| P/E (ttm) | 270.31 | Insider ownership | 0.07% |
| Forward P/E | 86.72 | Short float | 11.52% |
| PEG (trailing) | 2.00 | Avg volume | 5,863,056 |
| P/S | 54.87 | Employees | 9,584 |
| P/B | 32.78 | Analyst rec (1=buy..5=sell) | 2.0 |
