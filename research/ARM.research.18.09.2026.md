...
Signed file: `ARM.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $275.61 (2026-09-18, ~15-min delayed) |
| Market cap | $294.35B |
...
|---|---|---|
| Technical momentum | High | 1Y +79.70%; price +32.96% vs SMA200. |
| Fresh setup quality | Poor / broken | -37.28% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 20.25%, revenue growth 22.40%. |
| Value attractiveness | Low (expensive) | Forward P/E 90.22, EV/Sales 54.21. |
| Risk level | High | Beta 3.89, ATR 6.0% of price, short float 11.52%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $275.61; 52w high $439.46 (-37.28%); 52w low $104.55 (+163.62%) |
| Trend | +32.96% vs SMA200, +5.57% vs SMA50, +10.57% vs SMA20 |
| Momentum | RSI(14) 57.7 (neutral) |
| Volatility | ATR(14) 16.55 (~6.0% of price); beta 3.89 |
| Setup perspective | -37.28% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 281.23, forward P/E 90.22, P/S 57.09, P/B 34.11 | EV/Sales 54.21, EV/EBITDA 262.77 |
...
- **Valuation risk:** Forward P/E 90.22, EV/Sales 54.21. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 3.89, ATR 6.0% of price, short float 11.52%. Size positions accordingly.
...
|---|---|---|---|
| Price | $275.61 | EV/Sales | 54.21 |
| Market cap | $294.35B | EV/EBITDA | 262.77 |
| Beta | 3.89 | Gross margin | 97.54% |
| RSI(14) | 57.7 | Operating margin | 7.60% |
| ATR(14) | 16.55 | Profit margin | 20.25% |
| SMA20 dist | +10.57% | ROA | 5.42% |
| SMA50 dist | +5.57% | ROE | 13.35% |
| SMA200 dist | +32.96% | Revenue (ttm) | $5.16B |
| 52W high | $439.46 | Revenue growth y/y | 22.40% |
| 52W low | $104.55 | Inst. ownership | 96.21% |
| P/E (ttm) | 281.23 | Insider ownership | 0.07% |
| Forward P/E | 90.22 | Short float | 11.52% |
| PEG (trailing) | 2.18 | Avg volume | 5,411,116 |
| P/S | 57.09 | Employees | 9,584 |
| P/B | 34.11 | Analyst rec (1=buy..5=sell) | 2.0 |
