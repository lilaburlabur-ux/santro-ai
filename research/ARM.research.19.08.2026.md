...
Signed file: `ARM.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $249.34 (2026-08-19, ~15-min delayed) |
| Market cap | $266.29B |
...
|---|---|---|
| Technical momentum | High | 1Y +76.76%; price +26.98% vs SMA200. |
| Fresh setup quality | Poor / broken | -43.26% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 20.25%, revenue growth 22.40%. |
| Value attractiveness | Low (expensive) | Forward P/E 81.53, EV/Sales 51.81. |
| Risk level | High | Beta 3.91, ATR 9.0% of price, short float 11.61%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $249.34; 52w high $439.46 (-43.26%); 52w low $104.55 (+138.49%) |
| Trend | +26.98% vs SMA200, -18.28% vs SMA50, -5.28% vs SMA20 |
| Momentum | RSI(14) 40.8 (neutral) |
| Volatility | ATR(14) 22.43 (~9.0% of price); beta 3.91 |
| Setup perspective | -43.26% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 251.86, forward P/E 81.53, P/S 51.65, P/B 30.86 | EV/Sales 51.81, EV/EBITDA 251.15 |
...
- **Valuation risk:** Forward P/E 81.53, EV/Sales 51.81. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 3.91, ATR 9.0% of price, short float 11.61%. Size positions accordingly.
...
|---|---|---|---|
| Price | $249.34 | EV/Sales | 51.81 |
| Market cap | $266.29B | EV/EBITDA | 251.15 |
| Beta | 3.91 | Gross margin | 97.54% |
| RSI(14) | 40.8 | Operating margin | 7.60% |
| ATR(14) | 22.43 | Profit margin | 20.25% |
| SMA20 dist | -5.28% | ROA | 5.42% |
| SMA50 dist | -18.28% | ROE | 13.35% |
| SMA200 dist | +26.98% | Revenue (ttm) | $5.16B |
| 52W high | $439.46 | Revenue growth y/y | 22.40% |
| 52W low | $104.55 | Inst. ownership | 96.97% |
| P/E (ttm) | 251.86 | Insider ownership | 0.07% |
| Forward P/E | 81.53 | Short float | 11.61% |
| PEG (trailing) | 2.08 | Avg volume | 8,953,332 |
| P/S | 51.65 | Employees | 9,584 |
| P/B | 30.86 | Analyst rec (1=buy..5=sell) | 1.9 |
