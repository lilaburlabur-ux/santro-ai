...
Signed file: `ARM.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $250.72 (2026-08-20, ~15-min delayed) |
| Market cap | $267.77B |
...
|---|---|---|
| Technical momentum | High | 1Y +87.09%; price +27.42% vs SMA200. |
| Fresh setup quality | Poor / broken | -42.95% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 20.25%, revenue growth 22.40%. |
| Value attractiveness | Low (expensive) | Forward P/E 81.93, EV/Sales 50.99. |
| Risk level | High | Beta 3.91, ATR 8.6% of price, short float 11.61%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $250.72; 52w high $439.46 (-42.95%); 52w low $104.55 (+139.81%) |
| Trend | +27.42% vs SMA200, -17.43% vs SMA50, -4.16% vs SMA20 |
| Momentum | RSI(14) 41.4 (neutral) |
| Volatility | ATR(14) 21.47 (~8.6% of price); beta 3.91 |
| Setup perspective | -42.95% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 258.47, forward P/E 81.93, P/S 51.93, P/B 31.03 | EV/Sales 50.99, EV/EBITDA 247.15 |
| Growth expectations | Earnings growth 108.30%, EPS q/q 107.70% | Analyst mean target $286.08 (38 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 96.97% |
...
- **Valuation risk:** Forward P/E 81.93, EV/Sales 50.99. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 3.91, ATR 8.6% of price, short float 11.61%. Size positions accordingly.
...
|---|---|---|---|
| Price | $250.72 | EV/Sales | 50.99 |
| Market cap | $267.77B | EV/EBITDA | 247.15 |
| Beta | 3.91 | Gross margin | 97.54% |
| RSI(14) | 41.4 | Operating margin | 7.60% |
| ATR(14) | 21.47 | Profit margin | 20.25% |
| SMA20 dist | -4.16% | ROA | 5.42% |
| SMA50 dist | -17.43% | ROE | 13.35% |
| SMA200 dist | +27.42% | Revenue (ttm) | $5.16B |
| 52W high | $439.46 | Revenue growth y/y | 22.40% |
| 52W low | $104.55 | Inst. ownership | 96.97% |
| P/E (ttm) | 258.47 | Insider ownership | 0.07% |
| Forward P/E | 81.93 | Short float | 11.61% |
| PEG (trailing) | 2.05 | Avg volume | 8,727,940 |
| P/S | 51.93 | Employees | 9,584 |
| P/B | 31.03 | Analyst rec (1=buy..5=sell) | 1.9 |
