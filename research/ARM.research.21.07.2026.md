...
Signed file: `ARM.research.21.07.2026`

| Field | Value |
|---|---|
| Current price | $289.73 (2026-07-21, ~15-min delayed) |
| Market cap | $309.45B |
...
|---|---|---|
| Technical momentum | High | 1Y +84.85%; price +55.70% vs SMA200. |
| Fresh setup quality | Poor / broken | -34.07% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 18.37%, revenue growth 20.10%. |
| Value attractiveness | Low (expensive) | Forward P/E 94.15, EV/Sales 57.90. |
| Risk level | High | Beta 3.77, ATR 9.9% of price, short float 11.85%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $289.73; 52w high $439.46 (-34.07%); 52w low $104.55 (+177.12%) |
| Trend | +55.70% vs SMA200, -9.00% vs SMA50, -7.70% vs SMA20 |
| Momentum | RSI(14) 44.7 (neutral) |
| Volatility | ATR(14) 28.68 (~9.9% of price); beta 3.77 |
| Setup perspective | -34.07% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 336.90, forward P/E 94.15, P/S 62.90, P/B 37.21 | EV/Sales 57.90, EV/EBITDA 267.55 |
| Growth expectations | Earnings growth 47.90%, EPS q/q 49.00% | Analyst mean target $304.78 (37 analysts) |
...
- **Valuation risk:** Forward P/E 94.15, EV/Sales 57.90. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 3.77, ATR 9.9% of price, short float 11.85%. Size positions accordingly.
...
|---|---|---|---|
| Price | $289.73 | EV/Sales | 57.90 |
| Market cap | $309.45B | EV/EBITDA | 267.55 |
| Beta | 3.77 | Gross margin | 97.54% |
| RSI(14) | 44.7 | Operating margin | 29.53% |
| ATR(14) | 28.68 | Profit margin | 18.37% |
| SMA20 dist | -7.70% | ROA | 5.78% |
| SMA50 dist | -9.00% | ROE | 11.95% |
| SMA200 dist | +55.70% | Revenue (ttm) | $4.92B |
| 52W high | $439.46 | Revenue growth y/y | 20.10% |
| 52W low | $104.55 | Inst. ownership | 96.14% |
| P/E (ttm) | 336.90 | Insider ownership | 0.07% |
| Forward P/E | 94.15 | Short float | 11.85% |
| PEG (trailing) | 2.22 | Avg volume | 11,167,980 |
| P/S | 62.90 | Employees | 9,584 |
| P/B | 37.21 | Analyst rec (1=buy..5=sell) | 1.9 |
