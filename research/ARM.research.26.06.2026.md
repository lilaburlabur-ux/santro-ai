...
Signed file: `ARM.research.26.06.2026`

| Field | Value |
|---|---|
| Current price | $334.27 (2026-06-26, ~15-min delayed) |
| Market cap | $357.03B |
...
|---|---|---|
| Technical momentum | High | 1Y +112.49%; price +92.68% vs SMA200. |
| Fresh setup quality | Moderate / wait | -23.94% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 18.37%, revenue growth 20.10%. |
| Value attractiveness | Low (expensive) | Forward P/E 108.31, EV/Sales 74.85. |
| Risk level | High | Beta 3.79, ATR 10.5% of price, short float 11.26%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $334.27; 52w high $439.46 (-23.94%); 52w low $104.55 (+219.72%) |
| Trend | +92.68% vs SMA200, +17.17% vs SMA50, -10.83% vs SMA20 |
| Momentum | RSI(14) 48.4 (neutral) |
| Volatility | ATR(14) 35.16 (~10.5% of price); beta 3.79 |
| Setup perspective | -23.94% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 402.73, forward P/E 108.31, P/S 72.57, P/B 42.93 | EV/Sales 74.85, EV/EBITDA 345.89 |
...
- **Valuation risk:** Forward P/E 108.31, EV/Sales 74.85. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 3.79, ATR 10.5% of price, short float 11.26%. Size positions accordingly.
...
|---|---|---|---|
| Price | $334.27 | EV/Sales | 74.85 |
| Market cap | $357.03B | EV/EBITDA | 345.89 |
| Beta | 3.79 | Gross margin | 97.54% |
| RSI(14) | 48.4 | Operating margin | 29.53% |
| ATR(14) | 35.16 | Profit margin | 18.37% |
| SMA20 dist | -10.83% | ROA | 5.78% |
| SMA50 dist | +17.17% | ROE | 11.95% |
| SMA200 dist | +92.68% | Revenue (ttm) | $4.92B |
| 52W high | $439.46 | Revenue growth y/y | 20.10% |
| 52W low | $104.55 | Inst. ownership | 95.42% |
| P/E (ttm) | 402.73 | Insider ownership | 0.07% |
| Forward P/E | 108.31 | Short float | 11.26% |
| PEG (trailing) | 3.02 | Avg volume | 11,176,590 |
| P/S | 72.57 | Employees | 9,584 |
| P/B | 42.93 | Analyst rec (1=buy..5=sell) | 1.9 |
