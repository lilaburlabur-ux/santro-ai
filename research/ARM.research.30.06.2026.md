...
Signed file: `ARM.research.30.06.2026`

| Field | Value |
|---|---|
| Current price | $343.58 (2026-06-30, ~15-min delayed) |
| Market cap | $366.97B |
...
|---|---|---|
| Technical momentum | High | 1Y +117.25%; price +96.97% vs SMA200. |
| Fresh setup quality | Moderate / wait | -21.82% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 18.37%, revenue growth 20.10%. |
| Value attractiveness | Low (expensive) | Forward P/E 111.32, EV/Sales 73.95. |
| Risk level | High | Beta 3.79, ATR 10.4% of price, short float 11.26%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $343.58; 52w high $439.46 (-21.82%); 52w low $104.55 (+228.63%) |
| Trend | +96.97% vs SMA200, +18.92% vs SMA50, -8.23% vs SMA20 |
| Momentum | RSI(14) 50.1 (neutral) |
| Volatility | ATR(14) 35.69 (~10.4% of price); beta 3.79 |
| Setup perspective | -21.82% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 399.51, forward P/E 111.32, P/S 74.59, P/B 44.12 | EV/Sales 73.95, EV/EBITDA 341.75 |
...
- **Valuation risk:** Forward P/E 111.32, EV/Sales 73.95. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 3.79, ATR 10.4% of price, short float 11.26%. Size positions accordingly.
...
|---|---|---|---|
| Price | $343.58 | EV/Sales | 73.95 |
| Market cap | $366.97B | EV/EBITDA | 341.75 |
| Beta | 3.79 | Gross margin | 97.54% |
| RSI(14) | 50.1 | Operating margin | 29.53% |
| ATR(14) | 35.69 | Profit margin | 18.37% |
| SMA20 dist | -8.23% | ROA | 5.78% |
| SMA50 dist | +18.92% | ROE | 11.95% |
| SMA200 dist | +96.97% | Revenue (ttm) | $4.92B |
| 52W high | $439.46 | Revenue growth y/y | 20.10% |
| 52W low | $104.55 | Inst. ownership | 95.41% |
| P/E (ttm) | 399.51 | Insider ownership | 0.07% |
| Forward P/E | 111.32 | Short float | 11.26% |
| PEG (trailing) | 2.99 | Avg volume | 11,092,212 |
| P/S | 74.59 | Employees | 9,584 |
| P/B | 44.12 | Analyst rec (1=buy..5=sell) | 1.9 |
