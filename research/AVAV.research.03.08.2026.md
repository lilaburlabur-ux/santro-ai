...
Signed file: `AVAV.research.03.08.2026`

| Field | Value |
|---|---|
| Current price | $159.18 (2026-08-03, ~15-min delayed) |
| Market cap | $8.06B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-32.18%) with negative half-year (-42.82%). |
| Fresh setup quality | Poor / broken | -61.16% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Low (expensive) | Forward P/E 35.99, EV/Sales 3.91. |
| Risk level | High | Beta 1.41, ATR 6.5% of price, short float 10.06%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $159.18; 52w high $409.83 (-61.16%); 52w low $136.68 (+16.46%) |
| Trend | -32.18% vs SMA200, -3.26% vs SMA50, +6.51% vs SMA20 |
| Momentum | RSI(14) 52.9 (neutral) |
| Volatility | ATR(14) 10.40 (~6.5% of price); beta 1.41 |
| Setup perspective | -61.16% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 35.99, P/S 4.08, P/B 1.82 | EV/Sales 3.91, EV/EBITDA 39.73 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $225.77 (19 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 89.93% |
...
- **Valuation risk:** Forward P/E 35.99, EV/Sales 3.91. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.41, ATR 6.5% of price, short float 10.06%. Size positions accordingly.
...
|---|---|---|---|
| Price | $159.18 | EV/Sales | 3.91 |
| Market cap | $8.06B | EV/EBITDA | 39.73 |
| Beta | 1.41 | Gross margin | 25.32% |
| RSI(14) | 52.9 | Operating margin | 2.81% |
| ATR(14) | 10.40 | Profit margin | -13.41% |
| SMA20 dist | +6.51% | ROA | -1.29% |
| SMA50 dist | -3.26% | ROE | -10.03% |
| SMA200 dist | -32.18% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 89.93% |
| P/E (ttm) | — | Insider ownership | 0.89% |
| Forward P/E | 35.99 | Short float | 10.06% |
| PEG (trailing) | — | Avg volume | 1,640,375 |
