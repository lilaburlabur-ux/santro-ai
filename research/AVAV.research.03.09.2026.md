...
Signed file: `AVAV.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $147.21 (2026-09-03, ~15-min delayed) |
| Market cap | $7.48B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-30.94%) with negative half-year (-33.26%). |
| Fresh setup quality | Poor / broken | -64.08% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 33.53, EV/Sales 3.81. |
| Risk level | High | Beta 1.41, ATR 6.1% of price, short float 9.55%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $147.21; 52w high $409.83 (-64.08%); 52w low $136.68 (+7.70%) |
| Trend | -30.94% vs SMA200, -7.30% vs SMA50, -11.42% vs SMA20 |
| Momentum | RSI(14) 40.5 (neutral) |
| Volatility | ATR(14) 8.92 (~6.1% of price); beta 1.41 |
| Setup perspective | -64.08% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 33.53, P/S 3.78, P/B 1.69 | EV/Sales 3.81, EV/EBITDA 38.70 |
...
- **Valuation risk:** Forward P/E 33.53, EV/Sales 3.81. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.41, ATR 6.1% of price, short float 9.55%. Size positions accordingly.
...
|---|---|---|---|
| Price | $147.21 | EV/Sales | 3.81 |
| Market cap | $7.48B | EV/EBITDA | 38.70 |
| Beta | 1.41 | Gross margin | 25.32% |
| RSI(14) | 40.5 | Operating margin | 2.81% |
| ATR(14) | 8.92 | Profit margin | -13.41% |
| SMA20 dist | -11.42% | ROA | -1.29% |
| SMA50 dist | -7.30% | ROE | -10.03% |
| SMA200 dist | -30.94% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 88.19% |
| P/E (ttm) | — | Insider ownership | 0.90% |
| Forward P/E | 33.53 | Short float | 9.55% |
| PEG (trailing) | — | Avg volume | 1,578,468 |
