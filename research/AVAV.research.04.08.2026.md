...
Signed file: `AVAV.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $169.02 (2026-08-04, ~15-min delayed) |
| Market cap | $8.55B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-27.65%) with negative half-year (-37.40%). |
| Fresh setup quality | Poor / broken | -58.76% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Low (expensive) | Forward P/E 38.22, EV/Sales 4.16. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $169.02; 52w high $409.83 (-58.76%); 52w low $136.68 (+23.66%) |
| Trend | -27.65% vs SMA200, +2.65% vs SMA50, +12.84% vs SMA20 |
| Momentum | RSI(14) 57.7 (neutral) |
| Volatility | ATR(14) 10.45 (~6.2% of price); beta 1.41 |
| Setup perspective | -58.76% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 38.22, P/S 4.33, P/B 1.94 | EV/Sales 4.16, EV/EBITDA 42.28 |
...
- **Valuation risk:** Forward P/E 38.22, EV/Sales 4.16. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $169.02 | EV/Sales | 4.16 |
| Market cap | $8.55B | EV/EBITDA | 42.28 |
| Beta | 1.41 | Gross margin | 25.32% |
| RSI(14) | 57.7 | Operating margin | 2.81% |
| ATR(14) | 10.45 | Profit margin | -13.41% |
| SMA20 dist | +12.84% | ROA | -1.29% |
| SMA50 dist | +2.65% | ROE | -10.03% |
| SMA200 dist | -27.65% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 89.93% |
| P/E (ttm) | — | Insider ownership | 0.89% |
| Forward P/E | 38.22 | Short float | 10.06% |
| PEG (trailing) | — | Avg volume | 1,646,154 |
| P/S | 4.33 | Employees | 3,991 |
| P/B | 1.94 | Analyst rec (1=buy..5=sell) | 1.6 |
