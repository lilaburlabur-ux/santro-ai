...
Signed file: `AVAV.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $168.06 (2026-08-05, ~15-min delayed) |
| Market cap | $8.51B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-27.74%) with negative half-year (-41.12%). |
| Fresh setup quality | Poor / broken | -58.99% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Low (expensive) | Forward P/E 38.16, EV/Sales 4.16. |
| Risk level | High | Beta 1.41, ATR 6.2% of price, short float 10.06%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $168.06; 52w high $409.83 (-58.99%); 52w low $136.68 (+22.96%) |
| Trend | -27.74% vs SMA200, +2.14% vs SMA50, +11.82% vs SMA20 |
| Momentum | RSI(14) 57.1 (neutral) |
| Volatility | ATR(14) 10.39 (~6.2% of price); beta 1.41 |
| Setup perspective | -58.99% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 38.16, P/S 4.30, P/B 1.93 | EV/Sales 4.16, EV/EBITDA 42.28 |
...
- **Valuation risk:** Forward P/E 38.16, EV/Sales 4.16. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.41, ATR 6.2% of price, short float 10.06%. Size positions accordingly.
...
|---|---|---|---|
| Price | $168.06 | EV/Sales | 4.16 |
| Market cap | $8.51B | EV/EBITDA | 42.28 |
| Beta | 1.41 | Gross margin | 25.32% |
| RSI(14) | 57.1 | Operating margin | 2.81% |
| ATR(14) | 10.39 | Profit margin | -13.41% |
| SMA20 dist | +11.82% | ROA | -1.29% |
| SMA50 dist | +2.14% | ROE | -10.03% |
| SMA200 dist | -27.74% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 90.50% |
| P/E (ttm) | — | Insider ownership | 0.89% |
| Forward P/E | 38.16 | Short float | 10.06% |
| PEG (trailing) | — | Avg volume | 1,633,086 |
| P/S | 4.30 | Employees | 3,991 |
| P/B | 1.93 | Analyst rec (1=buy..5=sell) | 1.6 |
