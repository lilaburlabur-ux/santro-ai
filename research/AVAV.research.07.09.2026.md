...
Signed file: `AVAV.research.07.09.2026`

| Field | Value |
|---|---|
| Current price | $144.65 (2026-09-07, ~15-min delayed) |
| Market cap | $7.35B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-31.92%) with negative half-year (-37.05%). |
| Fresh setup quality | Poor / broken | -64.70% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 32.94, EV/Sales 3.79. |
| Risk level | High | Beta 1.41, ATR 6.0% of price, short float 9.55%. |
...
|---|---|---|
| ONDS Raises 2026 Revenue Outlook as Backlog Surges Higher | Zacks | 2026-09-07 |
| ONDS Down 18.2% in the Past Month: Does the Pullback Create Value? | Zacks | 2026-09-07 |
| Is ONDS Worth Buying as Hypergrowth Collides With M&A Execution Risk? | Zacks | 2026-09-07 |
| ONDS Stock Sinks 22% YTD: Is it Time to Hold Tight or Head for Exit? | Zacks | 2026-09-07 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $144.65; 52w high $409.83 (-64.70%); 52w low $136.68 (+5.83%) |
| Trend | -31.92% vs SMA200, -9.00% vs SMA50, -11.85% vs SMA20 |
| Momentum | RSI(14) 38.9 (neutral) |
| Volatility | ATR(14) 8.62 (~6.0% of price); beta 1.41 |
| Setup perspective | -64.70% from 52w high — base needs to rebuild. |
...
|---|---|---|
| Next earnings | 2026-09-09 | Next scheduled report (Yahoo estimate) |
...
| Valuation | P/E —, forward P/E 32.94, P/S 3.72, P/B 1.66 | EV/Sales 3.79, EV/EBITDA 38.51 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $225.77 (19 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 87.97% |
...
- **Valuation risk:** Forward P/E 32.94, EV/Sales 3.79. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.41, ATR 6.0% of price, short float 9.55%. Size positions accordingly.
...
|---|---|---|---|
| Price | $144.65 | EV/Sales | 3.79 |
| Market cap | $7.35B | EV/EBITDA | 38.51 |
| Beta | 1.41 | Gross margin | 25.32% |
| RSI(14) | 38.9 | Operating margin | 2.81% |
| ATR(14) | 8.62 | Profit margin | -13.41% |
| SMA20 dist | -11.85% | ROA | -1.29% |
| SMA50 dist | -9.00% | ROE | -10.03% |
| SMA200 dist | -31.92% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 87.97% |
| P/E (ttm) | — | Insider ownership | 0.90% |
| Forward P/E | 32.94 | Short float | 9.55% |
| PEG (trailing) | — | Avg volume | 1,607,049 |
| P/S | 3.72 | Employees | 3,991 |
| P/B | 1.66 | Analyst rec (1=buy..5=sell) | 1.6 |
