...
Signed file: `AVAV.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $146.71 (2026-09-11, ~15-min delayed) |
| Market cap | $7.46B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $146.71; 52w high $409.83 (-64.20%); 52w low $136.68 (+7.34%) |
| Trend | -30.09% vs SMA200, -7.34% vs SMA50, -5.25% vs SMA20 |
| Momentum | RSI(14) 43.3 (neutral) |
| Volatility | ATR(14) 9.33 (~6.4% of price); beta 1.41 |
| Setup perspective | -64.20% from 52w high — base needs to rebuild. |
