...
Signed file: `AVAV.research.13.07.2026`

| Field | Value |
|---|---|
| Current price | $141.80 (2026-07-13, ~15-min delayed) |
| Market cap | $7.18B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-43.41%) with negative half-year (-58.89%). |
| Fresh setup quality | Poor / broken | -65.40% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 31.29, EV/Sales 3.79. |
| Risk level | High | Beta 1.40, ATR 8.9% of price, short float 10.73%. |
...
| RBC Capital Just Downgraded AVAV Stock. Here's Why. | Barchart | 2026-07-09 |
| This Drone Maker’s Stock Is Falling on a Contrarian Downgrade | Barrons.com | 2026-07-09 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $141.80; 52w high $409.83 (-65.40%); 52w low $136.68 (+3.75%) |
| Trend | -43.41% vs SMA200, -16.94% vs SMA50, -10.32% vs SMA20 |
| Momentum | RSI(14) 39.8 (neutral) |
| Volatility | ATR(14) 12.61 (~8.9% of price); beta 1.40 |
| Setup perspective | -65.40% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 31.29, P/S 3.63, P/B 1.62 | EV/Sales 3.79, EV/EBITDA 38.49 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $245.38 (18 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 89.57% |
...
- **Valuation risk:** Forward P/E 31.29, EV/Sales 3.79. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.40, ATR 8.9% of price, short float 10.73%. Size positions accordingly.
...
|---|---|---|---|
| Price | $141.80 | EV/Sales | 3.79 |
| Market cap | $7.18B | EV/EBITDA | 38.49 |
| Beta | 1.40 | Gross margin | 25.32% |
| RSI(14) | 39.8 | Operating margin | 2.81% |
| ATR(14) | 12.61 | Profit margin | -13.41% |
| SMA20 dist | -10.32% | ROA | -1.29% |
| SMA50 dist | -16.94% | ROE | -10.03% |
| SMA200 dist | -43.41% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 89.57% |
| P/E (ttm) | — | Insider ownership | 0.91% |
| Forward P/E | 31.29 | Short float | 10.73% |
| PEG (trailing) | — | Avg volume | 1,600,308 |
