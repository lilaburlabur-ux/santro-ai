...
Signed file: `AVAV.research.13.08.2026`

| Field | Value |
|---|---|
| Current price | $189.43 (2026-08-13, ~15-min delayed) |
| Market cap | $9.59B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-16.65%) with negative half-year (-22.18%). |
| Fresh setup quality | Poor / broken | -53.78% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Low (expensive) | Forward P/E 43.01, EV/Sales 5.05. |
| Risk level | High | Beta 1.41, ATR 5.5% of price, short float 11.32%. |
...
|---|---|---|
| Ondas Drops 7% After Earnings. Is Their Post-Earnings Drop Impacting Other Drone Stocks? | 24/7 Wall St. | 2026-08-13 |
| AVAV Outperforms Industry in the Past Month: How to Play the Stock? | Zacks | 2026-08-13 |
| 2 High-Flying Stocks Worth Your Attention and 1 We Avoid | StockStory | 2026-08-13 |
| Innovative Solutions and Support, Inc. (ISSC) Q3 Earnings and Revenues Beat Estimates | Zacks | 2026-08-13 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $189.43; 52w high $409.83 (-53.78%); 52w low $136.68 (+38.59%) |
| Trend | -16.65% vs SMA200, +16.08% vs SMA50, +16.09% vs SMA20 |
| Momentum | RSI(14) 63.6 (neutral) |
| Volatility | ATR(14) 10.42 (~5.5% of price); beta 1.41 |
| Setup perspective | -53.78% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 43.01, P/S 4.85, P/B 2.17 | EV/Sales 5.05, EV/EBITDA 51.25 |
...
- **Valuation risk:** Forward P/E 43.01, EV/Sales 5.05. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.41, ATR 5.5% of price, short float 11.32%. Size positions accordingly.
...
|---|---|---|---|
| Price | $189.43 | EV/Sales | 5.05 |
| Market cap | $9.59B | EV/EBITDA | 51.25 |
| Beta | 1.41 | Gross margin | 25.32% |
| RSI(14) | 63.6 | Operating margin | 2.81% |
| ATR(14) | 10.42 | Profit margin | -13.41% |
| SMA20 dist | +16.09% | ROA | -1.29% |
| SMA50 dist | +16.08% | ROE | -10.03% |
| SMA200 dist | -16.65% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 87.68% |
| P/E (ttm) | — | Insider ownership | 0.91% |
| Forward P/E | 43.01 | Short float | 11.32% |
| PEG (trailing) | — | Avg volume | 1,637,085 |
| P/S | 4.85 | Employees | 3,991 |
| P/B | 2.17 | Analyst rec (1=buy..5=sell) | 1.6 |
