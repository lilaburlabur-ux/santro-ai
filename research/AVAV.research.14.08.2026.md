...
Signed file: `AVAV.research.14.08.2026`

| Field | Value |
|---|---|
| Current price | $192.81 (2026-08-14, ~15-min delayed) |
| Market cap | $9.76B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-14.81%) with negative half-year (-18.00%). |
| Fresh setup quality | Poor / broken | -52.95% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Low (expensive) | Forward P/E 43.78, EV/Sales 4.93. |
| Risk level | High | Beta 1.41, ATR 5.7% of price, short float 11.32%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $192.81; 52w high $409.83 (-52.95%); 52w low $136.68 (+41.07%) |
| Trend | -14.81% vs SMA200, +18.13% vs SMA50, +16.36% vs SMA20 |
| Momentum | RSI(14) 65.1 (neutral) |
| Volatility | ATR(14) 11.08 (~5.7% of price); beta 1.41 |
| Setup perspective | -52.95% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 43.78, P/S 4.94, P/B 2.21 | EV/Sales 4.93, EV/EBITDA 50.11 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $225.77 (19 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 86.17% |
...
- **Valuation risk:** Forward P/E 43.78, EV/Sales 4.93. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.41, ATR 5.7% of price, short float 11.32%. Size positions accordingly.
...
|---|---|---|---|
| Price | $192.81 | EV/Sales | 4.93 |
| Market cap | $9.76B | EV/EBITDA | 50.11 |
| Beta | 1.41 | Gross margin | 25.32% |
| RSI(14) | 65.1 | Operating margin | 2.81% |
| ATR(14) | 11.08 | Profit margin | -13.41% |
| SMA20 dist | +16.36% | ROA | -1.29% |
| SMA50 dist | +18.13% | ROE | -10.03% |
| SMA200 dist | -14.81% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 86.17% |
| P/E (ttm) | — | Insider ownership | 0.91% |
| Forward P/E | 43.78 | Short float | 11.32% |
| PEG (trailing) | — | Avg volume | 1,636,090 |
| P/S | 4.94 | Employees | 3,991 |
