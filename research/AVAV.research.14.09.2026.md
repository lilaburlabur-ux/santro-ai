...
Signed file: `AVAV.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $153.40 (2026-09-14, ~15-min delayed) |
| Market cap | $7.80B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-26.68%) with negative half-year (-25.92%). |
| Fresh setup quality | Poor / broken | -62.57% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-10.13%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 34.29, EV/Sales 3.84. |
| Risk level | High | Beta 1.41, ATR 6.2% of price, short float 11.21%. |
...
|---|---|---|
| Boeing Wins $13.4 Billion KC-46 Air Force Contract Amid Defense Awards | Investor's Business Daily | 2026-09-14 |
| AeroVironment Rises 6% as Post-Earnings Recovery Outpaces Drone Group; Ondas Ticks Up, Red Cat Barely Budges | 24/7 Wall St. | 2026-09-14 |
| MarketBeat Week in Review – 09/07 - 09/11 | MarketBeat | 2026-09-12 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $153.40; 52w high $409.83 (-62.57%); 52w low $136.68 (+12.23%) |
| Trend | -26.68% vs SMA200, -2.66% vs SMA50, +0.35% vs SMA20 |
| Momentum | RSI(14) 49.1 (neutral) |
| Volatility | ATR(14) 9.49 (~6.2% of price); beta 1.41 |
| Setup perspective | -62.57% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 34.29, P/S 3.89, P/B 1.77 | EV/Sales 3.84, EV/EBITDA 35.19 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $224.40 (19 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 88.01% |
...
|---|---|---|---|
| Blackrock Inc. | 3,480,740 | 6.85% | 2026-06-30 |
| State Street Corporation | 2,192,680 | 4.31% | 2026-06-30 |
| Vanguard Capital Management LLC | 1,646,011 | 3.24% | 2026-06-30 |
| Vanguard Portfolio Management LLC | 1,548,605 | 3.05% | 2026-06-30 |
| BAILLIE GIFFORD & CO | 967,448 | 1.90% | 2026-06-30 |
| Heard Capital LLC | 903,975 | 1.78% | 2026-06-30 |
| Mirae Asset Global ETFs Holdings Ltd. | 854,017 | 1.68% | 2026-06-30 |
| Invesco Ltd. | 698,470 | 1.37% | 2026-06-30 |
| Geode Capital Management, LLC | 671,971 | 1.32% | 2026-06-30 |
| Van Eck Associates Corporation | 612,915 | 1.21% | 2026-06-30 |

## 6. Risk Review and Setup Plan
- **Valuation risk:** Forward P/E 34.29, EV/Sales 3.84. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.41, ATR 6.2% of price, short float 11.21%. Size positions accordingly.
...
|---|---|---|---|
| Price | $153.40 | EV/Sales | 3.84 |
| Market cap | $7.80B | EV/EBITDA | 35.19 |
| Beta | 1.41 | Gross margin | 26.47% |
| RSI(14) | 49.1 | Operating margin | -2.27% |
| ATR(14) | 9.49 | Profit margin | -10.13% |
| SMA20 dist | +0.35% | ROA | -0.13% |
| SMA50 dist | -2.66% | ROE | -4.60% |
| SMA200 dist | -26.68% | Revenue (ttm) | $2.00B |
| 52W high | $409.83 | Revenue growth y/y | 5.70% |
| 52W low | $136.68 | Inst. ownership | 88.01% |
| P/E (ttm) | — | Insider ownership | 0.90% |
| Forward P/E | 34.29 | Short float | 11.21% |
| PEG (trailing) | — | Avg volume | 1,888,288 |
| P/S | 3.89 | Employees | 3,991 |
| P/B | 1.77 | Analyst rec (1=buy..5=sell) | 1.6 |
...
| 2026-09-10 | main | JP Morgan | Overweight → Overweight |
...
| 2026-07-10 | main | Citizens | Market Outperform → Market Outperform |
