...
Signed file: `AVAV.research.15.07.2026`

| Field | Value |
|---|---|
| Current price | $141.22 (2026-07-15, ~15-min delayed) |
| Market cap | $7.15B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-43.28%) with negative half-year (-61.90%). |
| Fresh setup quality | Poor / broken | -65.54% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 31.16, EV/Sales 3.76. |
| Risk level | High | Beta 1.40, ATR 8.5% of price, short float 10.73%. |
...
|---|---|---|
| Can Draganfly Capitalize on the Global Shift Toward Drone Automation? | Zacks | 2026-07-15 |
| Drone Stocks Are Back In Play: Why RCAT, AVAV, KTOS, UMAC Stocks Are Climbing | Stocktwits | 2026-07-14 |
| AeroVironment Flies Under Wall Street’s Radar Toward a $4 Billion Target | MarketBeat | 2026-07-10 |
| AeroVironment Plots Revenue Doubling to $4 Billion on Defense Drone Demand | MarketBeat | 2026-07-10 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $141.22; 52w high $409.83 (-65.54%); 52w low $136.68 (+3.32%) |
| Trend | -43.28% vs SMA200, -16.35% vs SMA50, -9.03% vs SMA20 |
| Momentum | RSI(14) 39.9 (neutral) |
| Volatility | ATR(14) 11.96 (~8.5% of price); beta 1.40 |
| Setup perspective | -65.54% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 31.16, P/S 3.62, P/B 1.62 | EV/Sales 3.76, EV/EBITDA 38.21 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $245.38 (18 analysts) |
...
|---|---|---|---|
| Blackrock Inc. | 4,959,699 | 9.80% | 2026-03-31 |
...
| Heard Capital LLC | 721,352 | 1.43% | 2026-03-31 |
| Van Eck Associates Corporation | 687,977 | 1.36% | 2026-03-31 |

## 6. Risk Review and Setup Plan
- **Valuation risk:** Forward P/E 31.16, EV/Sales 3.76. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.40, ATR 8.5% of price, short float 10.73%. Size positions accordingly.
...
|---|---|---|---|
| Price | $141.22 | EV/Sales | 3.76 |
| Market cap | $7.15B | EV/EBITDA | 38.21 |
| Beta | 1.40 | Gross margin | 25.32% |
| RSI(14) | 39.9 | Operating margin | 2.81% |
| ATR(14) | 11.96 | Profit margin | -13.41% |
| SMA20 dist | -9.03% | ROA | -1.29% |
| SMA50 dist | -16.35% | ROE | -10.03% |
| SMA200 dist | -43.28% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 89.60% |
| P/E (ttm) | — | Insider ownership | 0.91% |
| Forward P/E | 31.16 | Short float | 10.73% |
| PEG (trailing) | — | Avg volume | 1,608,978 |
| P/S | 3.62 | Employees | 3,991 |
