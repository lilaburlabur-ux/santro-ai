...
Signed file: `AVAV.research.16.07.2026`

| Field | Value |
|---|---|
| Current price | $149.29 (2026-07-16, ~15-min delayed) |
| Market cap | $7.56B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-39.85%) with negative half-year (-58.97%). |
| Fresh setup quality | Poor / broken | -63.57% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 32.94, EV/Sales 3.70. |
| Risk level | High | Beta 1.40, ATR 7.9% of price, short float 10.73%. |
...
| Stocks Pressured by a Renewed Selloff in Chipmakers | Barchart | 2026-07-16 |
| SpaceX initiated, Lululemon downgraded: Wall Street's top analyst calls | The Fly | 2026-07-16 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $149.29; 52w high $409.83 (-63.57%); 52w low $136.68 (+9.23%) |
| Trend | -39.85% vs SMA200, -11.24% vs SMA50, -3.29% vs SMA20 |
| Momentum | RSI(14) 44.6 (neutral) |
| Volatility | ATR(14) 11.86 (~7.9% of price); beta 1.40 |
| Setup perspective | -63.57% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 32.94, P/S 3.82, P/B 1.71 | EV/Sales 3.70, EV/EBITDA 37.62 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $232.88 (18 analysts) |
...
- **Valuation risk:** Forward P/E 32.94, EV/Sales 3.70. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.40, ATR 7.9% of price, short float 10.73%. Size positions accordingly.
...
|---|---|---|---|
| Price | $149.29 | EV/Sales | 3.70 |
| Market cap | $7.56B | EV/EBITDA | 37.62 |
| Beta | 1.40 | Gross margin | 25.32% |
| RSI(14) | 44.6 | Operating margin | 2.81% |
| ATR(14) | 11.86 | Profit margin | -13.41% |
| SMA20 dist | -3.29% | ROA | -1.29% |
| SMA50 dist | -11.24% | ROE | -10.03% |
| SMA200 dist | -39.85% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 89.63% |
| P/E (ttm) | — | Insider ownership | 0.91% |
| Forward P/E | 32.94 | Short float | 10.73% |
| PEG (trailing) | — | Avg volume | 1,612,739 |
