...
Signed file: `AVAV.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $156.45 (2026-09-16, ~15-min delayed) |
| Market cap | $7.95B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-24.79%) with negative half-year (-29.69%). |
| Fresh setup quality | Poor / broken | -61.83% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-10.13%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 34.97, EV/Sales 4.10. |
| Risk level | High | Beta 1.41, ATR 6.1% of price, short float 11.21%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $156.45; 52w high $409.83 (-61.83%); 52w low $136.68 (+14.46%) |
| Trend | -24.79% vs SMA200, -0.39% vs SMA50, +3.77% vs SMA20 |
| Momentum | RSI(14) 51.5 (neutral) |
| Volatility | ATR(14) 9.47 (~6.1% of price); beta 1.41 |
| Setup perspective | -61.83% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 34.97, P/S 3.97, P/B 1.80 | EV/Sales 4.10, EV/EBITDA 37.56 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $222.82 (19 analysts) |
...
- **Valuation risk:** Forward P/E 34.97, EV/Sales 4.10. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.41, ATR 6.1% of price, short float 11.21%. Size positions accordingly.
...
|---|---|---|---|
| Price | $156.45 | EV/Sales | 4.10 |
| Market cap | $7.95B | EV/EBITDA | 37.56 |
| Beta | 1.41 | Gross margin | 26.47% |
| RSI(14) | 51.5 | Operating margin | -2.27% |
| ATR(14) | 9.47 | Profit margin | -10.13% |
| SMA20 dist | +3.77% | ROA | -0.13% |
| SMA50 dist | -0.39% | ROE | -4.60% |
| SMA200 dist | -24.79% | Revenue (ttm) | $2.00B |
| 52W high | $409.83 | Revenue growth y/y | 5.70% |
| 52W low | $136.68 | Inst. ownership | 88.00% |
| P/E (ttm) | — | Insider ownership | 0.90% |
| Forward P/E | 34.97 | Short float | 11.21% |
| PEG (trailing) | — | Avg volume | 1,945,708 |
| P/S | 3.97 | Employees | 3,991 |
