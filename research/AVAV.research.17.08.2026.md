...
Signed file: `AVAV.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $181.13 (2026-08-17, ~15-min delayed) |
| Market cap | $9.17B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-19.62%) with negative half-year (-25.73%). |
| Fresh setup quality | Poor / broken | -55.80% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Low (expensive) | Forward P/E 41.13, EV/Sales 5.02. |
| Risk level | High | Beta 1.41, ATR 6.2% of price, short float 11.32%. |
...
|---|---|---|
| Earnings, Fed Hopes Leave Markets in a Zen State. What Could Break It. | Barrons.com | 2026-08-17 |
| 2 Growth Stocks Set to Flourishand 1 We Brush Off | StockStory | 2026-08-16 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $181.13; 52w high $409.83 (-55.80%); 52w low $136.68 (+32.52%) |
| Trend | -19.62% vs SMA200, +11.29% vs SMA50, +8.06% vs SMA20 |
| Momentum | RSI(14) 56.5 (neutral) |
| Volatility | ATR(14) 11.16 (~6.2% of price); beta 1.41 |
| Setup perspective | -55.80% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 41.13, P/S 4.64, P/B 2.08 | EV/Sales 5.02, EV/EBITDA 50.99 |
...
|---|---|---|---|
| Blackrock Inc. | 3,480,740 | 6.88% | 2026-06-30 |
| State Street Corporation | 2,192,680 | 4.33% | 2026-06-30 |
| Vanguard Capital Management LLC | 1,646,011 | 3.25% | 2026-06-30 |
| Vanguard Portfolio Management LLC | 1,548,605 | 3.06% | 2026-06-30 |
| BAILLIE GIFFORD & CO | 967,448 | 1.91% | 2026-06-30 |
| Heard Capital LLC | 903,975 | 1.79% | 2026-06-30 |
| Mirae Asset Global ETFs Holdings Ltd. | 854,017 | 1.69% | 2026-06-30 |
| Geode Capital Management, LLC | 671,971 | 1.33% | 2026-06-30 |
| Van Eck Associates Corporation | 612,915 | 1.21% | 2026-06-30 |
| ARK Investment Management, LLC | 607,502 | 1.20% | 2026-06-30 |

## 6. Risk Review and Setup Plan
- **Valuation risk:** Forward P/E 41.13, EV/Sales 5.02. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.41, ATR 6.2% of price, short float 11.32%. Size positions accordingly.
- **Short interest risk:** short float 11.32% can fuel squeezes both ways around news.
...
|---|---|---|---|
| Price | $181.13 | EV/Sales | 5.02 |
| Market cap | $9.17B | EV/EBITDA | 50.99 |
| Beta | 1.41 | Gross margin | 25.32% |
| RSI(14) | 56.5 | Operating margin | 2.81% |
| ATR(14) | 11.16 | Profit margin | -13.41% |
| SMA20 dist | +8.06% | ROA | -1.29% |
| SMA50 dist | +11.29% | ROE | -10.03% |
| SMA200 dist | -19.62% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 88.44% |
| P/E (ttm) | — | Insider ownership | 0.91% |
| Forward P/E | 41.13 | Short float | 11.32% |
| PEG (trailing) | — | Avg volume | 1,646,148 |
| P/S | 4.64 | Employees | 3,991 |
| P/B | 2.08 | Analyst rec (1=buy..5=sell) | 1.6 |
...
| 2026-07-10 | main | Canaccord Genuity | Buy → Buy |
