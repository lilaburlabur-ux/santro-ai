...
Signed file: `AVAV.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $174.14 (2026-08-18, ~15-min delayed) |
| Market cap | $8.85B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-22.37%) with negative half-year (-33.78%). |
| Fresh setup quality | Poor / broken | -57.51% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Low (expensive) | Forward P/E 39.54, EV/Sales 4.72. |
| Risk level | High | Beta 1.41, ATR 6.3% of price, short float 11.32%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $174.14; 52w high $409.83 (-57.51%); 52w low $136.68 (+27.41%) |
| Trend | -22.37% vs SMA200, +7.15% vs SMA50, +3.11% vs SMA20 |
| Momentum | RSI(14) 52.1 (neutral) |
| Volatility | ATR(14) 11.01 (~6.3% of price); beta 1.41 |
| Setup perspective | -57.51% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 39.54, P/S 4.48, P/B 2.00 | EV/Sales 4.72, EV/EBITDA 47.96 |
...
| Invesco Ltd. | 698,470 | 1.38% | 2026-06-30 |
| Geode Capital Management, LLC | 671,971 | 1.33% | 2026-06-30 |
| Van Eck Associates Corporation | 612,915 | 1.21% | 2026-06-30 |

## 6. Risk Review and Setup Plan
- **Valuation risk:** Forward P/E 39.54, EV/Sales 4.72. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.41, ATR 6.3% of price, short float 11.32%. Size positions accordingly.
...
|---|---|---|---|
| Price | $174.14 | EV/Sales | 4.72 |
| Market cap | $8.85B | EV/EBITDA | 47.96 |
| Beta | 1.41 | Gross margin | 25.32% |
| RSI(14) | 52.1 | Operating margin | 2.81% |
| ATR(14) | 11.01 | Profit margin | -13.41% |
| SMA20 dist | +3.11% | ROA | -1.29% |
| SMA50 dist | +7.15% | ROE | -10.03% |
| SMA200 dist | -22.37% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 88.15% |
| P/E (ttm) | — | Insider ownership | 0.90% |
| Forward P/E | 39.54 | Short float | 11.32% |
| PEG (trailing) | — | Avg volume | 1,648,590 |
| P/S | 4.48 | Employees | 3,991 |
| P/B | 2.00 | Analyst rec (1=buy..5=sell) | 1.6 |
