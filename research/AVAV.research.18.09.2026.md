...
Signed file: `AVAV.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $159.95 (2026-09-18, ~15-min delayed) |
| Market cap | $8.13B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-22.71%) with negative half-year (-24.32%). |
...
| Value attractiveness | Low (expensive) | Forward P/E 35.79, EV/Sales 4.27. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $159.95; 52w high $409.83 (-60.97%); 52w low $136.68 (+17.03%) |
| Trend | -22.71% vs SMA200, +1.61% vs SMA50, +6.41% vs SMA20 |
| Momentum | RSI(14) 53.7 (neutral) |
| Volatility | ATR(14) 9.53 (~6.0% of price); beta 1.41 |
...
| Valuation | P/E —, forward P/E 35.79, P/S 4.06, P/B 1.84 | EV/Sales 4.27, EV/EBITDA 39.04 |
...
- **Valuation risk:** Forward P/E 35.79, EV/Sales 4.27. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $159.95 | EV/Sales | 4.27 |
| Market cap | $8.13B | EV/EBITDA | 39.04 |
| Beta | 1.41 | Gross margin | 26.47% |
| RSI(14) | 53.7 | Operating margin | -2.27% |
| ATR(14) | 9.53 | Profit margin | -10.13% |
| SMA20 dist | +6.41% | ROA | -0.13% |
| SMA50 dist | +1.61% | ROE | -4.60% |
| SMA200 dist | -22.71% | Revenue (ttm) | $2.00B |
| 52W high | $409.83 | Revenue growth y/y | 5.70% |
| 52W low | $136.68 | Inst. ownership | 88.00% |
| P/E (ttm) | — | Insider ownership | 0.90% |
| Forward P/E | 35.79 | Short float | 11.21% |
| PEG (trailing) | — | Avg volume | 1,961,180 |
