...
Signed file: `AVAV.research.20.07.2026`

| Field | Value |
|---|---|
| Current price | $142.60 (2026-07-20, ~15-min delayed) |
| Market cap | $7.22B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-42.15%) with negative half-year (-62.33%). |
| Fresh setup quality | Poor / broken | -65.21% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 31.47, EV/Sales 3.73. |
| Risk level | High | Beta 1.40, ATR 7.8% of price, short float 10.73%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $142.60; 52w high $409.83 (-65.21%); 52w low $136.68 (+4.33%) |
| Trend | -42.15% vs SMA200, -14.65% vs SMA50, -6.04% vs SMA20 |
| Momentum | RSI(14) 41.8 (neutral) |
| Volatility | ATR(14) 11.12 (~7.8% of price); beta 1.40 |
| Setup perspective | -65.21% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 31.47, P/S 3.65, P/B 1.63 | EV/Sales 3.73, EV/EBITDA 37.88 |
...
- **Valuation risk:** Forward P/E 31.47, EV/Sales 3.73. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.40, ATR 7.8% of price, short float 10.73%. Size positions accordingly.
...
|---|---|---|---|
| Price | $142.60 | EV/Sales | 3.73 |
| Market cap | $7.22B | EV/EBITDA | 37.88 |
| Beta | 1.40 | Gross margin | 25.32% |
| RSI(14) | 41.8 | Operating margin | 2.81% |
| ATR(14) | 11.12 | Profit margin | -13.41% |
| SMA20 dist | -6.04% | ROA | -1.29% |
| SMA50 dist | -14.65% | ROE | -10.03% |
| SMA200 dist | -42.15% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 89.63% |
| P/E (ttm) | — | Insider ownership | 0.89% |
| Forward P/E | 31.47 | Short float | 10.73% |
| PEG (trailing) | — | Avg volume | 1,627,196 |
| P/S | 3.65 | Employees | 3,991 |
