...
Signed file: `AVAV.research.21.07.2026`

| Field | Value |
|---|---|
| Current price | $148.84 (2026-07-21, ~15-min delayed) |
| Market cap | $7.53B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-39.38%) with negative half-year (-62.11%). |
| Fresh setup quality | Poor / broken | -63.68% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 32.85, EV/Sales 3.74. |
| Risk level | High | Beta 1.40, ATR 7.4% of price, short float 10.73%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $148.84; 52w high $409.83 (-63.68%); 52w low $136.68 (+8.90%) |
| Trend | -39.38% vs SMA200, -10.70% vs SMA50, -1.85% vs SMA20 |
| Momentum | RSI(14) 45.6 (neutral) |
| Volatility | ATR(14) 11.03 (~7.4% of price); beta 1.40 |
| Setup perspective | -63.68% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 32.85, P/S 3.81, P/B 1.71 | EV/Sales 3.74, EV/EBITDA 37.98 |
...
- **Valuation risk:** Forward P/E 32.85, EV/Sales 3.74. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.40, ATR 7.4% of price, short float 10.73%. Size positions accordingly.
...
|---|---|---|---|
| Price | $148.84 | EV/Sales | 3.74 |
| Market cap | $7.53B | EV/EBITDA | 37.98 |
| Beta | 1.40 | Gross margin | 25.32% |
| RSI(14) | 45.6 | Operating margin | 2.81% |
| ATR(14) | 11.03 | Profit margin | -13.41% |
| SMA20 dist | -1.85% | ROA | -1.29% |
| SMA50 dist | -10.70% | ROE | -10.03% |
| SMA200 dist | -39.38% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 89.65% |
| P/E (ttm) | — | Insider ownership | 0.89% |
| Forward P/E | 32.85 | Short float | 10.73% |
| PEG (trailing) | — | Avg volume | 1,608,904 |
