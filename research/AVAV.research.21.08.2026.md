...
Signed file: `AVAV.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $160.22 (2026-08-21, ~15-min delayed) |
| Market cap | $8.14B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-27.58%) with negative half-year (-39.46%). |
...
| Value attractiveness | Low (expensive) | Forward P/E 36.38, EV/Sales 4.18. |
| Risk level | High | Beta 1.41, ATR 6.7% of price, short float 11.32%. |
...
| AVAV Stock Gains Overnight: AeroVironment Bets On Greece To Build Europe’s Counter-Drone Arsenal | Stocktwits | 2026-08-21 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $160.22; 52w high $409.83 (-60.91%); 52w low $136.68 (+17.22%) |
| Trend | -27.58% vs SMA200, -0.91% vs SMA50, -6.08% vs SMA20 |
| Momentum | RSI(14) 44.3 (neutral) |
| Volatility | ATR(14) 10.71 (~6.7% of price); beta 1.41 |
...
| Valuation | P/E —, forward P/E 36.38, P/S 4.12, P/B 1.84 | EV/Sales 4.18, EV/EBITDA 42.43 |
...
- **Valuation risk:** Forward P/E 36.38, EV/Sales 4.18. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.41, ATR 6.7% of price, short float 11.32%. Size positions accordingly.
...
|---|---|---|---|
| Price | $160.22 | EV/Sales | 4.18 |
| Market cap | $8.14B | EV/EBITDA | 42.43 |
| Beta | 1.41 | Gross margin | 25.32% |
| RSI(14) | 44.3 | Operating margin | 2.81% |
| ATR(14) | 10.71 | Profit margin | -13.41% |
| SMA20 dist | -6.08% | ROA | -1.29% |
| SMA50 dist | -0.91% | ROE | -10.03% |
| SMA200 dist | -27.58% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 88.14% |
| P/E (ttm) | — | Insider ownership | 0.90% |
| Forward P/E | 36.38 | Short float | 11.32% |
| PEG (trailing) | — | Avg volume | 1,669,883 |
| P/S | 4.12 | Employees | 3,991 |
| P/B | 1.84 | Analyst rec (1=buy..5=sell) | 1.6 |
