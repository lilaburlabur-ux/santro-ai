...
Signed file: `AVAV.research.23.07.2026`

| Field | Value |
|---|---|
| Current price | $158.73 (2026-07-23, ~15-min delayed) |
| Market cap | $8.03B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $158.73; 52w high $409.83 (-61.27%); 52w low $136.68 (+16.13%) |
| Trend | -34.78% vs SMA200, -4.48% vs SMA50, +4.06% vs SMA20 |
| Momentum | RSI(14) 51.4 (neutral) |
| Volatility | ATR(14) 10.93 (~6.9% of price); beta 1.40 |
| Setup perspective | -61.27% from 52w high — base needs to rebuild. |
...
|---|---|---|---|
| Price | $158.73 | EV/Sales | 3.94 |
| Market cap | $8.03B | EV/EBITDA | 39.99 |
| Beta | 1.40 | Gross margin | 25.32% |
| RSI(14) | 51.4 | Operating margin | 2.81% |
| ATR(14) | 10.93 | Profit margin | -13.41% |
| SMA20 dist | +4.06% | ROA | -1.29% |
| SMA50 dist | -4.48% | ROE | -10.03% |
