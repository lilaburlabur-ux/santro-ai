...
Signed file: `AVAV.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $155.94 (2026-09-23, ~15-min delayed) |
| Market cap | $7.92B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-24.24%) with negative half-year (-24.40%). |
| Fresh setup quality | Poor / broken | -61.95% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-10.13%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 34.98, EV/Sales 4.08. |
...
| AeroVironment Stock And 2 Other Top Defense Stocks | Simply Wall St. | 2026-09-23 |
| 3 Defense Stocks Investors Are Watching As Middle East Risk Puts Aerospace In Focus | Simply Wall St. | 2026-09-21 |
| Drones Stock AeroVironment Is Now a Space Stock, Too | Motley Fool | 2026-09-20 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $155.94; 52w high $409.83 (-61.95%); 52w low $136.68 (+14.09%) |
| Trend | -24.24% vs SMA200, -1.32% vs SMA50, +3.45% vs SMA20 |
| Momentum | RSI(14) 49.8 (neutral) |
| Volatility | ATR(14) 9.15 (~5.9% of price); beta 1.41 |
| Setup perspective | -61.95% from 52w high — base needs to rebuild. |
...
- **Valuation risk:** Forward P/E 34.98, EV/Sales 4.08. Multiple compression is the main downside if growth disappoints.
...
| SMA20 dist | +3.45% | ROA | -0.13% |
| SMA50 dist | -1.32% | ROE | -4.60% |
| SMA200 dist | -24.24% | Revenue (ttm) | $2.00B |
| 52W high | $409.83 | Revenue growth y/y | 5.70% |
| 52W low | $136.68 | Inst. ownership | 88.00% |
| P/E (ttm) | — | Insider ownership | 0.91% |
| Forward P/E | 34.98 | Short float | 11.21% |
| PEG (trailing) | — | Avg volume | 1,952,801 |
