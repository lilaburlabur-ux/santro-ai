...
Signed file: `AVAV.research.24.07.2026`

| Field | Value |
|---|---|
| Current price | $149.51 (2026-07-24, ~15-min delayed) |
| Market cap | $7.57B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-38.27%) with negative half-year (-52.10%). |
| Fresh setup quality | Poor / broken | -63.52% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 33.80, EV/Sales 4.15. |
| Risk level | High | Beta 1.40, ATR 7.3% of price, short float 10.73%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $149.51; 52w high $409.83 (-63.52%); 52w low $136.68 (+9.39%) |
| Trend | -38.27% vs SMA200, -9.82% vs SMA50, -2.39% vs SMA20 |
| Momentum | RSI(14) 46.4 (neutral) |
| Volatility | ATR(14) 10.90 (~7.3% of price); beta 1.40 |
| Setup perspective | -63.52% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 33.80, P/S 3.83, P/B 1.71 | EV/Sales 4.15, EV/EBITDA 42.16 |
...
- **Valuation risk:** Forward P/E 33.80, EV/Sales 4.15. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.40, ATR 7.3% of price, short float 10.73%. Size positions accordingly.
...
|---|---|---|---|
| Price | $149.51 | EV/Sales | 4.15 |
| Market cap | $7.57B | EV/EBITDA | 42.16 |
| Beta | 1.40 | Gross margin | 25.32% |
| RSI(14) | 46.4 | Operating margin | 2.81% |
| ATR(14) | 10.90 | Profit margin | -13.41% |
| SMA20 dist | -2.39% | ROA | -1.29% |
| SMA50 dist | -9.82% | ROE | -10.03% |
| SMA200 dist | -38.27% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 89.58% |
| P/E (ttm) | — | Insider ownership | 0.89% |
| Forward P/E | 33.80 | Short float | 10.73% |
| PEG (trailing) | — | Avg volume | 1,638,962 |
| P/S | 3.83 | Employees | 3,991 |
