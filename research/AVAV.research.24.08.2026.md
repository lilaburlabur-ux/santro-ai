...
Signed file: `AVAV.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $148.20 (2026-08-24, ~15-min delayed) |
| Market cap | $7.53B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-32.69%) with negative half-year (-43.29%). |
| Fresh setup quality | Poor / broken | -63.84% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 33.65, EV/Sales 4.19. |
| Risk level | High | Beta 1.41, ATR 7.3% of price, short float 11.32%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $148.20; 52w high $409.83 (-63.84%); 52w low $136.68 (+8.43%) |
| Trend | -32.69% vs SMA200, -7.94% vs SMA50, -12.98% vs SMA20 |
| Momentum | RSI(14) 38.4 (neutral) |
| Volatility | ATR(14) 10.81 (~7.3% of price); beta 1.41 |
| Setup perspective | -63.84% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 33.65, P/S 3.81, P/B 1.70 | EV/Sales 4.19, EV/EBITDA 42.55 |
...
- **Valuation risk:** Forward P/E 33.65, EV/Sales 4.19. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.41, ATR 7.3% of price, short float 11.32%. Size positions accordingly.
...
|---|---|---|---|
| Price | $148.20 | EV/Sales | 4.19 |
| Market cap | $7.53B | EV/EBITDA | 42.55 |
| Beta | 1.41 | Gross margin | 25.32% |
| RSI(14) | 38.4 | Operating margin | 2.81% |
| ATR(14) | 10.81 | Profit margin | -13.41% |
| SMA20 dist | -12.98% | ROA | -1.29% |
| SMA50 dist | -7.94% | ROE | -10.03% |
| SMA200 dist | -32.69% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 88.14% |
| P/E (ttm) | — | Insider ownership | 0.90% |
| Forward P/E | 33.65 | Short float | 11.32% |
| PEG (trailing) | — | Avg volume | 1,670,059 |
