...
Signed file: `AVAV.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $147.42 (2026-08-25, ~15-min delayed) |
| Market cap | $7.49B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-32.73%) with negative half-year (-43.79%). |
| Fresh setup quality | Poor / broken | -64.03% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 33.47, EV/Sales 3.88. |
| Risk level | High | Beta 1.41, ATR 7.0% of price, short float 11.32%. |
...
|---|---|---|
| Here's Why AeroVironment (AVAV) Fell More Than Broader Market | Zacks | 2026-08-24 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $147.42; 52w high $409.83 (-64.03%); 52w low $136.68 (+7.86%) |
| Trend | -32.73% vs SMA200, -8.16% vs SMA50, -13.21% vs SMA20 |
| Momentum | RSI(14) 38.1 (neutral) |
| Volatility | ATR(14) 10.36 (~7.0% of price); beta 1.41 |
| Setup perspective | -64.03% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 33.47, P/S 3.79, P/B 1.69 | EV/Sales 3.88, EV/EBITDA 39.43 |
...
- **Valuation risk:** Forward P/E 33.47, EV/Sales 3.88. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.41, ATR 7.0% of price, short float 11.32%. Size positions accordingly.
...
|---|---|---|---|
| Price | $147.42 | EV/Sales | 3.88 |
| Market cap | $7.49B | EV/EBITDA | 39.43 |
| Beta | 1.41 | Gross margin | 25.32% |
| RSI(14) | 38.1 | Operating margin | 2.81% |
| ATR(14) | 10.36 | Profit margin | -13.41% |
| SMA20 dist | -13.21% | ROA | -1.29% |
| SMA50 dist | -8.16% | ROE | -10.03% |
| SMA200 dist | -32.73% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 88.14% |
| P/E (ttm) | — | Insider ownership | 0.90% |
| Forward P/E | 33.47 | Short float | 11.32% |
| PEG (trailing) | — | Avg volume | 1,663,120 |
| P/S | 3.79 | Employees | 3,991 |
