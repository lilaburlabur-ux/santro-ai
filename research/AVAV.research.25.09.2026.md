...
Signed file: `AVAV.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $152.05 (2026-09-25, ~15-min delayed) |
| Market cap | $7.73B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-25.44%) with negative half-year (-22.39%). |
| Fresh setup quality | Poor / broken | -62.90% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-10.13%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 34.11, EV/Sales 4.14. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $152.05; 52w high $409.83 (-62.90%); 52w low $136.68 (+11.25%) |
| Trend | -25.44% vs SMA200, -4.18% vs SMA50, +0.20% vs SMA20 |
| Momentum | RSI(14) 46.2 (neutral) |
| Volatility | ATR(14) 9.24 (~6.1% of price); beta 1.41 |
| Setup perspective | -62.90% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 34.11, P/S 3.86, P/B 1.75 | EV/Sales 4.14, EV/EBITDA 37.92 |
...
- **Valuation risk:** Forward P/E 34.11, EV/Sales 4.14. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $152.05 | EV/Sales | 4.14 |
| Market cap | $7.73B | EV/EBITDA | 37.92 |
| Beta | 1.41 | Gross margin | 26.47% |
| RSI(14) | 46.2 | Operating margin | -2.27% |
| ATR(14) | 9.24 | Profit margin | -10.13% |
| SMA20 dist | +0.20% | ROA | -0.13% |
| SMA50 dist | -4.18% | ROE | -4.60% |
| SMA200 dist | -25.44% | Revenue (ttm) | $2.00B |
| 52W high | $409.83 | Revenue growth y/y | 5.70% |
| 52W low | $136.68 | Inst. ownership | 88.00% |
| P/E (ttm) | — | Insider ownership | 0.91% |
| Forward P/E | 34.11 | Short float | 11.76% |
| PEG (trailing) | — | Avg volume | 1,944,506 |
| P/S | 3.86 | Employees | 3,991 |
| P/B | 1.75 | Analyst rec (1=buy..5=sell) | 1.6 |
