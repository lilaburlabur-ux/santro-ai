...
Signed file: `AVAV.research.28.07.2026`

| Field | Value |
|---|---|
| Current price | $156.35 (2026-07-28, ~15-min delayed) |
| Market cap | $7.91B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-34.78%) with negative half-year (-48.34%). |
| Fresh setup quality | Poor / broken | -61.85% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Low (expensive) | Forward P/E 35.35, EV/Sales 4.04. |
| Risk level | High | Beta 1.40, ATR 6.8% of price, short float 10.06%. |
...
|---|---|---|
| Is AeroVironment (AVAV) Cheap After Its Army Contract And Legal Headlines? | Simply Wall St. | 2026-07-28 |
| AeroVironment (AVAV) Stock Looks Reasonable On Cash Flow But Rich On Sales | Simply Wall St. | 2026-07-28 |
| ONDS, RCAT, AVAV, UMAC Stocks Slide Overnight: Pentagon’s Drone Push Is Reportedly Facing Major Production Gap | Stocktwits | 2026-07-28 |
| 1 Cash-Burning Stock to Consider Right Now and 2 We Brush Off | StockStory | 2026-07-24 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $156.35; 52w high $409.83 (-61.85%); 52w low $136.68 (+14.39%) |
| Trend | -34.78% vs SMA200, -5.51% vs SMA50, +0.96% vs SMA20 |
| Momentum | RSI(14) 50.4 (neutral) |
| Volatility | ATR(14) 10.61 (~6.8% of price); beta 1.40 |
| Setup perspective | -61.85% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 35.35, P/S 4.00, P/B 1.79 | EV/Sales 4.04, EV/EBITDA 41.00 |
...
- **Valuation risk:** Forward P/E 35.35, EV/Sales 4.04. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.40, ATR 6.8% of price, short float 10.06%. Size positions accordingly.
...
|---|---|---|---|
| Price | $156.35 | EV/Sales | 4.04 |
| Market cap | $7.91B | EV/EBITDA | 41.00 |
| Beta | 1.40 | Gross margin | 25.32% |
| RSI(14) | 50.4 | Operating margin | 2.81% |
| ATR(14) | 10.61 | Profit margin | -13.41% |
| SMA20 dist | +0.96% | ROA | -1.29% |
| SMA50 dist | -5.51% | ROE | -10.03% |
| SMA200 dist | -34.78% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 89.66% |
| P/E (ttm) | — | Insider ownership | 0.89% |
| Forward P/E | 35.35 | Short float | 10.06% |
| PEG (trailing) | — | Avg volume | 1,647,362 |
| P/S | 4.00 | Employees | 3,991 |
| P/B | 1.79 | Analyst rec (1=buy..5=sell) | 1.6 |
