...
Signed file: `AVAV.research.29.07.2026`

| Field | Value |
|---|---|
| Current price | $142.12 (2026-07-29, ~15-min delayed) |
| Market cap | $7.19B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-40.40%) with negative half-year (-54.09%). |
| Fresh setup quality | Poor / broken | -65.32% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 32.13, EV/Sales 4.09. |
| Risk level | High | Beta 1.40, ATR 7.7% of price, short float 10.06%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $142.12; 52w high $409.83 (-65.32%); 52w low $136.68 (+3.98%) |
| Trend | -40.40% vs SMA200, -13.95% vs SMA50, -7.54% vs SMA20 |
| Momentum | RSI(14) 42.9 (neutral) |
| Volatility | ATR(14) 10.91 (~7.7% of price); beta 1.40 |
| Setup perspective | -65.32% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 32.13, P/S 3.64, P/B 1.63 | EV/Sales 4.09, EV/EBITDA 41.54 |
...
- **Valuation risk:** Forward P/E 32.13, EV/Sales 4.09. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.40, ATR 7.7% of price, short float 10.06%. Size positions accordingly.
...
|---|---|---|---|
| Price | $142.12 | EV/Sales | 4.09 |
| Market cap | $7.19B | EV/EBITDA | 41.54 |
| Beta | 1.40 | Gross margin | 25.32% |
| RSI(14) | 42.9 | Operating margin | 2.81% |
| ATR(14) | 10.91 | Profit margin | -13.41% |
| SMA20 dist | -7.54% | ROA | -1.29% |
| SMA50 dist | -13.95% | ROE | -10.03% |
| SMA200 dist | -40.40% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 89.67% |
| P/E (ttm) | — | Insider ownership | 0.89% |
| Forward P/E | 32.13 | Short float | 10.06% |
| PEG (trailing) | — | Avg volume | 1,650,911 |
| P/S | 3.64 | Employees | 3,991 |
| P/B | 1.63 | Analyst rec (1=buy..5=sell) | 1.6 |
