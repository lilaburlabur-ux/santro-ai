...
Signed file: `AVAV.research.30.07.2026`

| Field | Value |
|---|---|
| Current price | $146.57 (2026-07-30, ~15-min delayed) |
| Market cap | $7.42B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-38.21%) with negative half-year (-52.25%). |
| Fresh setup quality | Poor / broken | -64.24% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 33.14, EV/Sales 3.73. |
| Risk level | High | Beta 1.40, ATR 7.2% of price, short float 10.06%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $146.57; 52w high $409.83 (-64.24%); 52w low $136.68 (+7.24%) |
| Trend | -38.21% vs SMA200, -11.09% vs SMA50, -3.84% vs SMA20 |
| Momentum | RSI(14) 45.6 (neutral) |
| Volatility | ATR(14) 10.62 (~7.2% of price); beta 1.40 |
| Setup perspective | -64.24% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 33.14, P/S 3.75, P/B 1.68 | EV/Sales 3.73, EV/EBITDA 37.86 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $225.77 (19 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 89.84% |
...
- **Valuation risk:** Forward P/E 33.14, EV/Sales 3.73. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.40, ATR 7.2% of price, short float 10.06%. Size positions accordingly.
...
|---|---|---|---|
| Price | $146.57 | EV/Sales | 3.73 |
| Market cap | $7.42B | EV/EBITDA | 37.86 |
| Beta | 1.40 | Gross margin | 25.32% |
| RSI(14) | 45.6 | Operating margin | 2.81% |
| ATR(14) | 10.62 | Profit margin | -13.41% |
| SMA20 dist | -3.84% | ROA | -1.29% |
| SMA50 dist | -11.09% | ROE | -10.03% |
| SMA200 dist | -38.21% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 89.84% |
| P/E (ttm) | — | Insider ownership | 0.89% |
| Forward P/E | 33.14 | Short float | 10.06% |
| PEG (trailing) | — | Avg volume | 1,653,844 |
| P/S | 3.75 | Employees | 3,991 |
