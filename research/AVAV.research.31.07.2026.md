...
Signed file: `AVAV.research.31.07.2026`

| Field | Value |
|---|---|
| Current price | $149.37 (2026-07-31, ~15-min delayed) |
| Market cap | $7.56B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-36.68%) with negative half-year (-49.06%). |
| Fresh setup quality | Poor / broken | -63.55% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-13.41%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 33.77, EV/Sales 3.84. |
| Risk level | High | Beta 1.40, ATR 7.0% of price, short float 10.06%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $149.37; 52w high $409.83 (-63.55%); 52w low $136.68 (+9.28%) |
| Trend | -36.68% vs SMA200, -9.27% vs SMA50, -0.64% vs SMA20 |
| Momentum | RSI(14) 47.3 (neutral) |
| Volatility | ATR(14) 10.42 (~7.0% of price); beta 1.40 |
| Setup perspective | -63.55% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 33.77, P/S 3.82, P/B 1.71 | EV/Sales 3.84, EV/EBITDA 39.01 |
...
- **Valuation risk:** Forward P/E 33.77, EV/Sales 3.84. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.40, ATR 7.0% of price, short float 10.06%. Size positions accordingly.
...
|---|---|---|---|
| Price | $149.37 | EV/Sales | 3.84 |
| Market cap | $7.56B | EV/EBITDA | 39.01 |
| Beta | 1.40 | Gross margin | 25.32% |
| RSI(14) | 47.3 | Operating margin | 2.81% |
| ATR(14) | 10.42 | Profit margin | -13.41% |
| SMA20 dist | -0.64% | ROA | -1.29% |
| SMA50 dist | -9.27% | ROE | -10.03% |
| SMA200 dist | -36.68% | Revenue (ttm) | $1.98B |
| 52W high | $409.83 | Revenue growth y/y | 133.30% |
| 52W low | $136.68 | Inst. ownership | 89.94% |
| P/E (ttm) | — | Insider ownership | 0.89% |
| Forward P/E | 33.77 | Short float | 10.06% |
| PEG (trailing) | — | Avg volume | 1,642,472 |
| P/S | 3.82 | Employees | 3,991 |
| P/B | 1.71 | Analyst rec (1=buy..5=sell) | 1.6 |
