...
Signed file: `AVGO.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $418.16 (2026-08-04, ~15-min delayed) |
| Market cap | $1.99T |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +45.93%; price +14.41% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 21.45, EV/Sales 25.33. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $418.16; 52w high $480.81 (-13.03%); 52w low $287.49 (+45.45%) |
| Trend | +14.41% vs SMA200, +5.97% vs SMA50, +7.77% vs SMA20 |
| Momentum | RSI(14) 61.8 (neutral) |
| Volatility | ATR(14) 17.61 (~4.2% of price); beta 1.47 |
...
- **Valuation risk:** Forward P/E 21.45, EV/Sales 25.33. Multiple compression is the main downside if growth disappoints.
...
| P/B | 22.69 | Analyst rec (1=buy..5=sell) | 1.3 |
