...
Signed file: `AVGO.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $339.27 (2026-09-15, ~15-min delayed) |
| Market cap | $1.62T |
...
|---|---|---|
| Technical momentum | Moderate | 1Y -5.03%; price -8.07% vs SMA200. |
| Fresh setup quality | Poor / broken | -29.44% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 42.94%, revenue growth 85.50%. |
| Value attractiveness | Reasonable | Forward P/E 17.50, EV/Sales 18.87. |
| Risk level | Elevated | Beta 1.46, ATR 3.6% of price, short float 1.08%. |
...
| Why Rule Breakers Dig Stocks With Multiple Futures | Motley Fool | 2026-09-15 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $339.27; 52w high $480.81 (-29.44%); 52w low $292.95 (+15.81%) |
| Trend | -8.07% vs SMA200, -11.20% vs SMA50, -6.39% vs SMA20 |
| Momentum | RSI(14) 32.3 (neutral) |
| Volatility | ATR(14) 12.24 (~3.6% of price); beta 1.46 |
| Setup perspective | -29.44% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 43.33, forward P/E 17.50, P/S 18.18, P/B 16.25 | EV/Sales 18.87, EV/EBITDA 32.17 |
...
- **Volatility risk:** Beta 1.46, ATR 3.6% of price, short float 1.08%. Size positions accordingly.
...
|---|---|---|---|
| Price | $339.27 | EV/Sales | 18.87 |
| Market cap | $1.62T | EV/EBITDA | 32.17 |
| Beta | 1.46 | Gross margin | 75.52% |
| RSI(14) | 32.3 | Operating margin | 54.31% |
| ATR(14) | 12.24 | Profit margin | 42.94% |
| SMA20 dist | -6.39% | ROA | 15.37% |
| SMA50 dist | -11.20% | ROE | 44.25% |
| SMA200 dist | -8.07% | Revenue (ttm) | $89.10B |
| 52W high | $480.81 | Revenue growth y/y | 85.50% |
| 52W low | $292.95 | Inst. ownership | 79.82% |
| P/E (ttm) | 43.33 | Insider ownership | 1.94% |
| Forward P/E | 17.50 | Short float | 1.08% |
| PEG (trailing) | 0.34 | Avg volume | 23,790,593 |
| P/S | 18.18 | Employees | 33,000 |
| P/B | 16.25 | Analyst rec (1=buy..5=sell) | 1.3 |
