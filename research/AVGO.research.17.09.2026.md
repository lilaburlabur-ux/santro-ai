...
Signed file: `AVGO.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $347.30 (2026-09-17, ~15-min delayed) |
| Market cap | $1.66T |
...
|---|---|---|
| Technical momentum | Moderate | 1Y -2.82%; price -5.76% vs SMA200. |
| Fresh setup quality | Poor / broken | -27.77% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 42.94%, revenue growth 85.50%. |
| Value attractiveness | Reasonable | Forward P/E 17.92, EV/Sales 18.59. |
| Risk level | Elevated | Beta 1.46, ATR 3.4% of price, short float 1.08%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $347.30; 52w high $480.81 (-27.77%); 52w low $292.95 (+18.55%) |
| Trend | -5.76% vs SMA200, -8.76% vs SMA50, -3.43% vs SMA20 |
| Momentum | RSI(14) 38.5 (neutral) |
| Volatility | ATR(14) 11.92 (~3.4% of price); beta 1.46 |
| Setup perspective | -27.77% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 44.30, forward P/E 17.92, P/S 18.61, P/B 16.63 | EV/Sales 18.59, EV/EBITDA 31.69 |
...
- **Volatility risk:** Beta 1.46, ATR 3.4% of price, short float 1.08%. Size positions accordingly.
...
|---|---|---|---|
| Price | $347.30 | EV/Sales | 18.59 |
| Market cap | $1.66T | EV/EBITDA | 31.69 |
| Beta | 1.46 | Gross margin | 75.52% |
| RSI(14) | 38.5 | Operating margin | 54.31% |
| ATR(14) | 11.92 | Profit margin | 42.94% |
| SMA20 dist | -3.43% | ROA | 15.37% |
| SMA50 dist | -8.76% | ROE | 44.25% |
| SMA200 dist | -5.76% | Revenue (ttm) | $89.10B |
| 52W high | $480.81 | Revenue growth y/y | 85.50% |
| 52W low | $292.95 | Inst. ownership | 79.82% |
| P/E (ttm) | 44.30 | Insider ownership | 1.94% |
| Forward P/E | 17.92 | Short float | 1.08% |
| PEG (trailing) | 0.34 | Avg volume | 23,408,743 |
| P/S | 18.61 | Employees | 33,000 |
| P/B | 16.63 | Analyst rec (1=buy..5=sell) | 1.3 |
