...
Signed file: `AVGO.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $357.61 (2026-09-18, ~15-min delayed) |
| Market cap | $1.71T |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +4.06%; price -2.93% vs SMA200. |
| Fresh setup quality | Poor / broken | -25.62% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 42.94%, revenue growth 85.50%. |
| Value attractiveness | Reasonable | Forward P/E 18.45, EV/Sales 19.00. |
...
| Cisco Drops 8% in 3 Months: Should You Buy the Stock on the Dip? | Zacks | 2026-09-18 |
| Will Micron Follow Nvidia and Give Investors a Huge Dividend Hike? | Motley Fool | 2026-09-18 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $357.61; 52w high $480.81 (-25.62%); 52w low $292.95 (+22.07%) |
| Trend | -2.93% vs SMA200, -5.83% vs SMA50, -0.48% vs SMA20 |
| Momentum | RSI(14) 45.5 (neutral) |
| Volatility | ATR(14) 12.21 (~3.4% of price); beta 1.46 |
| Setup perspective | -25.62% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 45.56, forward P/E 18.45, P/S 19.16, P/B 17.13 | EV/Sales 19.00, EV/EBITDA 32.40 |
...
|---|---|---|---|
| Price | $357.61 | EV/Sales | 19.00 |
| Market cap | $1.71T | EV/EBITDA | 32.40 |
| Beta | 1.46 | Gross margin | 75.52% |
| RSI(14) | 45.5 | Operating margin | 54.31% |
| ATR(14) | 12.21 | Profit margin | 42.94% |
| SMA20 dist | -0.48% | ROA | 15.37% |
| SMA50 dist | -5.83% | ROE | 44.25% |
| SMA200 dist | -2.93% | Revenue (ttm) | $89.10B |
| 52W high | $480.81 | Revenue growth y/y | 85.50% |
| 52W low | $292.95 | Inst. ownership | 79.82% |
| P/E (ttm) | 45.56 | Insider ownership | 1.94% |
| Forward P/E | 18.45 | Short float | 1.08% |
| PEG (trailing) | 0.34 | Avg volume | 23,075,912 |
| P/S | 19.16 | Employees | 33,000 |
| P/B | 17.13 | Analyst rec (1=buy..5=sell) | 1.3 |
