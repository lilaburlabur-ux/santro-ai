...
Signed file: `AVGO.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $362.48 (2026-08-19, ~15-min delayed) |
| Market cap | $1.72T |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +19.42%; price -1.57% vs SMA200. |
| Fresh setup quality | Moderate / wait | -24.61% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 38.85%, revenue growth 47.90%. |
| Value attractiveness | Reasonable | Forward P/E 18.56, EV/Sales 24.56. |
| Risk level | Elevated | Beta 1.47, ATR 4.5% of price, short float 1.31%. |
...
| NVIDIA vs. Broadcom: The AI Stock You Should Buy Right Now | Zacks | 2026-08-19 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $362.48; 52w high $480.81 (-24.61%); 52w low $287.49 (+26.08%) |
| Trend | -1.57% vs SMA200, -6.83% vs SMA50, -8.96% vs SMA20 |
| Momentum | RSI(14) 35.3 (neutral) |
| Volatility | ATR(14) 16.43 (~4.5% of price); beta 1.47 |
| Setup perspective | -24.61% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 60.41, forward P/E 18.56, P/S 22.85, P/B 19.67 | EV/Sales 24.56, EV/EBITDA 44.03 |
...
- **Volatility risk:** Beta 1.47, ATR 4.5% of price, short float 1.31%. Size positions accordingly.
...
|---|---|---|---|
| Price | $362.48 | EV/Sales | 24.56 |
| Market cap | $1.72T | EV/EBITDA | 44.03 |
| Beta | 1.47 | Gross margin | 76.28% |
| RSI(14) | 35.3 | Operating margin | 48.99% |
| ATR(14) | 16.43 | Profit margin | 38.85% |
| SMA20 dist | -8.96% | ROA | 12.12% |
| SMA50 dist | -6.83% | ROE | 37.28% |
| SMA200 dist | -1.57% | Revenue (ttm) | $75.46B |
| 52W high | $480.81 | Revenue growth y/y | 47.90% |
| 52W low | $287.49 | Inst. ownership | 80.41% |
| P/E (ttm) | 60.41 | Insider ownership | 1.95% |
| Forward P/E | 18.56 | Short float | 1.31% |
| PEG (trailing) | 0.43 | Avg volume | 25,897,148 |
| P/S | 22.85 | Employees | 33,000 |
| P/B | 19.67 | Analyst rec (1=buy..5=sell) | 1.3 |
