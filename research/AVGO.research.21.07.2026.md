...
Signed file: `AVGO.research.21.07.2026`

| Field | Value |
|---|---|
| Current price | $386.50 (2026-07-21, ~15-min delayed) |
| Market cap | $1.84T |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +37.41%; price +6.47% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 19.86, EV/Sales 24.44. |
| Risk level | Elevated | Beta 1.46, ATR 4.3% of price, short float 1.50%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $386.50; 52w high $480.81 (-19.61%); 52w low $276.56 (+39.75%) |
| Trend | +6.47% vs SMA200, -3.64% vs SMA50, +1.74% vs SMA20 |
| Momentum | RSI(14) 50.0 (neutral) |
| Volatility | ATR(14) 16.70 (~4.3% of price); beta 1.46 |
...
| Valuation | P/E 64.31, forward P/E 19.86, P/S 24.37, P/B 20.97 | EV/Sales 24.44, EV/EBITDA 43.83 |
...
- **Volatility risk:** Beta 1.46, ATR 4.3% of price, short float 1.50%. Size positions accordingly.
...
|---|---|---|---|
| Price | $386.50 | EV/Sales | 24.44 |
| Market cap | $1.84T | EV/EBITDA | 43.83 |
| Beta | 1.46 | Gross margin | 76.28% |
| RSI(14) | 50.0 | Operating margin | 48.99% |
| ATR(14) | 16.70 | Profit margin | 38.85% |
| SMA20 dist | +1.74% | ROA | 12.12% |
| SMA50 dist | -3.64% | ROE | 37.28% |
| SMA200 dist | +6.47% | Revenue (ttm) | $75.46B |
| 52W high | $480.81 | Revenue growth y/y | 47.90% |
| 52W low | $276.56 | Inst. ownership | 80.20% |
| P/E (ttm) | 64.31 | Insider ownership | 1.94% |
| Forward P/E | 19.86 | Short float | 1.50% |
| PEG (trailing) | 0.43 | Avg volume | 26,324,632 |
| P/S | 24.37 | Employees | 33,000 |
| P/B | 20.97 | Analyst rec (1=buy..5=sell) | 1.3 |
