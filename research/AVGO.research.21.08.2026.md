...
Signed file: `AVGO.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $368.45 (2026-08-21, ~15-min delayed) |
| Market cap | $1.75T |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +27.47%; price +0.04% vs SMA200. |
| Fresh setup quality | Moderate / wait | -23.37% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 38.85%, revenue growth 47.90%. |
| Value attractiveness | Reasonable | Forward P/E 18.89, EV/Sales 23.55. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $368.45; 52w high $480.81 (-23.37%); 52w low $287.49 (+28.16%) |
| Trend | +0.04% vs SMA200, -5.14% vs SMA50, -6.97% vs SMA20 |
| Momentum | RSI(14) 38.7 (neutral) |
| Volatility | ATR(14) 15.28 (~4.1% of price); beta 1.47 |
| Setup perspective | -23.37% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 61.31, forward P/E 18.89, P/S 23.23, P/B 19.99 | EV/Sales 23.55, EV/EBITDA 42.23 |
...
|---|---|---|---|
| Price | $368.45 | EV/Sales | 23.55 |
| Market cap | $1.75T | EV/EBITDA | 42.23 |
| Beta | 1.47 | Gross margin | 76.28% |
| RSI(14) | 38.7 | Operating margin | 48.99% |
| ATR(14) | 15.28 | Profit margin | 38.85% |
| SMA20 dist | -6.97% | ROA | 12.12% |
| SMA50 dist | -5.14% | ROE | 37.28% |
| SMA200 dist | +0.04% | Revenue (ttm) | $75.46B |
| 52W high | $480.81 | Revenue growth y/y | 47.90% |
| 52W low | $287.49 | Inst. ownership | 80.18% |
| P/E (ttm) | 61.31 | Insider ownership | 1.95% |
| Forward P/E | 18.89 | Short float | 1.31% |
| PEG (trailing) | 0.41 | Avg volume | 26,246,308 |
| P/S | 23.23 | Employees | 33,000 |
| P/B | 19.99 | Analyst rec (1=buy..5=sell) | 1.3 |
