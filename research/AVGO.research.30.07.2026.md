...
Signed file: `AVGO.research.30.07.2026`

| Field | Value |
|---|---|
| Current price | $387.84 (2026-07-30, ~15-min delayed) |
| Market cap | $1.85T |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +31.36%; price +6.34% vs SMA200. |
| Fresh setup quality | Moderate / wait | -19.34% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 38.85%, revenue growth 47.90%. |
| Value attractiveness | Reasonable | Forward P/E 19.90, EV/Sales 23.95. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $387.84; 52w high $480.81 (-19.34%); 52w low $286.54 (+35.35%) |
| Trend | +6.34% vs SMA200, -1.93% vs SMA50, +1.19% vs SMA20 |
| Momentum | RSI(14) 50.9 (neutral) |
| Volatility | ATR(14) 16.28 (~4.2% of price); beta 1.46 |
| Setup perspective | -19.34% from 52w high; no clean fresh pivot by default. |
...
|---|---|---|---|
| Price | $387.84 | EV/Sales | 23.95 |
| Market cap | $1.85T | EV/EBITDA | 42.94 |
| Beta | 1.46 | Gross margin | 76.28% |
| RSI(14) | 50.9 | Operating margin | 48.99% |
| ATR(14) | 16.28 | Profit margin | 38.85% |
| SMA20 dist | +1.19% | ROA | 12.12% |
...
| P/B | 21.04 | Analyst rec (1=buy..5=sell) | 1.3 |
