...
Signed file: `CEVA.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $36.22 (2026-08-04, ~15-min delayed) |
| Market cap | $1.01B |
...
|---|---|---|
| Technical momentum | High | 1Y +74.98%; price +27.77% vs SMA200. |
| Fresh setup quality | Poor / broken | -27.65% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-10.47%). |
| Value attractiveness | Low (expensive) | Forward P/E 43.85, EV/Sales 6.48. |
| Risk level | High | Beta 2.01, ATR 8.9% of price, short float 7.35%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $36.22; 52w high $50.06 (-27.65%); 52w low $17.21 (+110.46%) |
| Trend | +27.77% vs SMA200, -14.03% vs SMA50, -5.50% vs SMA20 |
| Momentum | RSI(14) 46.2 (neutral) |
| Volatility | ATR(14) 3.24 (~8.9% of price); beta 2.01 |
| Setup perspective | -27.65% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 43.85, P/S 8.98, P/B 2.98 | EV/Sales 6.48, EV/EBITDA -93.61 |
...
- **Valuation risk:** Forward P/E 43.85, EV/Sales 6.48. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.01, ATR 8.9% of price, short float 7.35%. Size positions accordingly.
...
|---|---|---|---|
| Price | $36.22 | EV/Sales | 6.48 |
| Market cap | $1.01B | EV/EBITDA | -93.61 |
| Beta | 2.01 | Gross margin | 87.19% |
| RSI(14) | 46.2 | Operating margin | -18.82% |
| ATR(14) | 3.24 | Profit margin | -10.47% |
| SMA20 dist | -5.50% | ROA | -2.16% |
| SMA50 dist | -14.03% | ROE | -3.88% |
| SMA200 dist | +27.77% | Revenue (ttm) | $112.38M |
| 52W high | $50.06 | Revenue growth y/y | 11.50% |
| 52W low | $17.21 | Inst. ownership | 94.59% |
| P/E (ttm) | — | Insider ownership | 3.11% |
| Forward P/E | 43.85 | Short float | 7.35% |
| PEG (trailing) | 3.20 | Avg volume | 884,752 |
| P/S | 8.98 | Employees | 400 |
| P/B | 2.98 | Analyst rec (1=buy..5=sell) | 1.6 |
