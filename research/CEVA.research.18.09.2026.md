...
Signed file: `CEVA.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $30.27 (2026-09-18, ~15-min delayed) |
| Market cap | $852.22M |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +22.01%; price +4.15% vs SMA200. |
| Fresh setup quality | Poor / broken | -39.53% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-9.48%). |
| Value attractiveness | Low (expensive) | Forward P/E 37.72, EV/Sales 5.50. |
| Risk level | High | Beta 1.98, ATR 5.6% of price, short float 10.33%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $30.27; 52w high $50.06 (-39.53%); 52w low $17.21 (+75.89%) |
| Trend | +4.15% vs SMA200, -6.32% vs SMA50, +9.13% vs SMA20 |
| Momentum | RSI(14) 53.3 (neutral) |
| Volatility | ATR(14) 1.69 (~5.6% of price); beta 1.98 |
| Setup perspective | -39.53% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 37.72, P/S 7.36, P/B 2.50 | EV/Sales 5.50, EV/EBITDA -112.13 |
...
- **Valuation risk:** Forward P/E 37.72, EV/Sales 5.50. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.98, ATR 5.6% of price, short float 10.33%. Size positions accordingly.
...
|---|---|---|---|
| Price | $30.27 | EV/Sales | 5.50 |
| Market cap | $852.22M | EV/EBITDA | -112.13 |
| Beta | 1.98 | Gross margin | 87.47% |
| RSI(14) | 53.3 | Operating margin | -7.15% |
| ATR(14) | 1.69 | Profit margin | -9.48% |
| SMA20 dist | +9.13% | ROA | -1.74% |
| SMA50 dist | -6.32% | ROE | -3.62% |
| SMA200 dist | +4.15% | Revenue (ttm) | $115.73M |
| 52W high | $50.06 | Revenue growth y/y | 13.10% |
| 52W low | $17.21 | Inst. ownership | 91.93% |
| P/E (ttm) | — | Insider ownership | 3.50% |
| Forward P/E | 37.72 | Short float | 10.33% |
| PEG (trailing) | 2.13 | Avg volume | 772,617 |
| P/S | 7.36 | Employees | 374 |
| P/B | 2.50 | Analyst rec (1=buy..5=sell) | 1.3 |
