...
Signed file: `CEVA.research.24.07.2026`

| Field | Value |
|---|---|
| Current price | $36.35 (2026-07-24, ~15-min delayed) |
| Market cap | $1.01B |
...
|---|---|---|
| Technical momentum | High | 1Y +56.21%; price +28.91% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 44.20, EV/Sales 7.84. |
| Risk level | High | Beta 1.97, ATR 9.2% of price, short float 6.57%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $36.35; 52w high $50.06 (-27.39%); 52w low $17.21 (+111.21%) |
| Trend | +28.91% vs SMA200, -14.95% vs SMA50, -13.52% vs SMA20 |
| Momentum | RSI(14) 39.9 (neutral) |
| Volatility | ATR(14) 3.36 (~9.2% of price); beta 1.97 |
| Setup perspective | -27.39% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 44.20, P/S 9.01, P/B 2.99 | EV/Sales 7.84, EV/EBITDA -113.27 |
...
- **Valuation risk:** Forward P/E 44.20, EV/Sales 7.84. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.97, ATR 9.2% of price, short float 6.57%. Size positions accordingly.
...
|---|---|---|---|
| Price | $36.35 | EV/Sales | 7.84 |
| Market cap | $1.01B | EV/EBITDA | -113.27 |
| Beta | 1.97 | Gross margin | 87.19% |
| RSI(14) | 39.9 | Operating margin | -18.82% |
| ATR(14) | 3.36 | Profit margin | -10.47% |
| SMA20 dist | -13.52% | ROA | -2.16% |
| SMA50 dist | -14.95% | ROE | -3.88% |
| SMA200 dist | +28.91% | Revenue (ttm) | $112.38M |
| 52W high | $50.06 | Revenue growth y/y | 11.50% |
| 52W low | $17.21 | Inst. ownership | 93.41% |
| P/E (ttm) | — | Insider ownership | 3.11% |
| Forward P/E | 44.20 | Short float | 6.57% |
| PEG (trailing) | 3.80 | Avg volume | 897,596 |
| P/S | 9.01 | Employees | 400 |
| P/B | 2.99 | Analyst rec (1=buy..5=sell) | 1.6 |
