...
Signed file: `CEVA.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $36.20 (2026-09-25, ~15-min delayed) |
| Market cap | $1.02B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $36.20; 52w high $50.06 (-27.69%); 52w low $17.21 (+110.34%) |
| Trend | +23.31% vs SMA200, +15.04% vs SMA50, +23.37% vs SMA20 |
| Momentum | RSI(14) 70.2 (overbought) |
| Volatility | ATR(14) 1.79 (~4.9% of price); beta 1.98 |
| Setup perspective | -27.69% from 52w high — base needs to rebuild. |
...
| SMA20 dist | +23.37% | ROA | -1.74% |
| SMA50 dist | +15.04% | ROE | -3.62% |
| SMA200 dist | +23.31% | Revenue (ttm) | $115.73M |
| 52W high | $50.06 | Revenue growth y/y | 13.10% |
| 52W low | $17.21 | Inst. ownership | 91.98% |
| P/E (ttm) | — | Insider ownership | 3.50% |
| Forward P/E | 45.11 | Short float | 11.57% |
| PEG (trailing) | 2.13 | Avg volume | 770,580 |
| P/S | 8.81 | Employees | 374 |
| P/B | 2.99 | Analyst rec (1=buy..5=sell) | 1.3 |
