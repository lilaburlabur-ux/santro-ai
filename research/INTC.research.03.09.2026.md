...
Signed file: `INTC.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $91.67 (2026-09-03, ~15-min delayed) |
| Market cap | $484.58B |
...
|---|---|---|
| Technical momentum | High | 1Y +281.96%; price +24.13% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 44.93, EV/Sales 8.75. |
| Risk level | High | Beta 2.24, ATR 5.7% of price, short float 2.57%. |
...
|---|---|---|
| Intel (INTC) Outperforms Broader Market: What You Need to Know | Zacks | 2026-09-03 |
| Nvidia’s $5 Billion Intel Bet Was Worth $30 Billion by June. Is the Partnership Still Mispriced? | Insider Monkey | 2026-09-03 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $91.67; 52w high $140.94 (-34.96%); 52w low $24.08 (+280.69%) |
| Trend | +24.13% vs SMA200, -9.55% vs SMA50, -2.73% vs SMA20 |
| Momentum | RSI(14) 45.5 (neutral) |
| Volatility | ATR(14) 5.18 (~5.7% of price); beta 2.24 |
...
| Valuation | P/E —, forward P/E 44.93, P/S 8.50, P/B 5.28 | EV/Sales 8.75, EV/EBITDA 29.62 |
...
- **Valuation risk:** Forward P/E 44.93, EV/Sales 8.75. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.24, ATR 5.7% of price, short float 2.57%. Size positions accordingly.
...
|---|---|---|---|
| Price | $91.67 | EV/Sales | 8.75 |
| Market cap | $484.58B | EV/EBITDA | 29.62 |
| Beta | 2.24 | Gross margin | 38.87% |
| RSI(14) | 45.5 | Operating margin | 12.19% |
| ATR(14) | 5.18 | Profit margin | -19.79% |
| SMA20 dist | -2.73% | ROA | 1.41% |
| SMA50 dist | -9.55% | ROE | -10.71% |
| SMA200 dist | +24.13% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $24.08 | Inst. ownership | 62.53% |
| P/E (ttm) | — | Insider ownership | 13.99% |
| Forward P/E | 44.93 | Short float | 2.57% |
| PEG (trailing) | — | Avg volume | 114,486,473 |
| P/S | 8.50 | Employees | 85,100 |
| P/B | 5.28 | Analyst rec (1=buy..5=sell) | — |
