...
Signed file: `INTC.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $100.86 (2026-08-04, ~15-min delayed) |
| Market cap | $508.74B |
...
|---|---|---|
| Technical momentum | High | 1Y +422.32%; price +49.13% vs SMA200. |
| Fresh setup quality | Poor / broken | -28.44% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-19.79%). |
| Value attractiveness | Low (expensive) | Forward P/E 49.10, EV/Sales 8.69. |
| Risk level | High | Beta 2.24, ATR 8.5% of price, short float 2.40%. |
...
| Intel's Packaging Progress Points to Google | GuruFocus.com | 2026-08-04 |
| Why Nvidia Stock Still Trades at a Heavy Discount to Chip Rivals | Barrons.com | 2026-08-04 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $100.86; 52w high $140.94 (-28.44%); 52w low $19.50 (+417.23%) |
| Trend | +49.13% vs SMA200, -9.87% vs SMA50, +2.44% vs SMA20 |
| Momentum | RSI(14) 49.4 (neutral) |
| Volatility | ATR(14) 8.58 (~8.5% of price); beta 2.24 |
| Setup perspective | -28.44% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 49.10, P/S 8.92, P/B 5.81 | EV/Sales 8.69, EV/EBITDA 29.42 |
...
- **Valuation risk:** Forward P/E 49.10, EV/Sales 8.69. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.24, ATR 8.5% of price, short float 2.40%. Size positions accordingly.
...
|---|---|---|---|
| Price | $100.86 | EV/Sales | 8.69 |
| Market cap | $508.74B | EV/EBITDA | 29.42 |
| Beta | 2.24 | Gross margin | 38.87% |
| RSI(14) | 49.4 | Operating margin | 12.19% |
| ATR(14) | 8.58 | Profit margin | -19.79% |
| SMA20 dist | +2.44% | ROA | 1.41% |
| SMA50 dist | -9.87% | ROE | -10.71% |
| SMA200 dist | +49.13% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $19.50 | Inst. ownership | 63.57% |
| P/E (ttm) | — | Insider ownership | 14.67% |
| Forward P/E | 49.10 | Short float | 2.40% |
| PEG (trailing) | — | Avg volume | 129,428,093 |
| P/S | 8.92 | Employees | 85,100 |
| P/B | 5.81 | Analyst rec (1=buy..5=sell) | 2.6 |
