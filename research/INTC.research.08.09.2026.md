...
Signed file: `INTC.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $104.47 (2026-09-08, ~15-min delayed) |
| Market cap | $552.24B |
...
|---|---|---|
| Technical momentum | High | 1Y +326.58%; price +40.22% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 51.16, EV/Sales 9.11. |
| Risk level | High | Beta 2.23, ATR 5.2% of price, short float 2.57%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $104.47; 52w high $140.94 (-25.88%); 52w low $24.08 (+333.85%) |
| Trend | +40.22% vs SMA200, +4.33% vs SMA50, +10.79% vs SMA20 |
| Momentum | RSI(14) 61.7 (neutral) |
| Volatility | ATR(14) 5.48 (~5.2% of price); beta 2.23 |
...
| Valuation | P/E —, forward P/E 51.16, P/S 9.68, P/B 6.02 | EV/Sales 9.11, EV/EBITDA 30.86 |
...
- **Valuation risk:** Forward P/E 51.16, EV/Sales 9.11. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.23, ATR 5.2% of price, short float 2.57%. Size positions accordingly.
...
|---|---|---|---|
| Price | $104.47 | EV/Sales | 9.11 |
| Market cap | $552.24B | EV/EBITDA | 30.86 |
| Beta | 2.23 | Gross margin | 38.87% |
| RSI(14) | 61.7 | Operating margin | 12.19% |
| ATR(14) | 5.48 | Profit margin | -19.79% |
| SMA20 dist | +10.79% | ROA | 1.41% |
...
| P/S | 9.68 | Employees | 85,100 |
| P/B | 6.02 | Analyst rec (1=buy..5=sell) | 2.5 |
