...
Signed file: `INTC.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $106.24 (2026-09-09, ~15-min delayed) |
| Market cap | $561.60B |
...
|---|---|---|
| Technical momentum | High | 1Y +333.99%; price +41.92% vs SMA200. |
| Fresh setup quality | Moderate / wait | -24.62% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Weak | Negative profit margin (-19.79%). |
| Value attractiveness | Low (expensive) | Forward P/E 52.01, EV/Sales 9.88. |
| Risk level | High | Beta 2.23, ATR 5.1% of price, short float 2.57%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $106.24; 52w high $140.94 (-24.62%); 52w low $24.08 (+341.20%) |
| Trend | +41.92% vs SMA200, +6.65% vs SMA50, +12.16% vs SMA20 |
| Momentum | RSI(14) 63.4 (neutral) |
| Volatility | ATR(14) 5.37 (~5.1% of price); beta 2.23 |
| Setup perspective | -24.62% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E 52.01, P/S 9.85, P/B 6.12 | EV/Sales 9.88, EV/EBITDA 33.45 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $115.88 (42 analysts) |
...
- **Valuation risk:** Forward P/E 52.01, EV/Sales 9.88. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.23, ATR 5.1% of price, short float 2.57%. Size positions accordingly.
...
|---|---|---|---|
| Price | $106.24 | EV/Sales | 9.88 |
| Market cap | $561.60B | EV/EBITDA | 33.45 |
| Beta | 2.23 | Gross margin | 38.87% |
| RSI(14) | 63.4 | Operating margin | 12.19% |
| ATR(14) | 5.37 | Profit margin | -19.79% |
| SMA20 dist | +12.16% | ROA | 1.41% |
| SMA50 dist | +6.65% | ROE | -10.71% |
| SMA200 dist | +41.92% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $24.08 | Inst. ownership | 62.61% |
| P/E (ttm) | — | Insider ownership | 13.99% |
| Forward P/E | 52.01 | Short float | 2.57% |
| PEG (trailing) | — | Avg volume | 113,243,461 |
| P/S | 9.85 | Employees | 85,100 |
| P/B | 6.12 | Analyst rec (1=buy..5=sell) | 2.5 |
