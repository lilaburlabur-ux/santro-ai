...
Signed file: `INTC.research.10.08.2026`

| Field | Value |
|---|---|
| Current price | $97.52 (2026-08-10, ~15-min delayed) |
| Market cap | $491.89B |
...
|---|---|---|
| Technical momentum | High | 1Y +393.27%; price +41.58% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 47.37, EV/Sales 9.63. |
| Risk level | High | Beta 2.24, ATR 8.1% of price, short float 2.40%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $97.52; 52w high $140.94 (-30.81%); 52w low $19.95 (+388.82%) |
| Trend | +41.58% vs SMA200, -11.49% vs SMA50, +0.87% vs SMA20 |
| Momentum | RSI(14) 46.5 (neutral) |
| Volatility | ATR(14) 7.89 (~8.1% of price); beta 2.24 |
...
| Valuation | P/E —, forward P/E 47.37, P/S 8.62, P/B 5.62 | EV/Sales 9.63, EV/EBITDA 32.61 |
...
- **Valuation risk:** Forward P/E 47.37, EV/Sales 9.63. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.24, ATR 8.1% of price, short float 2.40%. Size positions accordingly.
...
|---|---|---|---|
| Price | $97.52 | EV/Sales | 9.63 |
| Market cap | $491.89B | EV/EBITDA | 32.61 |
| Beta | 2.24 | Gross margin | 38.87% |
| RSI(14) | 46.5 | Operating margin | 12.19% |
| ATR(14) | 7.89 | Profit margin | -19.79% |
| SMA20 dist | +0.87% | ROA | 1.41% |
| SMA50 dist | -11.49% | ROE | -10.71% |
| SMA200 dist | +41.58% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $19.95 | Inst. ownership | 63.40% |
| P/E (ttm) | — | Insider ownership | 14.67% |
| Forward P/E | 47.37 | Short float | 2.40% |
| PEG (trailing) | — | Avg volume | 123,393,238 |
| P/S | 8.62 | Employees | 85,100 |
