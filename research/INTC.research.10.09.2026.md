...
Signed file: `INTC.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $100.32 (2026-09-10, ~15-min delayed) |
| Market cap | $530.30B |
...
|---|---|---|
| Technical momentum | High | 1Y +310.47%; price +33.41% vs SMA200. |
| Fresh setup quality | Poor / broken | -28.82% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-19.79%). |
| Value attractiveness | Low (expensive) | Forward P/E 49.06, EV/Sales 9.51. |
| Risk level | High | Beta 2.23, ATR 5.5% of price, short float 2.57%. |
...
| Why Intel Stock Slumped Today | Motley Fool | 2026-09-10 |
| Intel Stock Plunges 4% as Piper Sandler Turns Neutral on Chipmaker | GuruFocus.com | 2026-09-10 |
| Can Marvell Stock Make You Money Before Its Hyperscaler Deal Pays Off? | Trefis | 2026-09-10 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $100.32; 52w high $140.94 (-28.82%); 52w low $24.08 (+316.61%) |
| Trend | +33.41% vs SMA200, +1.50% vs SMA50, +5.95% vs SMA20 |
| Momentum | RSI(14) 54.8 (neutral) |
| Volatility | ATR(14) 5.49 (~5.5% of price); beta 2.23 |
| Setup perspective | -28.82% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 49.06, P/S 9.30, P/B 5.78 | EV/Sales 9.51, EV/EBITDA 32.21 |
...
- **Valuation risk:** Forward P/E 49.06, EV/Sales 9.51. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.23, ATR 5.5% of price, short float 2.57%. Size positions accordingly.
...
|---|---|---|---|
| Price | $100.32 | EV/Sales | 9.51 |
| Market cap | $530.30B | EV/EBITDA | 32.21 |
| Beta | 2.23 | Gross margin | 38.87% |
| RSI(14) | 54.8 | Operating margin | 12.19% |
| ATR(14) | 5.49 | Profit margin | -19.79% |
| SMA20 dist | +5.95% | ROA | 1.41% |
| SMA50 dist | +1.50% | ROE | -10.71% |
| SMA200 dist | +33.41% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $24.08 | Inst. ownership | 62.61% |
| P/E (ttm) | — | Insider ownership | 13.99% |
| Forward P/E | 49.06 | Short float | 2.57% |
| PEG (trailing) | — | Avg volume | 112,830,870 |
| P/S | 9.30 | Employees | 85,100 |
| P/B | 5.78 | Analyst rec (1=buy..5=sell) | 2.5 |
