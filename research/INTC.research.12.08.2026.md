...
Signed file: `INTC.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $100.95 (2026-08-12, ~15-min delayed) |
| Market cap | $509.19B |
...
|---|---|---|
| Technical momentum | High | 1Y +388.86%; price +45.26% vs SMA200. |
| Fresh setup quality | Poor / broken | -28.37% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-19.79%). |
| Value attractiveness | Low (expensive) | Forward P/E 48.75, EV/Sales 9.28. |
| Risk level | High | Beta 2.24, ATR 7.3% of price, short float 2.48%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $100.95; 52w high $140.94 (-28.37%); 52w low $21.81 (+362.86%) |
| Trend | +45.26% vs SMA200, -7.95% vs SMA50, +5.08% vs SMA20 |
| Momentum | RSI(14) 50.0 (neutral) |
| Volatility | ATR(14) 7.39 (~7.3% of price); beta 2.24 |
| Setup perspective | -28.37% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 48.75, P/S 8.93, P/B 5.82 | EV/Sales 9.28, EV/EBITDA 31.43 |
...
- **Valuation risk:** Forward P/E 48.75, EV/Sales 9.28. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.24, ATR 7.3% of price, short float 2.48%. Size positions accordingly.
...
|---|---|---|---|
| Price | $100.95 | EV/Sales | 9.28 |
| Market cap | $509.19B | EV/EBITDA | 31.43 |
| Beta | 2.24 | Gross margin | 38.87% |
| RSI(14) | 50.0 | Operating margin | 12.19% |
| ATR(14) | 7.39 | Profit margin | -19.79% |
| SMA20 dist | +5.08% | ROA | 1.41% |
| SMA50 dist | -7.95% | ROE | -10.71% |
| SMA200 dist | +45.26% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $21.81 | Inst. ownership | 63.10% |
| P/E (ttm) | — | Insider ownership | 14.67% |
| Forward P/E | 48.75 | Short float | 2.48% |
| PEG (trailing) | — | Avg volume | 121,990,977 |
| P/S | 8.93 | Employees | 85,100 |
| P/B | 5.82 | Analyst rec (1=buy..5=sell) | 2.6 |
