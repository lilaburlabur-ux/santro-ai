...
Signed file: `INTC.research.14.08.2026`

| Field | Value |
|---|---|
| Current price | $102.50 (2026-08-14, ~15-min delayed) |
| Market cap | $541.83B |
...
|---|---|---|
| Technical momentum | High | 1Y +361.30%; price +46.13% vs SMA200. |
| Fresh setup quality | Poor / broken | -27.27% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-19.79%). |
| Value attractiveness | Low (expensive) | Forward P/E 50.24, EV/Sales 9.89. |
...
| 1 Semiconductor Stock on Our Buy List and 2 We Brush Off | StockStory | 2026-08-14 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $102.50; 52w high $140.94 (-27.27%); 52w low $23.50 (+336.17%) |
| Trend | +46.13% vs SMA200, -6.31% vs SMA50, +5.86% vs SMA20 |
| Momentum | RSI(14) 51.3 (neutral) |
| Volatility | ATR(14) 7.20 (~7.0% of price); beta 2.24 |
| Setup perspective | -27.27% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 50.24, P/S 9.50, P/B 5.90 | EV/Sales 9.89, EV/EBITDA 33.48 |
...
| Primecap Management Company | 75,761,968 | 1.50% | 2026-03-31 |
| Capital Research Global Investors | 73,749,883 | 1.46% | 2026-06-30 |

## 6. Risk Review and Setup Plan
- **Valuation risk:** Forward P/E 50.24, EV/Sales 9.89. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $102.50 | EV/Sales | 9.89 |
| Market cap | $541.83B | EV/EBITDA | 33.48 |
| Beta | 2.24 | Gross margin | 38.87% |
| RSI(14) | 51.3 | Operating margin | 12.19% |
| ATR(14) | 7.20 | Profit margin | -19.79% |
| SMA20 dist | +5.86% | ROA | 1.41% |
...
| P/B | 5.90 | Analyst rec (1=buy..5=sell) | 2.6 |
