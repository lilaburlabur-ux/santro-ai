...
Signed file: `INTC.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $97.19 (2026-09-14, ~15-min delayed) |
| Market cap | $513.76B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $97.19; 52w high $140.94 (-31.04%); 52w low $24.08 (+303.61%) |
| Trend | +28.14% vs SMA200, -0.71% vs SMA50, +3.02% vs SMA20 |
| Momentum | RSI(14) 50.3 (neutral) |
| Volatility | ATR(14) 5.64 (~5.8% of price); beta 2.23 |
| Setup perspective | -31.04% from 52w high — base needs to rebuild. |
...
| SMA20 dist | +3.02% | ROA | 1.41% |
| SMA50 dist | -0.71% | ROE | -10.71% |
| SMA200 dist | +28.14% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $24.08 | Inst. ownership | 62.51% |
| P/E (ttm) | — | Insider ownership | 13.99% |
| Forward P/E | 47.53 | Short float | 2.88% |
| PEG (trailing) | — | Avg volume | 110,321,322 |
| P/S | 9.01 | Employees | 85,100 |
