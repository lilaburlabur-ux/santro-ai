...
Signed file: `INTC.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $97.14 (2026-09-15, ~15-min delayed) |
| Market cap | $513.49B |
...
|---|---|---|
| Technical momentum | High | 1Y +303.41%; price +27.56% vs SMA200. |
| Fresh setup quality | Poor / broken | -31.08% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-19.79%). |
| Value attractiveness | Low (expensive) | Forward P/E 47.51, EV/Sales 9.23. |
| Risk level | High | Beta 2.23, ATR 5.7% of price, short float 2.88%. |
...
| Stock Market Midday, Sept. 15: Stocks Slide on AI and Bond Jitters | Motley Fool | 2026-09-15 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $97.14; 52w high $140.94 (-31.08%); 52w low $24.77 (+292.17%) |
| Trend | +27.56% vs SMA200, -0.25% vs SMA50, +3.31% vs SMA20 |
| Momentum | RSI(14) 50.3 (neutral) |
| Volatility | ATR(14) 5.52 (~5.7% of price); beta 2.23 |
| Setup perspective | -31.08% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 47.51, P/S 9.00, P/B 5.60 | EV/Sales 9.23, EV/EBITDA 31.27 |
...
- **Valuation risk:** Forward P/E 47.51, EV/Sales 9.23. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.23, ATR 5.7% of price, short float 2.88%. Size positions accordingly.
...
|---|---|---|---|
| Price | $97.14 | EV/Sales | 9.23 |
| Market cap | $513.49B | EV/EBITDA | 31.27 |
| Beta | 2.23 | Gross margin | 38.87% |
| RSI(14) | 50.3 | Operating margin | 12.19% |
| ATR(14) | 5.52 | Profit margin | -19.79% |
| SMA20 dist | +3.31% | ROA | 1.41% |
| SMA50 dist | -0.25% | ROE | -10.71% |
| SMA200 dist | +27.56% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $24.77 | Inst. ownership | 62.52% |
| P/E (ttm) | — | Insider ownership | 13.99% |
| Forward P/E | 47.51 | Short float | 2.88% |
| PEG (trailing) | — | Avg volume | 109,706,588 |
| P/S | 9.00 | Employees | 85,100 |
| P/B | 5.60 | Analyst rec (1=buy..5=sell) | 2.5 |
