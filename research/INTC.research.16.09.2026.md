...
Signed file: `INTC.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $101.05 (2026-09-16, ~15-min delayed) |
| Market cap | $534.16B |
...
|---|---|---|
| Technical momentum | High | 1Y +307.95%; price +32.14% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 49.00, EV/Sales 9.23. |
| Risk level | High | Beta 2.23, ATR 5.6% of price, short float 2.88%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $101.05; 52w high $140.94 (-28.30%); 52w low $24.90 (+305.82%) |
| Trend | +32.14% vs SMA200, +3.96% vs SMA50, +7.22% vs SMA20 |
| Momentum | RSI(14) 54.7 (neutral) |
| Volatility | ATR(14) 5.64 (~5.6% of price); beta 2.23 |
...
| Valuation | P/E —, forward P/E 49.00, P/S 9.37, P/B 5.82 | EV/Sales 9.23, EV/EBITDA 31.26 |
...
- **Valuation risk:** Forward P/E 49.00, EV/Sales 9.23. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.23, ATR 5.6% of price, short float 2.88%. Size positions accordingly.
...
|---|---|---|---|
| Price | $101.05 | EV/Sales | 9.23 |
| Market cap | $534.16B | EV/EBITDA | 31.26 |
| Beta | 2.23 | Gross margin | 38.87% |
| RSI(14) | 54.7 | Operating margin | 12.19% |
| ATR(14) | 5.64 | Profit margin | -19.79% |
| SMA20 dist | +7.22% | ROA | 1.41% |
| SMA50 dist | +3.96% | ROE | -10.71% |
| SMA200 dist | +32.14% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $24.90 | Inst. ownership | 62.52% |
| P/E (ttm) | — | Insider ownership | 13.99% |
| Forward P/E | 49.00 | Short float | 2.88% |
| PEG (trailing) | — | Avg volume | 108,933,875 |
| P/S | 9.37 | Employees | 85,100 |
| P/B | 5.82 | Analyst rec (1=buy..5=sell) | 2.5 |
