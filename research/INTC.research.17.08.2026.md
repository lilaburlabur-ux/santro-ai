...
Signed file: `INTC.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $103.49 (2026-08-17, ~15-min delayed) |
| Market cap | $547.06B |
...
|---|---|---|
| Technical momentum | High | 1Y +333.74%; price +46.89% vs SMA200. |
| Fresh setup quality | Poor / broken | -26.57% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-19.79%). |
| Value attractiveness | Low (expensive) | Forward P/E 50.73, EV/Sales 9.70. |
| Risk level | High | Beta 2.24, ATR 6.7% of price, short float 2.48%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $103.49; 52w high $140.94 (-26.57%); 52w low $23.50 (+340.38%) |
| Trend | +46.89% vs SMA200, -5.26% vs SMA50, +6.53% vs SMA20 |
| Momentum | RSI(14) 52.3 (neutral) |
| Volatility | ATR(14) 6.98 (~6.7% of price); beta 2.24 |
| Setup perspective | -26.57% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 50.73, P/S 9.59, P/B 5.96 | EV/Sales 9.70, EV/EBITDA 32.86 |
...
- **Valuation risk:** Forward P/E 50.73, EV/Sales 9.70. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.24, ATR 6.7% of price, short float 2.48%. Size positions accordingly.
...
|---|---|---|---|
| Price | $103.49 | EV/Sales | 9.70 |
| Market cap | $547.06B | EV/EBITDA | 32.86 |
| Beta | 2.24 | Gross margin | 38.87% |
| RSI(14) | 52.3 | Operating margin | 12.19% |
| ATR(14) | 6.98 | Profit margin | -19.79% |
| SMA20 dist | +6.53% | ROA | 1.41% |
| SMA50 dist | -5.26% | ROE | -10.71% |
| SMA200 dist | +46.89% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $23.50 | Inst. ownership | 62.47% |
| P/E (ttm) | — | Insider ownership | 13.99% |
| Forward P/E | 50.73 | Short float | 2.48% |
| PEG (trailing) | — | Avg volume | 122,085,245 |
| P/S | 9.59 | Employees | 85,100 |
| P/B | 5.96 | Analyst rec (1=buy..5=sell) | 2.5 |
