...
Signed file: `INTC.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $96.68 (2026-08-18, ~15-min delayed) |
| Market cap | $511.09B |
...
|---|---|---|
| Technical momentum | High | 1Y +293.67%; price +36.69% vs SMA200. |
| Fresh setup quality | Poor / broken | -31.40% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-19.79%). |
| Value attractiveness | Low (expensive) | Forward P/E 47.39, EV/Sales 9.79. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $96.68; 52w high $140.94 (-31.40%); 52w low $23.50 (+311.43%) |
| Trend | +36.69% vs SMA200, -11.45% vs SMA50, -0.02% vs SMA20 |
| Momentum | RSI(14) 45.4 (neutral) |
| Volatility | ATR(14) 7.07 (~7.3% of price); beta 2.24 |
| Setup perspective | -31.40% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 47.39, P/S 8.96, P/B 5.57 | EV/Sales 9.79, EV/EBITDA 33.16 |
...
- **Valuation risk:** Forward P/E 47.39, EV/Sales 9.79. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $96.68 | EV/Sales | 9.79 |
| Market cap | $511.09B | EV/EBITDA | 33.16 |
| Beta | 2.24 | Gross margin | 38.87% |
| RSI(14) | 45.4 | Operating margin | 12.19% |
| ATR(14) | 7.07 | Profit margin | -19.79% |
| SMA20 dist | -0.02% | ROA | 1.41% |
| SMA50 dist | -11.45% | ROE | -10.71% |
| SMA200 dist | +36.69% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $23.50 | Inst. ownership | 62.56% |
| P/E (ttm) | — | Insider ownership | 13.99% |
| Forward P/E | 47.39 | Short float | 2.48% |
| PEG (trailing) | — | Avg volume | 121,163,579 |
| P/S | 8.96 | Employees | 85,100 |
| P/B | 5.57 | Analyst rec (1=buy..5=sell) | 2.5 |
