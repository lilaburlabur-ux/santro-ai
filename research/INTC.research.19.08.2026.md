...
Signed file: `INTC.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $92.80 (2026-08-19, ~15-min delayed) |
| Market cap | $490.55B |
...
|---|---|---|
| Technical momentum | High | 1Y +292.22%; price +30.71% vs SMA200. |
| Fresh setup quality | Poor / broken | -34.16% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-19.79%). |
| Value attractiveness | Low (expensive) | Forward P/E 45.49, EV/Sales 9.19. |
| Risk level | High | Beta 2.24, ATR 7.6% of price, short float 2.48%. |
...
| 15 S&P 500 stocks are up 100% or more this year — here's what they have in common | Yahoo Finance | 2026-08-19 |
| This Billionaire Tech Investor Is Betting Big on SpaceX and Chip Stocks | Motley Fool | 2026-08-19 |
| Why Is NVDA The Discount Option Among Its Peers? | Trefis | 2026-08-19 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $92.80; 52w high $140.94 (-34.16%); 52w low $23.50 (+294.89%) |
| Trend | +30.71% vs SMA200, -14.73% vs SMA50, -3.55% vs SMA20 |
| Momentum | RSI(14) 42.0 (neutral) |
| Volatility | ATR(14) 7.06 (~7.6% of price); beta 2.24 |
| Setup perspective | -34.16% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 45.49, P/S 8.60, P/B 5.35 | EV/Sales 9.19, EV/EBITDA 31.12 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $114.88 (41 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 62.56% |
...
- **Valuation risk:** Forward P/E 45.49, EV/Sales 9.19. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.24, ATR 7.6% of price, short float 2.48%. Size positions accordingly.
...
|---|---|---|---|
| Price | $92.80 | EV/Sales | 9.19 |
| Market cap | $490.55B | EV/EBITDA | 31.12 |
| Beta | 2.24 | Gross margin | 38.87% |
| RSI(14) | 42.0 | Operating margin | 12.19% |
| ATR(14) | 7.06 | Profit margin | -19.79% |
| SMA20 dist | -3.55% | ROA | 1.41% |
| SMA50 dist | -14.73% | ROE | -10.71% |
| SMA200 dist | +30.71% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $23.50 | Inst. ownership | 62.56% |
| P/E (ttm) | — | Insider ownership | 13.99% |
| Forward P/E | 45.49 | Short float | 2.48% |
| PEG (trailing) | — | Avg volume | 120,702,032 |
| P/S | 8.60 | Employees | 85,100 |
| P/B | 5.35 | Analyst rec (1=buy..5=sell) | 2.5 |
