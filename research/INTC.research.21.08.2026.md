...
Signed file: `INTC.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $90.07 (2026-08-21, ~15-min delayed) |
| Market cap | $476.12B |
...
|---|---|---|
| Technical momentum | High | 1Y +282.63%; price +25.96% vs SMA200. |
| Fresh setup quality | Poor / broken | -36.09% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-19.79%). |
| Value attractiveness | Low (expensive) | Forward P/E 44.15, EV/Sales 8.79. |
| Risk level | High | Beta 2.24, ATR 7.2% of price, short float 2.48%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $90.07; 52w high $140.94 (-36.09%); 52w low $23.50 (+283.28%) |
| Trend | +25.96% vs SMA200, -16.74% vs SMA50, -5.88% vs SMA20 |
| Momentum | RSI(14) 39.6 (neutral) |
| Volatility | ATR(14) 6.50 (~7.2% of price); beta 2.24 |
| Setup perspective | -36.09% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 44.15, P/S 8.35, P/B 5.19 | EV/Sales 8.79, EV/EBITDA 29.76 |
...
- **Valuation risk:** Forward P/E 44.15, EV/Sales 8.79. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.24, ATR 7.2% of price, short float 2.48%. Size positions accordingly.
...
|---|---|---|---|
| Price | $90.07 | EV/Sales | 8.79 |
| Market cap | $476.12B | EV/EBITDA | 29.76 |
| Beta | 2.24 | Gross margin | 38.87% |
| RSI(14) | 39.6 | Operating margin | 12.19% |
| ATR(14) | 6.50 | Profit margin | -19.79% |
| SMA20 dist | -5.88% | ROA | 1.41% |
| SMA50 dist | -16.74% | ROE | -10.71% |
| SMA200 dist | +25.96% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $23.50 | Inst. ownership | 62.51% |
| P/E (ttm) | — | Insider ownership | 13.99% |
| Forward P/E | 44.15 | Short float | 2.48% |
| PEG (trailing) | — | Avg volume | 119,552,924 |
| P/S | 8.35 | Employees | 85,100 |
| P/B | 5.19 | Analyst rec (1=buy..5=sell) | 2.5 |
