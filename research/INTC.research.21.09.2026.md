...
Signed file: `INTC.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $121.78 (2026-09-21, ~15-min delayed) |
| Market cap | $643.74B |
...
|---|---|---|
| Technical momentum | High | 1Y +298.36%; price +57.04% vs SMA200. |
| Fresh setup quality | Moderate / wait | -13.59% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Weak | Negative profit margin (-19.79%). |
| Value attractiveness | Low (expensive) | Forward P/E 59.06, EV/Sales 10.24. |
| Risk level | High | Beta 2.23, ATR 5.4% of price, short float 2.88%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $121.78; 52w high $140.94 (-13.59%); 52w low $28.76 (+323.44%) |
| Trend | +57.04% vs SMA200, +25.12% vs SMA50, +24.96% vs SMA20 |
| Momentum | RSI(14) 70.9 (overbought) |
| Volatility | ATR(14) 6.58 (~5.4% of price); beta 2.23 |
| Setup perspective | -13.59% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E 59.06, P/S 11.29, P/B 7.02 | EV/Sales 10.24, EV/EBITDA 34.69 |
...
- **Valuation risk:** Forward P/E 59.06, EV/Sales 10.24. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.23, ATR 5.4% of price, short float 2.88%. Size positions accordingly.
...
|---|---|---|---|
| Price | $121.78 | EV/Sales | 10.24 |
| Market cap | $643.74B | EV/EBITDA | 34.69 |
| Beta | 2.23 | Gross margin | 38.87% |
| RSI(14) | 70.9 | Operating margin | 12.19% |
| ATR(14) | 6.58 | Profit margin | -19.79% |
| SMA20 dist | +24.96% | ROA | 1.41% |
| SMA50 dist | +25.12% | ROE | -10.71% |
| SMA200 dist | +57.04% | Revenue (ttm) | $57.03B |
