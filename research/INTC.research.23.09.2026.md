...
Signed file: `INTC.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $122.60 (2026-09-23, ~15-min delayed) |
| Market cap | $648.08B |
| Sector / Industry | Technology / Semiconductors |
| Main theme | Semiconductors — see catalysts below |
| Current stance | High technical momentum, weak fundamentals, value: low (expensive), risk: high. |

> Research journal, not financial advice. For education and decision journaling only — not a recommendation to buy, hold, or sell. Public Yahoo Finance data retrieved 2026-09-23.

## 1. Executive Summary
| Area | Score / Read | Reason |
|---|---|---|
| Technical momentum | High | 1Y +326.29%; price +56.46% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 59.45, EV/Sales 11.48. |
| Risk level | High | Beta 2.23, ATR 5.1% of price, short float 2.88%. |
...
| VYM’s Index Buys on Forecast Yield, So It Held Intel and Walgreens Right Into Their Dividend Cuts | 24/7 Wall St. | 2026-09-23 |
| Prediction: Intel Names a Major Outside Customer for Its Next Factory Process Before 2027 | Motley Fool | 2026-09-23 |
| Own ON Semiconductor For AI Power, Or Own Micron's Contracts? | Trefis | 2026-09-23 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $122.60; 52w high $140.94 (-13.01%); 52w low $29.34 (+317.86%) |
| Trend | +56.46% vs SMA200, +25.05% vs SMA50, +21.34% vs SMA20 |
| Momentum | RSI(14) 70.3 (overbought) |
| Volatility | ATR(14) 6.28 (~5.1% of price); beta 2.23 |
| Setup perspective | -13.01% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E 59.45, P/S 11.36, P/B 7.06 | EV/Sales 11.48, EV/EBITDA 38.88 |
...
- **Valuation risk:** Forward P/E 59.45, EV/Sales 11.48. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.23, ATR 5.1% of price, short float 2.88%. Size positions accordingly.
...
|---|---|---|---|
| Price | $122.60 | EV/Sales | 11.48 |
| Market cap | $648.08B | EV/EBITDA | 38.88 |
| Beta | 2.23 | Gross margin | 38.87% |
| RSI(14) | 70.3 | Operating margin | 12.19% |
| ATR(14) | 6.28 | Profit margin | -19.79% |
| SMA20 dist | +21.34% | ROA | 1.41% |
| SMA50 dist | +25.05% | ROE | -10.71% |
| SMA200 dist | +56.46% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $29.34 | Inst. ownership | 62.55% |
| P/E (ttm) | — | Insider ownership | 13.99% |
| Forward P/E | 59.45 | Short float | 2.88% |
| PEG (trailing) | — | Avg volume | 109,346,892 |
| P/S | 11.36 | Employees | 85,100 |
