...
Signed file: `INTC.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $87.48 (2026-08-25, ~15-min delayed) |
| Market cap | $462.43B |
...
|---|---|---|
| Technical momentum | High | 1Y +252.74%; price +21.49% vs SMA200. |
| Fresh setup quality | Poor / broken | -37.93% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-19.79%). |
| Value attractiveness | Low (expensive) | Forward P/E 42.88, EV/Sales 8.36. |
| Risk level | High | Beta 2.24, ATR 7.0% of price, short float 2.48%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $87.48; 52w high $140.94 (-37.93%); 52w low $24.00 (+264.50%) |
| Trend | +21.49% vs SMA200, -18.12% vs SMA50, -8.43% vs SMA20 |
| Momentum | RSI(14) 37.5 (neutral) |
| Volatility | ATR(14) 6.14 (~7.0% of price); beta 2.24 |
| Setup perspective | -37.93% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 42.88, P/S 8.11, P/B 5.04 | EV/Sales 8.36, EV/EBITDA 28.30 |
...
- **Valuation risk:** Forward P/E 42.88, EV/Sales 8.36. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.24, ATR 7.0% of price, short float 2.48%. Size positions accordingly.
...
|---|---|---|---|
| Price | $87.48 | EV/Sales | 8.36 |
| Market cap | $462.43B | EV/EBITDA | 28.30 |
| Beta | 2.24 | Gross margin | 38.87% |
| RSI(14) | 37.5 | Operating margin | 12.19% |
| ATR(14) | 6.14 | Profit margin | -19.79% |
| SMA20 dist | -8.43% | ROA | 1.41% |
| SMA50 dist | -18.12% | ROE | -10.71% |
| SMA200 dist | +21.49% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $24.00 | Inst. ownership | 62.50% |
| P/E (ttm) | — | Insider ownership | 13.99% |
| Forward P/E | 42.88 | Short float | 2.48% |
| PEG (trailing) | — | Avg volume | 119,335,493 |
| P/S | 8.11 | Employees | 85,100 |
| P/B | 5.04 | Analyst rec (1=buy..5=sell) | 2.5 |
