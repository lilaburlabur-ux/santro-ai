...
Signed file: `INTC.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $123.00 (2026-09-25, ~15-min delayed) |
| Market cap | $650.19B |
...
| SK Hynix’s Solidigm said to mull IPO that could value unit at $150B | Investing.com | 2026-09-25 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $123.00; 52w high $140.94 (-12.73%); 52w low $33.55 (+266.62%) |
| Trend | +55.30% vs SMA200, +24.18% vs SMA50, +17.66% vs SMA20 |
| Momentum | RSI(14) 66.9 (neutral) |
| Volatility | ATR(14) 6.26 (~5.1% of price); beta 2.23 |
| Setup perspective | -12.73% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | +17.66% | ROA | 1.41% |
| SMA50 dist | +24.18% | ROE | -10.71% |
| SMA200 dist | +55.30% | Revenue (ttm) | $57.03B |
| 52W high | $140.94 | Revenue growth y/y | 25.40% |
| 52W low | $33.55 | Inst. ownership | 62.56% |
| P/E (ttm) | — | Insider ownership | 13.99% |
| Forward P/E | 59.65 | Short float | 3.01% |
| PEG (trailing) | — | Avg volume | 108,995,480 |
| P/S | 11.40 | Employees | 85,100 |
| P/B | 7.09 | Analyst rec (1=buy..5=sell) | 2.5 |
