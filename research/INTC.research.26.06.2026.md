...
Signed file: `INTC.research.26.06.2026`

| Field | Value |
|---|---|
| Current price | $132.87 (2026-06-26, ~15-min delayed) |
| Market cap | $667.80B |
...
|---|---|---|
| Technical momentum | High | 1Y +489.22%; price +130.23% vs SMA200. |
| Fresh setup quality | Moderate / wait | -5.73% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Weak | Negative profit margin (-5.90%). |
| Value attractiveness | Low (expensive) | Forward P/E 85.92, EV/Sales 12.90. |
| Risk level | High | Beta 2.23, ATR 7.7% of price, short float 2.86%. |
...
| Micron Breaks the Cycle. Why the Stock Could Still Double From Here. | Barrons.com | 2026-06-26 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $132.87; 52w high $140.94 (-5.73%); 52w low $19.31 (+588.09%) |
| Trend | +130.23% vs SMA200, +24.04% vs SMA50, +11.61% vs SMA20 |
| Momentum | RSI(14) 60.5 (neutral) |
| Volatility | ATR(14) 10.17 (~7.7% of price); beta 2.23 |
| Setup perspective | -5.73% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E 85.92, P/S 12.42, P/B 5.99 | EV/Sales 12.90, EV/EBITDA 48.94 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $96.07 (42 analysts) |
...
- **Valuation risk:** Forward P/E 85.92, EV/Sales 12.90. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.23, ATR 7.7% of price, short float 2.86%. Size positions accordingly.
...
|---|---|---|---|
| Price | $132.87 | EV/Sales | 12.90 |
| Market cap | $667.80B | EV/EBITDA | 48.94 |
| Beta | 2.23 | Gross margin | 37.20% |
| RSI(14) | 60.5 | Operating margin | 6.88% |
| ATR(14) | 10.17 | Profit margin | -5.90% |
| SMA20 dist | +11.61% | ROA | 0.63% |
| SMA50 dist | +24.04% | ROE | -2.91% |
| SMA200 dist | +130.23% | Revenue (ttm) | $53.76B |
