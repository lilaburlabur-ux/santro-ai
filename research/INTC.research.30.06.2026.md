...
Signed file: `INTC.research.30.06.2026`

| Field | Value |
|---|---|
| Current price | $131.72 (2026-06-30, ~15-min delayed) |
| Market cap | $662.02B |
...
|---|---|---|
| Technical momentum | High | 1Y +485.42%; price +124.14% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 84.71, EV/Sales 12.79. |
| Risk level | High | Beta 2.23, ATR 7.8% of price, short float 2.86%. |
...
| 2 Hidden Industrial Stocks That Will Benefit From the AI Infrastructure Build-Out Not Named SpaceX or Intel | Motley Fool | 2026-06-30 |
| Why Intel (INTC) Outpaced the Stock Market Today | Zacks | 2026-06-29 |
| The Margin Squeeze Threatening Intel Stock | Trefis | 2026-06-29 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $131.72; 52w high $140.94 (-6.54%); 52w low $19.31 (+582.13%) |
| Trend | +124.14% vs SMA200, +20.13% vs SMA50, +9.52% vs SMA20 |
| Momentum | RSI(14) 58.8 (neutral) |
| Volatility | ATR(14) 10.22 (~7.8% of price); beta 2.23 |
| Setup perspective | -6.54% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E 84.71, P/S 12.31, P/B 5.94 | EV/Sales 12.79, EV/EBITDA 48.53 |
...
- **Valuation risk:** Forward P/E 84.71, EV/Sales 12.79. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.23, ATR 7.8% of price, short float 2.86%. Size positions accordingly.
...
|---|---|---|---|
| Price | $131.72 | EV/Sales | 12.79 |
| Market cap | $662.02B | EV/EBITDA | 48.53 |
| Beta | 2.23 | Gross margin | 37.20% |
| RSI(14) | 58.8 | Operating margin | 6.88% |
| ATR(14) | 10.22 | Profit margin | -5.90% |
| SMA20 dist | +9.52% | ROA | 0.63% |
| SMA50 dist | +20.13% | ROE | -2.91% |
| SMA200 dist | +124.14% | Revenue (ttm) | $53.76B |
| 52W high | $140.94 | Revenue growth y/y | 7.20% |
| 52W low | $19.31 | Inst. ownership | 64.05% |
| P/E (ttm) | — | Insider ownership | 14.72% |
| Forward P/E | 84.71 | Short float | 2.86% |
| PEG (trailing) | — | Avg volume | 135,549,803 |
| P/S | 12.31 | Employees | 85,100 |
| P/B | 5.94 | Analyst rec (1=buy..5=sell) | 2.6 |
...
| 2026-06-01 | main | Mizuho | Neutral → Neutral |
