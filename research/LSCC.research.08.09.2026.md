...
Signed file: `LSCC.research.08.09.2026`
...
|---|---|---|
| Technical momentum | High | 1Y +77.72%; price +8.51% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 36.57, EV/Sales 25.07. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $117.49; 52w high $155.27 (-24.33%); 52w low $61.73 (+90.33%) |
| Trend | +8.51% vs SMA200, -7.54% vs SMA50, -1.95% vs SMA20 |
| Momentum | RSI(14) 45.7 (neutral) |
| Volatility | ATR(14) 5.66 (~4.8% of price); beta 1.78 |
| Setup perspective | -24.33% from 52w high; no clean fresh pivot by default. |
...
- **Valuation risk:** Forward P/E 36.57, EV/Sales 25.07. Multiple compression is the main downside if growth disappoints.
