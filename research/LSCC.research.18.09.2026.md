...
Signed file: `LSCC.research.18.09.2026`
...
|---|---|---|
| Technical momentum | High | 1Y +65.81%; price +0.87% vs SMA200. |
| Fresh setup quality | Poor / broken | -28.54% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 5.58%, revenue growth 62.20%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 34.54, EV/Sales 23.47. |
| Risk level | High | Beta 1.78, ATR 5.1% of price, short float 7.73%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $110.96; 52w high $155.27 (-28.54%); 52w low $61.73 (+79.75%) |
| Trend | +0.87% vs SMA200, -9.34% vs SMA50, -2.59% vs SMA20 |
| Momentum | RSI(14) 43.4 (neutral) |
| Volatility | ATR(14) 5.64 (~5.1% of price); beta 1.78 |
| Setup perspective | -28.54% from 52w high — base needs to rebuild. |
...
- **Valuation risk:** Forward P/E 34.54, EV/Sales 23.47. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.78, ATR 5.1% of price, short float 7.73%. Size positions accordingly.
...
| SMA20 dist | -2.59% | ROA | 3.87% |
| SMA50 dist | -9.34% | ROE | 4.93% |
| SMA200 dist | +0.87% | Revenue (ttm) | $651.12M |
