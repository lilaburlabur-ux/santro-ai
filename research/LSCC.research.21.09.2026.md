...
Signed file: `LSCC.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $117.24 (2026-09-21, ~15-min delayed) |
| Market cap | $16.65B |
| Sector / Industry | Technology / Semiconductors |
| Main theme | Semiconductors — see catalysts below |
| Current stance | High technical momentum, mixed fundamentals, value: low (expensive), risk: elevated. |

> Research journal, not financial advice. For education and decision journaling only — not a recommendation to buy, hold, or sell. Public Yahoo Finance data retrieved 2026-09-21.

## 1. Executive Summary
| Area | Score / Read | Reason |
|---|---|---|
| Technical momentum | High | 1Y +63.65%; price +6.36% vs SMA200. |
| Fresh setup quality | Moderate / wait | -24.49% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 5.58%, revenue growth 62.20%. |
| Value attractiveness | Low (expensive) | Forward P/E 36.49, EV/Sales 24.00. |
| Risk level | Elevated | Beta 1.78, ATR 5.0% of price, short float 7.73%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $117.24; 52w high $155.27 (-24.49%); 52w low $61.73 (+89.92%) |
| Trend | +6.36% vs SMA200, -3.89% vs SMA50, +2.94% vs SMA20 |
| Momentum | RSI(14) 51.1 (neutral) |
| Volatility | ATR(14) 5.84 (~5.0% of price); beta 1.78 |
| Setup perspective | -24.49% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 450.92, forward P/E 36.49, P/S 25.57, P/B 20.42 | EV/Sales 24.00, EV/EBITDA 169.58 |
...
- **Valuation risk:** Forward P/E 36.49, EV/Sales 24.00. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.78, ATR 5.0% of price, short float 7.73%. Size positions accordingly.
...
|---|---|---|---|
| Price | $117.24 | EV/Sales | 24.00 |
| Market cap | $16.65B | EV/EBITDA | 169.58 |
| Beta | 1.78 | Gross margin | 69.02% |
| RSI(14) | 51.1 | Operating margin | 13.33% |
| ATR(14) | 5.84 | Profit margin | 5.58% |
| SMA20 dist | +2.94% | ROA | 3.87% |
| SMA50 dist | -3.89% | ROE | 4.93% |
| SMA200 dist | +6.36% | Revenue (ttm) | $651.12M |
| 52W high | $155.27 | Revenue growth y/y | 62.20% |
| 52W low | $61.73 | Inst. ownership | 103.07% |
| P/E (ttm) | 450.92 | Insider ownership | 0.60% |
| Forward P/E | 36.49 | Short float | 7.73% |
| PEG (trailing) | — | Avg volume | 1,791,223 |
| P/S | 25.57 | Employees | 1,174 |
| P/B | 20.42 | Analyst rec (1=buy..5=sell) | — |
