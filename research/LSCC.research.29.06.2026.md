...
Signed file: `LSCC.research.29.06.2026`

| Field | Value |
|---|---|
| Current price | $146.78 (2026-06-29, ~15-min delayed) |
| Market cap | $20.11B |
| Sector / Industry | Technology / Semiconductors |
| Main theme | Semiconductors — see catalysts below |
| Current stance | High technical momentum, mixed fundamentals, value: low (expensive), risk: high. |

> Research journal, not financial advice. For education and decision journaling only — not a recommendation to buy, hold, or sell. Public Yahoo Finance data retrieved 2026-06-29.

## 1. Executive Summary
| Area | Score / Read | Reason |
|---|---|---|
| Technical momentum | High | 1Y +190.65%; price +55.70% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 63.51, EV/Sales 32.95. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $146.78; 52w high $155.27 (-5.47%); 52w low $48.73 (+201.21%) |
| Trend | +55.70% vs SMA200, +9.44% vs SMA50, +1.30% vs SMA20 |
| Momentum | RSI(14) 54.1 (neutral) |
| Volatility | ATR(14) 9.42 (~6.4% of price); beta 1.79 |
...
| Valuation | P/E 1,048.43, forward P/E 63.51, P/S 35.03, P/B 27.14 | EV/Sales 32.95, EV/EBITDA 269.56 |
...
- **Valuation risk:** Forward P/E 63.51, EV/Sales 32.95. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $146.78 | EV/Sales | 32.95 |
| Market cap | $20.11B | EV/EBITDA | 269.56 |
| Beta | 1.79 | Gross margin | 68.44% |
| RSI(14) | 54.1 | Operating margin | 15.61% |
| ATR(14) | 9.42 | Profit margin | 3.46% |
| SMA20 dist | +1.30% | ROA | 2.48% |
| SMA50 dist | +9.44% | ROE | 2.75% |
| SMA200 dist | +55.70% | Revenue (ttm) | $574.01M |
| 52W high | $155.27 | Revenue growth y/y | 42.20% |
| 52W low | $48.73 | Inst. ownership | 108.68% |
| P/E (ttm) | 1,048.43 | Insider ownership | 0.63% |
| Forward P/E | 63.51 | Short float | 7.90% |
| PEG (trailing) | — | Avg volume | 2,144,075 |
| P/S | 35.03 | Employees | 1,174 |
| P/B | 27.14 | Analyst rec (1=buy..5=sell) | — |
