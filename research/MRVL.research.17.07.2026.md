...
Signed file: `MRVL.research.17.07.2026`

| Field | Value |
|---|---|
| Current price | $188.68 (2026-07-17, ~15-min delayed) |
| Market cap | $169.35B |
...
|---|---|---|
| Technical momentum | High | 1Y +166.88%; price +45.39% vs SMA200. |
| Fresh setup quality | Poor / broken | -40.36% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 28.99%, revenue growth 27.60%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 30.44, EV/Sales 19.06. |
| Risk level | High | Beta 2.20, ATR 11.9% of price, short float 4.56%. |
...
| The 'Invisible Speculative Bear Market' Is Coming Out of Hiding | Barrons.com | 2026-07-17 |
| 2 Stocks to Buy in the Chip Stock Sell-Off | Motley Fool | 2026-07-17 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $188.68; 52w high $316.35 (-40.36%); 52w low $62.18 (+203.45%) |
| Trend | +45.39% vs SMA200, -19.88% vs SMA50, -24.95% vs SMA20 |
| Momentum | RSI(14) 35.7 (neutral) |
| Volatility | ATR(14) 22.41 (~11.9% of price); beta 2.20 |
| Setup perspective | -40.36% from 52w high — base needs to rebuild. |
...
- **Valuation risk:** Forward P/E 30.44, EV/Sales 19.06. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.20, ATR 11.9% of price, short float 4.56%. Size positions accordingly.
...
|---|---|---|---|
| Price | $188.68 | EV/Sales | 19.06 |
| Market cap | $169.35B | EV/EBITDA | 61.27 |
| Beta | 2.20 | Gross margin | 51.50% |
| RSI(14) | 35.7 | Operating margin | 14.48% |
| ATR(14) | 22.41 | Profit margin | 28.99% |
| SMA20 dist | -24.95% | ROA | 3.81% |
| SMA50 dist | -19.88% | ROE | 16.03% |
