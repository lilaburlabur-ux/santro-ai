...
Signed file: `MRVL.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $234.33 (2026-08-17, ~15-min delayed) |
| Market cap | $210.32B |
...
|---|---|---|
| Technical momentum | High | 1Y +197.10%; price +64.89% vs SMA200. |
| Fresh setup quality | Poor / broken | -25.93% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 28.99%, revenue growth 27.60%. |
| Value attractiveness | Low (expensive) | Forward P/E 37.49, EV/Sales 22.45. |
...
| Sandisk, Micron, Coherent, Boeing, Apple, Amazon, and More Stocks That Explain Today’s Market | Barrons.com | 2026-08-17 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $234.33; 52w high $316.35 (-25.93%); 52w low $62.18 (+276.87%) |
| Trend | +64.89% vs SMA200, -0.89% vs SMA50, +14.60% vs SMA20 |
| Momentum | RSI(14) 58.2 (neutral) |
| Volatility | ATR(14) 17.09 (~7.3% of price); beta 2.25 |
| Setup perspective | -25.93% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 80.53, forward P/E 37.49, P/S 24.13, P/B 11.26 | EV/Sales 22.45, EV/EBITDA 72.14 |
...
- **Valuation risk:** Forward P/E 37.49, EV/Sales 22.45. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $234.33 | EV/Sales | 22.45 |
| Market cap | $210.32B | EV/EBITDA | 72.14 |
| Beta | 2.25 | Gross margin | 51.50% |
| RSI(14) | 58.2 | Operating margin | 14.48% |
| ATR(14) | 17.09 | Profit margin | 28.99% |
| SMA20 dist | +14.60% | ROA | 3.81% |
| SMA50 dist | -0.89% | ROE | 16.03% |
| SMA200 dist | +64.89% | Revenue (ttm) | $8.72B |
| 52W high | $316.35 | Revenue growth y/y | 27.60% |
| 52W low | $62.18 | Inst. ownership | 82.23% |
| P/E (ttm) | 80.53 | Insider ownership | 0.50% |
| Forward P/E | 37.49 | Short float | 4.79% |
| PEG (trailing) | 1.25 | Avg volume | 41,081,091 |
| P/S | 24.13 | Employees | 7,480 |
| P/B | 11.26 | Analyst rec (1=buy..5=sell) | 1.4 |
