...
Signed file: `MRVL.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $244.25 (2026-09-18, ~15-min delayed) |
| Market cap | $219.51B |
...
|---|---|---|
| Technical momentum | High | 1Y +244.84%; price +54.24% vs SMA200. |
| Fresh setup quality | Moderate / wait | -22.79% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 27.93%, revenue growth 36.50%. |
| Value attractiveness | Low (expensive) | Forward P/E 36.13, EV/Sales 22.48. |
| Risk level | High | Beta 2.25, ATR 5.9% of price, short float 5.09%. |
...
|---|---|---|
| Bet on These Photonics ETFs to Exploit the Next Wave of AI Revolution | Zacks | 2026-09-18 |
| APH's AI Datacom Strength Grows: Can It Challenge TEL & MRVL? | Zacks | 2026-09-18 |
| GlobalFoundries Jumps 7% on an Expanded Marvell Agreement | GuruFocus.com | 2026-09-18 |
| Why Does NVDA Stock Carry The Lowest Clean Multiple In Its Peer Group? | Trefis | 2026-09-18 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $244.25; 52w high $316.35 (-22.79%); 52w low $73.67 (+231.52%) |
| Trend | +54.24% vs SMA200, +13.11% vs SMA50, +7.37% vs SMA20 |
| Momentum | RSI(14) 58.0 (neutral) |
| Volatility | ATR(14) 14.51 (~5.9% of price); beta 2.25 |
| Setup perspective | -22.79% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 81.15, forward P/E 36.13, P/S 23.23, P/B 11.74 | EV/Sales 22.48, EV/EBITDA 74.55 |
...
- **Valuation risk:** Forward P/E 36.13, EV/Sales 22.48. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.25, ATR 5.9% of price, short float 5.09%. Size positions accordingly.
...
|---|---|---|---|
| Price | $244.25 | EV/Sales | 22.48 |
| Market cap | $219.51B | EV/EBITDA | 74.55 |
| Beta | 2.25 | Gross margin | 52.22% |
| RSI(14) | 58.0 | Operating margin | 16.68% |
| ATR(14) | 14.51 | Profit margin | 27.93% |
| SMA20 dist | +7.37% | ROA | 4.12% |
| SMA50 dist | +13.11% | ROE | 16.52% |
| SMA200 dist | +54.24% | Revenue (ttm) | $9.45B |
| 52W high | $316.35 | Revenue growth y/y | 36.50% |
| 52W low | $73.67 | Inst. ownership | 81.81% |
| P/E (ttm) | 81.15 | Insider ownership | 0.49% |
| Forward P/E | 36.13 | Short float | 5.09% |
| PEG (trailing) | 1.28 | Avg volume | 25,705,716 |
| P/S | 23.23 | Employees | 7,480 |
| P/B | 11.74 | Analyst rec (1=buy..5=sell) | 1.4 |
