...
Signed file: `MRVL.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $237.27 (2026-08-19, ~15-min delayed) |
| Market cap | $212.96B |
...
|---|---|---|
| Technical momentum | High | 1Y +209.85%; price +65.36% vs SMA200. |
| Fresh setup quality | Moderate / wait | -25.00% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 28.99%, revenue growth 27.60%. |
| Value attractiveness | Low (expensive) | Forward P/E 37.96, EV/Sales 21.84. |
| Risk level | High | Beta 2.25, ATR 7.7% of price, short float 4.79%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $237.27; 52w high $316.35 (-25.00%); 52w low $62.18 (+281.60%) |
| Trend | +65.36% vs SMA200, +1.20% vs SMA50, +15.07% vs SMA20 |
| Momentum | RSI(14) 57.5 (neutral) |
| Volatility | ATR(14) 18.38 (~7.7% of price); beta 2.25 |
| Setup perspective | -25.00% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 81.26, forward P/E 37.96, P/S 24.43, P/B 11.41 | EV/Sales 21.84, EV/EBITDA 70.20 |
...
- **Valuation risk:** Forward P/E 37.96, EV/Sales 21.84. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.25, ATR 7.7% of price, short float 4.79%. Size positions accordingly.
...
|---|---|---|---|
| Price | $237.27 | EV/Sales | 21.84 |
| Market cap | $212.96B | EV/EBITDA | 70.20 |
| Beta | 2.25 | Gross margin | 51.50% |
| RSI(14) | 57.5 | Operating margin | 14.48% |
| ATR(14) | 18.38 | Profit margin | 28.99% |
| SMA20 dist | +15.07% | ROA | 3.81% |
| SMA50 dist | +1.20% | ROE | 16.03% |
| SMA200 dist | +65.36% | Revenue (ttm) | $8.72B |
| 52W high | $316.35 | Revenue growth y/y | 27.60% |
| 52W low | $62.18 | Inst. ownership | 82.23% |
| P/E (ttm) | 81.26 | Insider ownership | 0.50% |
| Forward P/E | 37.96 | Short float | 4.79% |
| PEG (trailing) | 1.22 | Avg volume | 41,040,109 |
| P/S | 24.43 | Employees | 7,480 |
| P/B | 11.41 | Analyst rec (1=buy..5=sell) | 1.4 |
