...
Signed file: `MRVL.research.21.07.2026`

| Field | Value |
|---|---|
| Current price | $207.96 (2026-07-21, ~15-min delayed) |
| Market cap | $186.65B |
...
|---|---|---|
| Technical momentum | High | 1Y +179.17%; price +58.80% vs SMA200. |
| Fresh setup quality | Poor / broken | -34.26% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 28.99%, revenue growth 27.60%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 33.43, EV/Sales 19.73. |
| Risk level | High | Beta 2.20, ATR 10.3% of price, short float 4.56%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $207.96; 52w high $316.35 (-34.26%); 52w low $62.18 (+234.46%) |
| Trend | +58.80% vs SMA200, -12.22% vs SMA50, -13.58% vs SMA20 |
| Momentum | RSI(14) 42.5 (neutral) |
| Volatility | ATR(14) 21.33 (~10.3% of price); beta 2.20 |
| Setup perspective | -34.26% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 71.71, forward P/E 33.43, P/S 21.41, P/B 10.00 | EV/Sales 19.73, EV/EBITDA 63.41 |
...
- **Valuation risk:** Forward P/E 33.43, EV/Sales 19.73. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.20, ATR 10.3% of price, short float 4.56%. Size positions accordingly.
...
|---|---|---|---|
| Price | $207.96 | EV/Sales | 19.73 |
| Market cap | $186.65B | EV/EBITDA | 63.41 |
| Beta | 2.20 | Gross margin | 51.50% |
| RSI(14) | 42.5 | Operating margin | 14.48% |
| ATR(14) | 21.33 | Profit margin | 28.99% |
| SMA20 dist | -13.58% | ROA | 3.81% |
| SMA50 dist | -12.22% | ROE | 16.03% |
| SMA200 dist | +58.80% | Revenue (ttm) | $8.72B |
| 52W high | $316.35 | Revenue growth y/y | 27.60% |
| 52W low | $62.18 | Inst. ownership | 86.69% |
| P/E (ttm) | 71.71 | Insider ownership | 0.69% |
| Forward P/E | 33.43 | Short float | 4.56% |
| PEG (trailing) | 1.10 | Avg volume | 42,453,229 |
| P/S | 21.41 | Employees | 7,480 |
| P/B | 10.00 | Analyst rec (1=buy..5=sell) | 1.4 |
