...
Signed file: `MRVL.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $229.29 (2026-08-24, ~15-min delayed) |
| Market cap | $205.80B |
...
|---|---|---|
| Technical momentum | High | 1Y +222.68%; price +57.36% vs SMA200. |
| Fresh setup quality | Poor / broken | -27.52% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 28.99%, revenue growth 27.60%. |
| Value attractiveness | Low (expensive) | Forward P/E 36.68, EV/Sales 23.95. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $229.29; 52w high $316.35 (-27.52%); 52w low $62.18 (+268.77%) |
| Trend | +57.36% vs SMA200, -1.51% vs SMA50, +7.94% vs SMA20 |
| Momentum | RSI(14) 52.9 (neutral) |
| Volatility | ATR(14) 18.24 (~8.0% of price); beta 2.25 |
| Setup perspective | -27.52% from 52w high — base needs to rebuild. |
...
- **Valuation risk:** Forward P/E 36.68, EV/Sales 23.95. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $229.29 | EV/Sales | 23.95 |
| Market cap | $205.80B | EV/EBITDA | 76.99 |
| Beta | 2.25 | Gross margin | 51.50% |
| RSI(14) | 52.9 | Operating margin | 14.48% |
| ATR(14) | 18.24 | Profit margin | 28.99% |
| SMA20 dist | +7.94% | ROA | 3.81% |
| SMA50 dist | -1.51% | ROE | 16.03% |
| SMA200 dist | +57.36% | Revenue (ttm) | $8.72B |
| 52W high | $316.35 | Revenue growth y/y | 27.60% |
| 52W low | $62.18 | Inst. ownership | 82.14% |
| P/E (ttm) | 78.52 | Insider ownership | 0.49% |
| Forward P/E | 36.68 | Short float | 4.79% |
| PEG (trailing) | 1.40 | Avg volume | 41,486,741 |
| P/S | 23.61 | Employees | 7,480 |
| P/B | 11.02 | Analyst rec (1=buy..5=sell) | 1.4 |
