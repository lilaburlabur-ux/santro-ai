...
Signed file: `MU.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $958.16 (2026-09-03, ~15-min delayed) |
| Market cap | $1.08T |
...
|---|---|---|
| Technical momentum | High | 1Y +708.37%; price +59.04% vs SMA200. |
| Fresh setup quality | Moderate / wait | -21.03% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 55.91%, revenue growth 345.70%. |
| Value attractiveness | Reasonable | Forward P/E 6.18, EV/Sales 11.74. |
| Risk level | High | Beta 2.22, ATR 5.7% of price, short float 2.66%. |
...
| Michael Burry doubles down on his surprising AI bet | TheStreet | 2026-09-03 |
| Micron, SanDisk Lag Tech Rally as China Grabs Memory Market Share | Benzinga Prediction Markets | 2026-09-03 |
| Micron's 11% Drop Hasn't Shaken Wall Street's Bull Case | GuruFocus.com | 2026-09-03 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $958.16; 52w high $1,213.37 (-21.03%); 52w low $124.01 (+672.64%) |
| Trend | +59.04% vs SMA200, +1.69% vs SMA50, +2.33% vs SMA20 |
| Momentum | RSI(14) 53.5 (neutral) |
| Volatility | ATR(14) 54.47 (~5.7% of price); beta 2.22 |
| Setup perspective | -21.03% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 21.64, forward P/E 6.18, P/S 11.99, P/B 10.74 | EV/Sales 11.74, EV/EBITDA 15.54 |
...
- **Volatility risk:** Beta 2.22, ATR 5.7% of price, short float 2.66%. Size positions accordingly.
...
|---|---|---|---|
| Price | $958.16 | EV/Sales | 11.74 |
| Market cap | $1.08T | EV/EBITDA | 15.54 |
| Beta | 2.22 | Gross margin | 72.57% |
| RSI(14) | 53.5 | Operating margin | 80.37% |
| ATR(14) | 54.47 | Profit margin | 55.91% |
| SMA20 dist | +2.33% | ROA | 34.87% |
| SMA50 dist | +1.69% | ROE | 66.64% |
| SMA200 dist | +59.04% | Revenue (ttm) | $90.27B |
| 52W high | $1,213.37 | Revenue growth y/y | 345.70% |
| 52W low | $124.01 | Inst. ownership | 79.91% |
| P/E (ttm) | 21.64 | Insider ownership | 0.24% |
| Forward P/E | 6.18 | Short float | 2.66% |
| PEG (trailing) | 0.14 | Avg volume | 44,371,471 |
