...
Signed file: `MU.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $977.41 (2026-09-10, ~15-min delayed) |
| Market cap | $1.10T |
...
|---|---|---|
| Technical momentum | High | 1Y +623.88%; price +58.13% vs SMA200. |
| Fresh setup quality | Moderate / wait | -19.45% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 55.91%, revenue growth 345.70%. |
| Value attractiveness | Reasonable | Forward P/E 6.30, EV/Sales 12.64. |
| Risk level | High | Beta 2.22, ATR 5.5% of price, short float 2.66%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $977.41; 52w high $1,213.37 (-19.45%); 52w low $139.78 (+599.27%) |
| Trend | +58.13% vs SMA200, +5.13% vs SMA50, +1.65% vs SMA20 |
| Momentum | RSI(14) 53.3 (neutral) |
| Volatility | ATR(14) 53.78 (~5.5% of price); beta 2.22 |
| Setup perspective | -19.45% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 22.12, forward P/E 6.30, P/S 12.23, P/B 10.96 | EV/Sales 12.64, EV/EBITDA 16.73 |
...
- **Volatility risk:** Beta 2.22, ATR 5.5% of price, short float 2.66%. Size positions accordingly.
...
|---|---|---|---|
| Price | $977.41 | EV/Sales | 12.64 |
| Market cap | $1.10T | EV/EBITDA | 16.73 |
| Beta | 2.22 | Gross margin | 72.57% |
| RSI(14) | 53.3 | Operating margin | 80.37% |
| ATR(14) | 53.78 | Profit margin | 55.91% |
| SMA20 dist | +1.65% | ROA | 34.87% |
| SMA50 dist | +5.13% | ROE | 66.64% |
| SMA200 dist | +58.13% | Revenue (ttm) | $90.27B |
| 52W high | $1,213.37 | Revenue growth y/y | 345.70% |
| 52W low | $139.78 | Inst. ownership | 79.96% |
| P/E (ttm) | 22.12 | Insider ownership | 0.24% |
| Forward P/E | 6.30 | Short float | 2.66% |
| PEG (trailing) | 0.15 | Avg volume | 41,770,890 |
