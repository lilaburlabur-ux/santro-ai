...
|---|---|---|
| Technical momentum | High | 1Y +637.76%; price +67.20% vs SMA200. |
| Fresh setup quality | Moderate / wait | -24.90% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 55.91%, revenue growth 345.70%. |
| Value attractiveness | Reasonable | Forward P/E 5.88, EV/Sales 10.65. |
| Risk level | High | Beta 2.21, ATR 8.3% of price, short float 2.65%. |
...
| Why Micron Stock Popped Wednesday | GuruFocus.com | 2026-08-12 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $911.29; 52w high $1,213.37 (-24.90%); 52w low $115.60 (+688.28%) |
| Trend | +67.20% vs SMA200, -5.57% vs SMA50, +3.66% vs SMA20 |
| Momentum | RSI(14) 51.1 (neutral) |
| Volatility | ATR(14) 76.05 (~8.3% of price); beta 2.21 |
| Setup perspective | -24.90% from 52w high; no clean fresh pivot by default. |
...
- **Volatility risk:** Beta 2.21, ATR 8.3% of price, short float 2.65%. Size positions accordingly.
...
| SMA20 dist | +3.66% | ROA | 34.87% |
| SMA50 dist | -5.57% | ROE | 66.64% |
| SMA200 dist | +67.20% | Revenue (ttm) | $90.27B |
