...
Signed file: `MU.research.14.08.2026`

| Field | Value |
|---|---|
| Current price | $971.66 (2026-08-14, ~15-min delayed) |
| Market cap | — |
...
|---|---|---|
| Technical momentum | High | 1Y +683.15%; price +75.88% vs SMA200. |
| Fresh setup quality | Moderate / wait | -19.92% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 55.91%, revenue growth 345.70%. |
| Value attractiveness | Reasonable | Forward P/E 6.27, EV/Sales 11.66. |
| Risk level | High | Beta 2.21, ATR 7.5% of price, short float 2.65%. |
...
| Micron Stock Jumps 2.1% as Memory Pricing Tightens Again | GuruFocus.com | 2026-08-14 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $971.66; 52w high $1,213.37 (-19.92%); 52w low $115.60 (+740.50%) |
| Trend | +75.88% vs SMA200, +1.15% vs SMA50, +9.17% vs SMA20 |
| Momentum | RSI(14) 56.3 (neutral) |
| Volatility | ATR(14) 72.75 (~7.5% of price); beta 2.21 |
| Setup perspective | -19.92% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 21.95, forward P/E 6.27, P/S —, P/B 10.89 | EV/Sales 11.66, EV/EBITDA 15.44 |
...
- **Volatility risk:** Beta 2.21, ATR 7.5% of price, short float 2.65%. Size positions accordingly.
...
|---|---|---|---|
| Price | $971.66 | EV/Sales | 11.66 |
| Market cap | — | EV/EBITDA | 15.44 |
| Beta | 2.21 | Gross margin | 72.57% |
| RSI(14) | 56.3 | Operating margin | 80.37% |
| ATR(14) | 72.75 | Profit margin | 55.91% |
| SMA20 dist | +9.17% | ROA | 34.87% |
| SMA50 dist | +1.15% | ROE | 66.64% |
| SMA200 dist | +75.88% | Revenue (ttm) | $90.27B |
| 52W high | $1,213.37 | Revenue growth y/y | 345.70% |
| 52W low | $115.60 | Inst. ownership | 79.63% |
| P/E (ttm) | 21.95 | Insider ownership | 0.24% |
| Forward P/E | 6.27 | Short float | 2.65% |
| PEG (trailing) | 0.13 | Avg volume | 50,361,219 |
| P/S | — | Employees | 53,000 |
| P/B | 10.89 | Analyst rec (1=buy..5=sell) | 1.4 |
