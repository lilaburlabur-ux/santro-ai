...
Signed file: `MU.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $1,015.80 (2026-09-18, ~15-min delayed) |
| Market cap | $1.15T |
...
|---|---|---|
| Technical momentum | High | 1Y +535.93%; price +58.71% vs SMA200. |
| Fresh setup quality | Moderate / wait | -16.28% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 55.91%, revenue growth 345.70%. |
| Value attractiveness | Reasonable | Forward P/E 6.50, EV/Sales 12.01. |
| Risk level | High | Beta 2.22, ATR 4.8% of price, short float 2.64%. |
...
|---|---|---|
| Q3 Earnings Season Preview: What Can Investors Expect? | Zacks | 2026-09-18 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $1,015.80; 52w high $1,213.37 (-16.28%); 52w low $156.58 (+548.75%) |
| Trend | +58.71% vs SMA200, +9.55% vs SMA50, +5.86% vs SMA20 |
| Momentum | RSI(14) 58.3 (neutral) |
| Volatility | ATR(14) 49.26 (~4.8% of price); beta 2.22 |
| Setup perspective | -16.28% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 22.94, forward P/E 6.50, P/S 12.71, P/B 11.39 | EV/Sales 12.01, EV/EBITDA 15.89 |
...
- **Volatility risk:** Beta 2.22, ATR 4.8% of price, short float 2.64%. Size positions accordingly.
...
|---|---|---|---|
| Price | $1,015.80 | EV/Sales | 12.01 |
| Market cap | $1.15T | EV/EBITDA | 15.89 |
| Beta | 2.22 | Gross margin | 72.57% |
| RSI(14) | 58.3 | Operating margin | 80.37% |
| ATR(14) | 49.26 | Profit margin | 55.91% |
| SMA20 dist | +5.86% | ROA | 34.87% |
| SMA50 dist | +9.55% | ROE | 66.64% |
| SMA200 dist | +58.71% | Revenue (ttm) | $90.27B |
| 52W high | $1,213.37 | Revenue growth y/y | 345.70% |
| 52W low | $156.58 | Inst. ownership | 79.89% |
| P/E (ttm) | 22.94 | Insider ownership | 0.24% |
| Forward P/E | 6.50 | Short float | 2.64% |
| PEG (trailing) | 0.32 | Avg volume | 39,131,190 |
| P/S | 12.71 | Employees | 53,000 |
| P/B | 11.39 | Analyst rec (1=buy..5=sell) | 1.3 |
