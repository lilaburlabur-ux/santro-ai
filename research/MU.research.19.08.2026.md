...
Signed file: `MU.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $937.10 (2026-08-19, ~15-min delayed) |
| Market cap | — |
...
|---|---|---|
| Technical momentum | High | 1Y +659.70%; price +66.29% vs SMA200. |
| Fresh setup quality | Moderate / wait | -22.77% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 55.91%, revenue growth 345.70%. |
| Value attractiveness | Reasonable | Forward P/E 6.05, EV/Sales 11.55. |
| Risk level | High | Beta 2.21, ATR 7.6% of price, short float 2.65%. |
...
| Moderna, Merck, Micron, Marvell, Estée Lauder, Honeywell Aerospace, and More Stocks That Explain Today’s Market | Barrons.com | 2026-08-19 |
| Micron Gained Memory Market Share. The Stock Is Dropping Anyway. | Barrons.com | 2026-08-19 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $937.10; 52w high $1,213.37 (-22.77%); 52w low $115.60 (+710.61%) |
| Trend | +66.29% vs SMA200, -2.62% vs SMA50, +4.73% vs SMA20 |
| Momentum | RSI(14) 51.8 (neutral) |
| Volatility | ATR(14) 71.07 (~7.6% of price); beta 2.21 |
| Setup perspective | -22.77% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 21.19, forward P/E 6.05, P/S —, P/B 10.50 | EV/Sales 11.55, EV/EBITDA 15.29 |
...
- **Volatility risk:** Beta 2.21, ATR 7.6% of price, short float 2.65%. Size positions accordingly.
...
|---|---|---|---|
| Price | $937.10 | EV/Sales | 11.55 |
| Market cap | — | EV/EBITDA | 15.29 |
| Beta | 2.21 | Gross margin | 72.57% |
| RSI(14) | 51.8 | Operating margin | 80.37% |
| ATR(14) | 71.07 | Profit margin | 55.91% |
| SMA20 dist | +4.73% | ROA | 34.87% |
| SMA50 dist | -2.62% | ROE | 66.64% |
| SMA200 dist | +66.29% | Revenue (ttm) | $90.27B |
| 52W high | $1,213.37 | Revenue growth y/y | 345.70% |
| 52W low | $115.60 | Inst. ownership | 80.08% |
| P/E (ttm) | 21.19 | Insider ownership | 0.24% |
| Forward P/E | 6.05 | Short float | 2.65% |
| PEG (trailing) | 0.14 | Avg volume | 49,202,309 |
| P/S | — | Employees | 53,000 |
| P/B | 10.50 | Analyst rec (1=buy..5=sell) | 1.4 |
...
| 2026-06-25 | main | Raymond James | Outperform → Outperform |
