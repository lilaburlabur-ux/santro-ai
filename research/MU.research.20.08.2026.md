...
Signed file: `MU.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $974.33 (2026-08-20, ~15-min delayed) |
| Market cap | $1.10T |
...
|---|---|---|
| Technical momentum | High | 1Y +699.59%; price +71.75% vs SMA200. |
| Fresh setup quality | Moderate / wait | -19.70% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 55.91%, revenue growth 345.70%. |
| Value attractiveness | Reasonable | Forward P/E 6.26, EV/Sales 11.51. |
| Risk level | High | Beta 2.21, ATR 7.1% of price, short float 2.65%. |
...
| How Much of Your Portfolio Should Actually Be in DRAM | 24/7 Wall St. | 2026-08-20 |
| The Biggest Risk Facing the Roundhill Memory ETF (DRAM) Right Now | 24/7 Wall St. | 2026-08-20 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $974.33; 52w high $1,213.37 (-19.70%); 52w low $115.60 (+742.81%) |
| Trend | +71.75% vs SMA200, +1.17% vs SMA50, +8.99% vs SMA20 |
| Momentum | RSI(14) 55.2 (neutral) |
| Volatility | ATR(14) 69.43 (~7.1% of price); beta 2.21 |
| Setup perspective | -19.70% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 22.03, forward P/E 6.26, P/S 12.19, P/B 10.92 | EV/Sales 11.51, EV/EBITDA 15.22 |
...
- **Volatility risk:** Beta 2.21, ATR 7.1% of price, short float 2.65%. Size positions accordingly.
...
|---|---|---|---|
| Price | $974.33 | EV/Sales | 11.51 |
| Market cap | $1.10T | EV/EBITDA | 15.22 |
| Beta | 2.21 | Gross margin | 72.57% |
| RSI(14) | 55.2 | Operating margin | 80.37% |
| ATR(14) | 69.43 | Profit margin | 55.91% |
| SMA20 dist | +8.99% | ROA | 34.87% |
| SMA50 dist | +1.17% | ROE | 66.64% |
| SMA200 dist | +71.75% | Revenue (ttm) | $90.27B |
| 52W high | $1,213.37 | Revenue growth y/y | 345.70% |
| 52W low | $115.60 | Inst. ownership | 80.08% |
| P/E (ttm) | 22.03 | Insider ownership | 0.24% |
| Forward P/E | 6.26 | Short float | 2.65% |
| PEG (trailing) | 0.14 | Avg volume | 48,850,585 |
| P/S | 12.19 | Employees | 53,000 |
| P/B | 10.92 | Analyst rec (1=buy..5=sell) | 1.4 |
