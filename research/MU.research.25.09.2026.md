...
Signed file: `MU.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $1,082.28 (2026-09-25, ~15-min delayed) |
| Market cap | $1.22T |
...
|---|---|---|
| Technical momentum | High | 1Y +570.35%; price +63.74% vs SMA200. |
| Fresh setup quality | Moderate / wait | -10.80% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 55.91%, revenue growth 345.70%. |
| Value attractiveness | Reasonable | Forward P/E 6.79, EV/Sales 13.30. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $1,082.28; 52w high $1,213.37 (-10.80%); 52w low $156.58 (+591.21%) |
| Trend | +63.74% vs SMA200, +14.94% vs SMA50, +8.87% vs SMA20 |
| Momentum | RSI(14) 63.2 (neutral) |
| Volatility | ATR(14) 47.98 (~4.4% of price); beta 2.22 |
| Setup perspective | -10.80% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 24.49, forward P/E 6.79, P/S 13.54, P/B 12.13 | EV/Sales 13.30, EV/EBITDA 17.60 |
...
- **Volatility risk:** Beta 2.22, ATR 4.4% of price, short float 2.45%. Size positions accordingly.
...
|---|---|---|---|
| Price | $1,082.28 | EV/Sales | 13.30 |
| Market cap | $1.22T | EV/EBITDA | 17.60 |
| Beta | 2.22 | Gross margin | 72.57% |
| RSI(14) | 63.2 | Operating margin | 80.37% |
| ATR(14) | 47.98 | Profit margin | 55.91% |
| SMA20 dist | +8.87% | ROA | 34.87% |
| SMA50 dist | +14.94% | ROE | 66.64% |
| SMA200 dist | +63.74% | Revenue (ttm) | $90.27B |
| 52W high | $1,213.37 | Revenue growth y/y | 345.70% |
| 52W low | $156.58 | Inst. ownership | 79.91% |
| P/E (ttm) | 24.49 | Insider ownership | 0.24% |
| Forward P/E | 6.79 | Short float | 2.45% |
| PEG (trailing) | 0.16 | Avg volume | 36,484,449 |
| P/S | 13.54 | Employees | 53,000 |
| P/B | 12.13 | Analyst rec (1=buy..5=sell) | 1.4 |
