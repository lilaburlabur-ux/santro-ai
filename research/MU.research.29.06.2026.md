...
Signed file: `MU.research.29.06.2026`

| Field | Value |
|---|---|
| Current price | $1,145.28 (2026-06-29, ~15-min delayed) |
| Market cap | $1.29T |
...
|---|---|---|
| Technical momentum | High | 1Y +811.13%; price +165.89% vs SMA200. |
| Fresh setup quality | Moderate / wait | -5.63% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 55.91%, revenue growth 345.70%. |
| Value attractiveness | Reasonable | Forward P/E 7.67, EV/Sales 13.95. |
| Risk level | High | Beta 2.17, ATR 8.5% of price, short float 3.69%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $1,145.28; 52w high $1,213.56 (-5.63%); 52w low $104.73 (+993.58%) |
| Trend | +165.89% vs SMA200, +40.37% vs SMA50, +9.69% vs SMA20 |
| Momentum | RSI(14) 59.6 (neutral) |
| Volatility | ATR(14) 97.32 (~8.5% of price); beta 2.17 |
| Setup perspective | -5.63% from 52w high; no clean fresh pivot by default. |
...
- **Volatility risk:** Beta 2.17, ATR 8.5% of price, short float 3.69%. Size positions accordingly.
...
|---|---|---|---|
| Price | $1,145.28 | EV/Sales | 13.95 |
| Market cap | $1.29T | EV/EBITDA | 18.46 |
| Beta | 2.17 | Gross margin | 72.57% |
| RSI(14) | 59.6 | Operating margin | 80.37% |
| ATR(14) | 97.32 | Profit margin | 55.91% |
| SMA20 dist | +9.69% | ROA | 34.87% |
| SMA50 dist | +40.37% | ROE | 66.64% |
| SMA200 dist | +165.89% | Revenue (ttm) | $90.27B |
| 52W high | $1,213.56 | Revenue growth y/y | 345.70% |
| 52W low | $104.73 | Inst. ownership | 81.53% |
| P/E (ttm) | 25.87 | Insider ownership | 0.25% |
| Forward P/E | 7.67 | Short float | 3.69% |
| PEG (trailing) | 0.17 | Avg volume | 52,227,241 |
| P/S | 14.33 | Employees | 53,000 |
| P/B | 17.83 | Analyst rec (1=buy..5=sell) | 1.5 |
