...
Signed file: `NVDA.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $225.73 (2026-09-08, ~15-min delayed) |
| Market cap | $5.45T |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +35.33%; price +14.73% vs SMA200. |
| Fresh setup quality | Watch | -4.13% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Strong | Profit margin 63.66%, revenue growth 105.90%. |
| Value attractiveness | Reasonable | Forward P/E 14.55, EV/Sales 18.25. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $225.73; 52w high $235.47 (-4.13%); 52w low $164.98 (+36.82%) |
| Trend | +14.73% vs SMA200, +6.86% vs SMA50, +2.38% vs SMA20 |
| Momentum | RSI(14) 56.1 (neutral) |
| Volatility | ATR(14) 7.49 (~3.3% of price); beta 2.22 |
| Setup perspective | -4.13% from 52w high and near SMA20 — check for a tight base. |
...
|---|---|---|---|
| Price | $225.73 | EV/Sales | 18.25 |
| Market cap | $5.45T | EV/EBITDA | 27.47 |
| Beta | 2.22 | Gross margin | 74.67% |
| RSI(14) | 56.1 | Operating margin | 66.24% |
| ATR(14) | 7.49 | Profit margin | 63.66% |
| SMA20 dist | +2.38% | ROA | 53.57% |
| SMA50 dist | +6.86% | ROE | 117.21% |
| SMA200 dist | +14.73% | Revenue (ttm) | $302.97B |
