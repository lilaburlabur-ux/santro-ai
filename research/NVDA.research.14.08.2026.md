...
Signed file: `NVDA.research.14.08.2026`

| Field | Value |
|---|---|
| Current price | $225.16 (2026-08-14, ~15-min delayed) |
| Market cap | $5.45T |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +24.16%; price +15.62% vs SMA200. |
| Fresh setup quality | Moderate / wait | -4.38% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 62.97%, revenue growth 85.20%. |
| Value attractiveness | Reasonable | Forward P/E 17.57, EV/Sales 21.35. |
| Risk level | High | Beta 2.21, ATR 3.1% of price, short float 1.26%. |
...
|---|---|---|
| Berkshire ups Alphabet stake under Greg Abel, making it a top-3 holding | Yahoo Finance Video | 2026-08-14 |
| The AI build-out has a problem that $1 trillion in cash can't fix | Yahoo Finance | 2026-08-14 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $225.16; 52w high $235.47 (-4.38%); 52w low $164.98 (+36.48%) |
| Trend | +15.62% vs SMA200, +9.03% vs SMA50, +7.02% vs SMA20 |
| Momentum | RSI(14) 63.0 (neutral) |
| Volatility | ATR(14) 6.93 (~3.1% of price); beta 2.21 |
| Setup perspective | -4.38% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 34.48, forward P/E 17.57, P/S 21.51, P/B 27.90 | EV/Sales 21.35, EV/EBITDA 32.70 |
...
- **Volatility risk:** Beta 2.21, ATR 3.1% of price, short float 1.26%. Size positions accordingly.
...
|---|---|---|---|
| Price | $225.16 | EV/Sales | 21.35 |
| Market cap | $5.45T | EV/EBITDA | 32.70 |
| Beta | 2.21 | Gross margin | 74.14% |
| RSI(14) | 63.0 | Operating margin | 65.60% |
| ATR(14) | 6.93 | Profit margin | 62.97% |
| SMA20 dist | +7.02% | ROA | 52.73% |
| SMA50 dist | +9.03% | ROE | 114.29% |
| SMA200 dist | +15.62% | Revenue (ttm) | $253.49B |
| 52W high | $235.47 | Revenue growth y/y | 85.20% |
| 52W low | $164.98 | Inst. ownership | 66.16% |
| P/E (ttm) | 34.48 | Insider ownership | 3.99% |
| Forward P/E | 17.57 | Short float | 1.26% |
| PEG (trailing) | 0.60 | Avg volume | 147,674,441 |
| P/S | 21.51 | Employees | 42,000 |
| P/B | 27.90 | Analyst rec (1=buy..5=sell) | 1.3 |
