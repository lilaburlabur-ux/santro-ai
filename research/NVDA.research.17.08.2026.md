...
**NVIDIA Corporation** — Technical + Fundamental Analysis, Data Snapshot, Institutional Investors
Signed file: `NVDA.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $225.01 (2026-08-17, ~15-min delayed) |
| Market cap | $5.45T |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +23.78%; price +15.47% vs SMA200. |
| Fresh setup quality | Moderate / wait | -4.44% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 62.97%, revenue growth 85.20%. |
| Value attractiveness | Reasonable | Forward P/E 17.58, EV/Sales 21.34. |
| Risk level | High | Beta 2.21, ATR 3.0% of price, short float 1.26%. |
...
|---|---|---|
| Nvidia inks $105 billion deal for OpenAI data center | Yahoo Finance | 2026-08-17 |
| Micron stock heats up again, crossing $1,000 | Yahoo Finance | 2026-08-17 |
| Groq Gets Brutal Valuation Reset After Nvidia Deal | GuruFocus.com | 2026-08-17 |
| A $1.5 Billion Reason Why Nvidia Stock In Focus | GuruFocus.com | 2026-08-17 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $225.01; 52w high $235.47 (-4.44%); 52w low $164.98 (+36.39%) |
| Trend | +15.47% vs SMA200, +8.89% vs SMA50, +6.40% vs SMA20 |
| Momentum | RSI(14) 62.9 (neutral) |
| Volatility | ATR(14) 6.65 (~3.0% of price); beta 2.21 |
| Setup perspective | -4.44% from 52w high; no clean fresh pivot by default. |
...
|---|---|---|
| Next earnings | 2026-08-26 | Next scheduled report (Yahoo estimate) |
...
| Valuation | P/E 34.46, forward P/E 17.58, P/S 21.50, P/B 27.88 | EV/Sales 21.34, EV/EBITDA 32.68 |
| Growth expectations | Earnings growth 214.50%, EPS q/q 210.60% | Analyst mean target $302.83 (58 analysts) |
...
| Invesco Ltd. | 327,497,096 | 1.35% | 2026-03-31 |

## 6. Risk Review and Setup Plan
- **Volatility risk:** Beta 2.21, ATR 3.0% of price, short float 1.26%. Size positions accordingly.
...
|---|---|---|---|
| Price | $225.01 | EV/Sales | 21.34 |
| Market cap | $5.45T | EV/EBITDA | 32.68 |
| Beta | 2.21 | Gross margin | 74.14% |
| RSI(14) | 62.9 | Operating margin | 65.60% |
| ATR(14) | 6.65 | Profit margin | 62.97% |
| SMA20 dist | +6.40% | ROA | 52.73% |
| SMA50 dist | +8.89% | ROE | 114.29% |
| SMA200 dist | +15.47% | Revenue (ttm) | $253.49B |
| 52W high | $235.47 | Revenue growth y/y | 85.20% |
| 52W low | $164.98 | Inst. ownership | 66.17% |
| P/E (ttm) | 34.46 | Insider ownership | 3.99% |
| Forward P/E | 17.58 | Short float | 1.26% |
| PEG (trailing) | 0.62 | Avg volume | 145,977,437 |
| P/S | 21.50 | Employees | 42,000 |
| P/B | 27.88 | Analyst rec (1=buy..5=sell) | 1.3 |

## 8. Analyst Actions
| Date | Action | Firm | Rating change |
|---|---|---|---|
| 2026-08-11 | reit | Wells Fargo | Overweight → Overweight |
| 2026-07-14 | main | Keybanc | Overweight → Overweight |
| 2026-06-05 | init | China Renaissance | — → Buy |
| 2026-06-02 | reit | Needham | Buy → Buy |
| 2026-06-01 | main | DA Davidson | Buy → Buy |
| 2026-05-27 | main | Tigress Financial | Strong Buy → Strong Buy |
| 2026-05-21 | main | UBS | Buy → Buy |
| 2026-05-21 | main | Evercore ISI Group | Outperform → Outperform |
...
| Source | URL | Used for |
|---|---|---|
| Yahoo Finance quote/profile/statistics for NVDA | https://finance.yahoo.com/quote/NVDA | Snapshot metrics, ownership, analyst data |
| Yahoo Finance price history (via yfinance) | https://finance.yahoo.com/quote/NVDA/history | SMA/RSI/ATR/performance calculations |
| Yahoo Finance news feed | https://finance.yahoo.com/quote/NVDA/news | Catalyst headlines |
