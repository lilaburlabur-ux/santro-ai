...
Signed file: `NVDA.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $224.58 (2026-09-24, ~15-min delayed) |
| Market cap | $5.42T |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $224.58; 52w high $235.20 (-4.52%); 52w low $164.79 (+36.28%) |
| Trend | +12.90% vs SMA200, +4.24% vs SMA50, +1.26% vs SMA20 |
| Momentum | RSI(14) 54.8 (neutral) |
| Volatility | ATR(14) 6.02 (~2.7% of price); beta 2.22 |
| Setup perspective | -4.52% from 52w high and near SMA20 — check for a tight base. |
...
| SMA20 dist | +1.26% | ROA | 53.57% |
| SMA50 dist | +4.24% | ROE | 117.21% |
| SMA200 dist | +12.90% | Revenue (ttm) | $302.97B |
