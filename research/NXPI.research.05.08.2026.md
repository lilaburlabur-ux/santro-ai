...
Signed file: `NXPI.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $231.15 (2026-08-05, ~15-min delayed) |
| Market cap | $58.29B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +10.98%; price -3.74% vs SMA200. |
| Fresh setup quality | Poor / broken | -30.28% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 22.56%, revenue growth 19.50%. |
| Value attractiveness | Reasonable | Forward P/E 12.77, EV/Sales 4.90. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $231.15; 52w high $331.55 (-30.28%); 52w low $181.81 (+27.14%) |
| Trend | -3.74% vs SMA200, -19.14% vs SMA50, -12.14% vs SMA20 |
| Momentum | RSI(14) 34.3 (neutral) |
| Volatility | ATR(14) 13.23 (~5.7% of price); beta 1.82 |
| Setup perspective | -30.28% from 52w high — base needs to rebuild. |
...
|---|---|---|---|
| Price | $231.15 | EV/Sales | 4.90 |
| Market cap | $58.29B | EV/EBITDA | 12.76 |
| Beta | 1.82 | Gross margin | 56.10% |
| RSI(14) | 34.3 | Operating margin | 30.41% |
| ATR(14) | 13.23 | Profit margin | 22.56% |
| SMA20 dist | -12.14% | ROA | 10.46% |
| SMA50 dist | -19.14% | ROE | 27.92% |
...
| P/B | 5.12 | Analyst rec (1=buy..5=sell) | 1.8 |
