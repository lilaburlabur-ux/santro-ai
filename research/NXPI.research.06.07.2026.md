...
Signed file: `NXPI.research.06.07.2026`

| Field | Value |
|---|---|
| Current price | $280.51 (2026-07-06, ~15-min delayed) |
| Market cap | $70.82B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +23.51%; price +19.22% vs SMA200. |
| Fresh setup quality | Moderate / wait | -15.39% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 21.03%, revenue growth 12.20%. |
| Value attractiveness | Reasonable | Forward P/E 15.84, EV/Sales 6.13. |
| Risk level | High | Beta 1.80, ATR 5.4% of price, short float 4.05%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $280.51; 52w high $331.55 (-15.39%); 52w low $181.81 (+54.29%) |
| Trend | +19.22% vs SMA200, -4.92% vs SMA50, -4.76% vs SMA20 |
| Momentum | RSI(14) 44.5 (neutral) |
| Volatility | ATR(14) 15.09 (~5.4% of price); beta 1.80 |
| Setup perspective | -15.39% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.79, forward P/E 15.84, P/S 5.61, P/B 6.49 | EV/Sales 6.13, EV/EBITDA 18.60 |
...
- **Volatility risk:** Beta 1.80, ATR 5.4% of price, short float 4.05%. Size positions accordingly.
...
|---|---|---|---|
| Price | $280.51 | EV/Sales | 6.13 |
| Market cap | $70.82B | EV/EBITDA | 18.60 |
| Beta | 1.80 | Gross margin | 55.63% |
| RSI(14) | 44.5 | Operating margin | 27.66% |
| ATR(14) | 15.09 | Profit margin | 21.03% |
| SMA20 dist | -4.76% | ROA | 8.14% |
| SMA50 dist | -4.92% | ROE | 25.81% |
...
| P/B | 6.49 | Analyst rec (1=buy..5=sell) | 1.7 |
