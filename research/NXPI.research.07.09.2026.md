...
Signed file: `NXPI.research.07.09.2026`

| Field | Value |
|---|---|
| Current price | $227.84 (2026-09-07, ~15-min delayed) |
| Market cap | $57.45B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +2.88%; price -6.06% vs SMA200. |
| Fresh setup quality | Poor / broken | -31.28% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 22.56%, revenue growth 19.50%. |
| Value attractiveness | Reasonable | Forward P/E 12.59, EV/Sales 4.97. |
| Risk level | Elevated | Beta 1.82, ATR 3.2% of price, short float 4.13%. |
...
| Is NXP Semiconductors Stock Underperforming the S&P 500? | Barchart | 2026-09-04 |
| Implied Volatility Surging for NXP Semiconductors Stock Options | Zacks | 2026-09-04 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $227.84; 52w high $331.55 (-31.28%); 52w low $181.81 (+25.32%) |
| Trend | -6.06% vs SMA200, -8.96% vs SMA50, +0.07% vs SMA20 |
| Momentum | RSI(14) 43.9 (neutral) |
| Volatility | ATR(14) 7.25 (~3.2% of price); beta 1.82 |
| Setup perspective | -31.28% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 19.46, forward P/E 12.59, P/S 4.36, P/B 5.04 | EV/Sales 4.97, EV/EBITDA 12.94 |
| Growth expectations | Earnings growth 72.60%, EPS q/q 72.40% | Analyst mean target $311.10 (29 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 99.46% |
...
- **Volatility risk:** Beta 1.82, ATR 3.2% of price, short float 4.13%. Size positions accordingly.
...
|---|---|---|---|
| Price | $227.84 | EV/Sales | 4.97 |
| Market cap | $57.45B | EV/EBITDA | 12.94 |
| Beta | 1.82 | Gross margin | 56.10% |
| RSI(14) | 43.9 | Operating margin | 30.41% |
| ATR(14) | 7.25 | Profit margin | 22.56% |
| SMA20 dist | +0.07% | ROA | 10.46% |
| SMA50 dist | -8.96% | ROE | 27.92% |
| SMA200 dist | -6.06% | Revenue (ttm) | $13.19B |
| 52W high | $331.55 | Revenue growth y/y | 19.50% |
| 52W low | $181.81 | Inst. ownership | 99.46% |
| P/E (ttm) | 19.46 | Insider ownership | 0.14% |
| Forward P/E | 12.59 | Short float | 4.13% |
| PEG (trailing) | 0.45 | Avg volume | 4,000,419 |
