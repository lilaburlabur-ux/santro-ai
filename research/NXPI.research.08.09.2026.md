...
Signed file: `NXPI.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $223.87 (2026-09-08, ~15-min delayed) |
| Market cap | $56.45B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +0.49%; price -7.77% vs SMA200. |
| Fresh setup quality | Poor / broken | -32.48% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 22.56%, revenue growth 19.50%. |
| Value attractiveness | Reasonable | Forward P/E 12.37, EV/Sales 4.97. |
| Risk level | Elevated | Beta 1.82, ATR 3.3% of price, short float 4.13%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $223.87; 52w high $331.55 (-32.48%); 52w low $181.81 (+23.14%) |
| Trend | -7.77% vs SMA200, -10.17% vs SMA50, -1.47% vs SMA20 |
| Momentum | RSI(14) 40.8 (neutral) |
| Volatility | ATR(14) 7.37 (~3.3% of price); beta 1.82 |
| Setup perspective | -32.48% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 19.12, forward P/E 12.37, P/S 4.28, P/B 4.95 | EV/Sales 4.97, EV/EBITDA 12.94 |
...
- **Volatility risk:** Beta 1.82, ATR 3.3% of price, short float 4.13%. Size positions accordingly.
...
|---|---|---|---|
| Price | $223.87 | EV/Sales | 4.97 |
| Market cap | $56.45B | EV/EBITDA | 12.94 |
| Beta | 1.82 | Gross margin | 56.10% |
| RSI(14) | 40.8 | Operating margin | 30.41% |
| ATR(14) | 7.37 | Profit margin | 22.56% |
| SMA20 dist | -1.47% | ROA | 10.46% |
| SMA50 dist | -10.17% | ROE | 27.92% |
| SMA200 dist | -7.77% | Revenue (ttm) | $13.19B |
| 52W high | $331.55 | Revenue growth y/y | 19.50% |
| 52W low | $181.81 | Inst. ownership | 99.46% |
| P/E (ttm) | 19.12 | Insider ownership | 0.14% |
| Forward P/E | 12.37 | Short float | 4.13% |
| PEG (trailing) | 0.45 | Avg volume | 3,974,504 |
