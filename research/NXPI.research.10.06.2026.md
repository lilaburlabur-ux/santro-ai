...
Signed file: `NXPI.research.10.06.2026`

| Field | Value |
|---|---|
| Current price | $293.97 (2026-06-10, ~15-min delayed) |
| Market cap | $74.22B |
...
|---|---|---|
| Technical momentum | High | 1Y +40.59%; price +27.56% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 16.68, EV/Sales 6.62. |
| Risk level | High | Beta 1.79, ATR 5.0% of price, short float 3.66%. |
...
|---|---|---|
| Broader Market Settles Lower as Chip Stocks Sink | Barchart | 2026-06-09 |
| Stocks Climb on an AI-Led Rebound | Barchart | 2026-06-09 |
| The Price of Perfection For Analog Devices Stock | Trefis | 2026-06-08 |
| Stocks Rally as Buyers Return After AI-Led Selloff | Barchart | 2026-06-08 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $293.97; 52w high $332.67 (-11.63%); 52w low $182.42 (+61.15%) |
| Trend | +27.56% vs SMA200, +9.68% vs SMA50, -4.82% vs SMA20 |
| Momentum | RSI(14) 48.2 (neutral) |
| Volatility | ATR(14) 14.77 (~5.0% of price); beta 1.79 |
...
| Valuation | P/E 28.08, forward P/E 16.68, P/S 5.88, P/B 6.80 | EV/Sales 6.62, EV/EBITDA 20.05 |
...
- **Volatility risk:** Beta 1.79, ATR 5.0% of price, short float 3.66%. Size positions accordingly.
...
|---|---|---|---|
| Price | $293.97 | EV/Sales | 6.62 |
| Market cap | $74.22B | EV/EBITDA | 20.05 |
| Beta | 1.79 | Gross margin | 55.63% |
| RSI(14) | 48.2 | Operating margin | 27.66% |
| ATR(14) | 14.77 | Profit margin | 21.03% |
| SMA20 dist | -4.82% | ROA | 8.14% |
| SMA50 dist | +9.68% | ROE | 25.81% |
| SMA200 dist | +27.56% | Revenue (ttm) | $12.62B |
| 52W high | $332.67 | Revenue growth y/y | 12.20% |
| 52W low | $182.42 | Inst. ownership | 100.75% |
| P/E (ttm) | 28.08 | Insider ownership | 0.11% |
| Forward P/E | 16.68 | Short float | 3.66% |
| PEG (trailing) | 0.76 | Avg volume | 3,537,046 |
| P/S | 5.88 | Employees | 32,169 |
| P/B | 6.80 | Analyst rec (1=buy..5=sell) | — |
