...
Signed file: `NXPI.research.10.07.2026`

| Field | Value |
|---|---|
| Current price | $292.26 (2026-07-10, ~15-min delayed) |
| Market cap | $73.79B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +29.09%; price +23.55% vs SMA200. |
| Fresh setup quality | Moderate / wait | -11.85% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 21.03%, revenue growth 12.20%. |
| Value attractiveness | Reasonable | Forward P/E 16.50, EV/Sales 6.48. |
| Risk level | Elevated | Beta 1.80, ATR 5.0% of price, short float 4.05%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $292.26; 52w high $331.55 (-11.85%); 52w low $181.81 (+60.75%) |
| Trend | +23.55% vs SMA200, -2.20% vs SMA50, -0.16% vs SMA20 |
| Momentum | RSI(14) 50.8 (neutral) |
| Volatility | ATR(14) 14.52 (~5.0% of price); beta 1.80 |
| Setup perspective | -11.85% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 27.94, forward P/E 16.50, P/S 5.85, P/B 6.76 | EV/Sales 6.48, EV/EBITDA 19.64 |
| Growth expectations | Earnings growth 130.70%, EPS q/q 129.00% | Analyst mean target $308.07 (29 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 100.82% |
...
- **Volatility risk:** Beta 1.80, ATR 5.0% of price, short float 4.05%. Size positions accordingly.
...
|---|---|---|---|
| Price | $292.26 | EV/Sales | 6.48 |
| Market cap | $73.79B | EV/EBITDA | 19.64 |
| Beta | 1.80 | Gross margin | 55.63% |
| RSI(14) | 50.8 | Operating margin | 27.66% |
| ATR(14) | 14.52 | Profit margin | 21.03% |
| SMA20 dist | -0.16% | ROA | 8.14% |
| SMA50 dist | -2.20% | ROE | 25.81% |
| SMA200 dist | +23.55% | Revenue (ttm) | $12.62B |
| 52W high | $331.55 | Revenue growth y/y | 12.20% |
| 52W low | $181.81 | Inst. ownership | 100.82% |
| P/E (ttm) | 27.94 | Insider ownership | 0.14% |
| Forward P/E | 16.50 | Short float | 4.05% |
| PEG (trailing) | 0.74 | Avg volume | 4,144,759 |
| P/S | 5.85 | Employees | 32,169 |
| P/B | 6.76 | Analyst rec (1=buy..5=sell) | 1.7 |
