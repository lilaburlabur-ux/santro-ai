...
Signed file: `NXPI.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $236.62 (2026-09-11, ~15-min delayed) |
| Market cap | $59.67B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +9.83%; price -2.77% vs SMA200. |
| Fresh setup quality | Poor / broken | -28.63% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 22.56%, revenue growth 19.50%. |
| Value attractiveness | Reasonable | Forward P/E 13.08, EV/Sales 4.95. |
| Risk level | Elevated | Beta 1.82, ATR 3.2% of price, short float 3.80%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $236.62; 52w high $331.55 (-28.63%); 52w low $181.81 (+30.15%) |
| Trend | -2.77% vs SMA200, -3.88% vs SMA50, +4.49% vs SMA20 |
| Momentum | RSI(14) 53.9 (neutral) |
| Volatility | ATR(14) 7.66 (~3.2% of price); beta 1.82 |
| Setup perspective | -28.63% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 20.17, forward P/E 13.08, P/S 4.53, P/B 5.24 | EV/Sales 4.95, EV/EBITDA 12.87 |
...
- **Volatility risk:** Beta 1.82, ATR 3.2% of price, short float 3.80%. Size positions accordingly.
...
|---|---|---|---|
| Price | $236.62 | EV/Sales | 4.95 |
| Market cap | $59.67B | EV/EBITDA | 12.87 |
| Beta | 1.82 | Gross margin | 56.10% |
| RSI(14) | 53.9 | Operating margin | 30.41% |
| ATR(14) | 7.66 | Profit margin | 22.56% |
| SMA20 dist | +4.49% | ROA | 10.46% |
| SMA50 dist | -3.88% | ROE | 27.92% |
| SMA200 dist | -2.77% | Revenue (ttm) | $13.19B |
| 52W high | $331.55 | Revenue growth y/y | 19.50% |
| 52W low | $181.81 | Inst. ownership | 99.34% |
| P/E (ttm) | 20.17 | Insider ownership | 0.14% |
| Forward P/E | 13.08 | Short float | 3.80% |
| PEG (trailing) | 0.45 | Avg volume | 3,940,738 |
| P/S | 4.53 | Employees | 32,169 |
| P/B | 5.24 | Analyst rec (1=buy..5=sell) | — |
