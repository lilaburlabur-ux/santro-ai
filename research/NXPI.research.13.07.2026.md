...
Signed file: `NXPI.research.13.07.2026`

| Field | Value |
|---|---|
| Current price | $278.39 (2026-07-13, ~15-min delayed) |
| Market cap | $70.29B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $278.39; 52w high $331.55 (-16.03%); 52w low $181.81 (+53.12%) |
| Trend | +17.55% vs SMA200, -6.78% vs SMA50, -4.52% vs SMA20 |
| Momentum | RSI(14) 44.7 (neutral) |
| Volatility | ATR(14) 14.54 (~5.2% of price); beta 1.80 |
| Setup perspective | -16.03% from 52w high; no clean fresh pivot by default. |
...
- **Volatility risk:** Beta 1.80, ATR 5.2% of price, short float 3.87%. Size positions accordingly.
...
|---|---|---|---|
| Price | $278.39 | EV/Sales | 6.51 |
| Market cap | $70.29B | EV/EBITDA | 19.74 |
| Beta | 1.80 | Gross margin | 55.63% |
| RSI(14) | 44.7 | Operating margin | 27.66% |
| ATR(14) | 14.54 | Profit margin | 21.03% |
| SMA20 dist | -4.52% | ROA | 8.14% |
| SMA50 dist | -6.78% | ROE | 25.81% |
| SMA200 dist | +17.55% | Revenue (ttm) | $12.62B |
