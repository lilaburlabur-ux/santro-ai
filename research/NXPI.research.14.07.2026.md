...
Signed file: `NXPI.research.14.07.2026`

| Field | Value |
|---|---|
| Current price | $283.87 (2026-07-14, ~15-min delayed) |
| Market cap | $71.67B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +26.21%; price +19.71% vs SMA200. |
...
| Risk level | High | Beta 1.80, ATR 5.0% of price, short float 3.87%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $283.87; 52w high $331.55 (-14.38%); 52w low $181.81 (+56.14%) |
| Trend | +19.71% vs SMA200, -4.89% vs SMA50, -2.30% vs SMA20 |
| Momentum | RSI(14) 47.4 (neutral) |
| Volatility | ATR(14) 14.31 (~5.0% of price); beta 1.80 |
...
| Valuation | P/E 27.11, forward P/E 16.00, P/S 5.68, P/B 6.56 | EV/Sales 6.24, EV/EBITDA 18.90 |
| Growth expectations | Earnings growth 130.70%, EPS q/q 129.00% | Analyst mean target $310.31 (29 analysts) |
...
- **Volatility risk:** Beta 1.80, ATR 5.0% of price, short float 3.87%. Size positions accordingly.
...
|---|---|---|---|
| Price | $283.87 | EV/Sales | 6.24 |
| Market cap | $71.67B | EV/EBITDA | 18.90 |
| Beta | 1.80 | Gross margin | 55.63% |
| RSI(14) | 47.4 | Operating margin | 27.66% |
| ATR(14) | 14.31 | Profit margin | 21.03% |
| SMA20 dist | -2.30% | ROA | 8.14% |
| SMA50 dist | -4.89% | ROE | 25.81% |
| SMA200 dist | +19.71% | Revenue (ttm) | $12.62B |
| 52W high | $331.55 | Revenue growth y/y | 12.20% |
| 52W low | $181.81 | Inst. ownership | 100.77% |
| P/E (ttm) | 27.11 | Insider ownership | 0.14% |
| Forward P/E | 16.00 | Short float | 3.87% |
| PEG (trailing) | 0.71 | Avg volume | 4,168,657 |
| P/S | 5.68 | Employees | 32,169 |
| P/B | 6.56 | Analyst rec (1=buy..5=sell) | 1.7 |
