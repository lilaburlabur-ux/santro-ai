...
Signed file: `NXPI.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $224.23 (2026-09-14, ~15-min delayed) |
| Market cap | $56.54B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +2.24%; price -7.93% vs SMA200. |
| Fresh setup quality | Poor / broken | -32.37% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 22.56%, revenue growth 19.50%. |
| Value attractiveness | Reasonable | Forward P/E 12.39, EV/Sales 5.14. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $224.23; 52w high $331.55 (-32.37%); 52w low $181.81 (+23.33%) |
| Trend | -7.93% vs SMA200, -8.55% vs SMA50, -0.75% vs SMA20 |
| Momentum | RSI(14) 43.7 (neutral) |
| Volatility | ATR(14) 8.02 (~3.6% of price); beta 1.82 |
| Setup perspective | -32.37% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 19.15, forward P/E 12.39, P/S 4.29, P/B 4.96 | EV/Sales 5.14, EV/EBITDA 13.38 |
...
- **Volatility risk:** Beta 1.82, ATR 3.6% of price, short float 3.80%. Size positions accordingly.
...
|---|---|---|---|
| Price | $224.23 | EV/Sales | 5.14 |
| Market cap | $56.54B | EV/EBITDA | 13.38 |
| Beta | 1.82 | Gross margin | 56.10% |
| RSI(14) | 43.7 | Operating margin | 30.41% |
| ATR(14) | 8.02 | Profit margin | 22.56% |
| SMA20 dist | -0.75% | ROA | 10.46% |
| SMA50 dist | -8.55% | ROE | 27.92% |
| SMA200 dist | -7.93% | Revenue (ttm) | $13.19B |
| 52W high | $331.55 | Revenue growth y/y | 19.50% |
| 52W low | $181.81 | Inst. ownership | 99.36% |
| P/E (ttm) | 19.15 | Insider ownership | 0.14% |
| Forward P/E | 12.39 | Short float | 3.80% |
| PEG (trailing) | 0.47 | Avg volume | 3,956,827 |
| P/S | 4.29 | Employees | 32,169 |
| P/B | 4.96 | Analyst rec (1=buy..5=sell) | 1.8 |
