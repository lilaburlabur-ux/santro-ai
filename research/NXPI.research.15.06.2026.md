...
Signed file: `NXPI.research.15.06.2026`

| Field | Value |
|---|---|
| Current price | $315.88 (2026-06-15, ~15-min delayed) |
| Market cap | $79.75B |
...
|---|---|---|
| Technical momentum | High | 1Y +48.07%; price +36.43% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 17.92, EV/Sales 6.76. |
| Risk level | Elevated | Beta 1.79, ATR 4.7% of price, short float 3.66%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $315.88; 52w high $332.67 (-5.05%); 52w low $182.42 (+73.16%) |
| Trend | +36.43% vs SMA200, +15.04% vs SMA50, +1.77% vs SMA20 |
| Momentum | RSI(14) 57.5 (neutral) |
| Volatility | ATR(14) 14.96 (~4.7% of price); beta 1.79 |
...
| Valuation | P/E 30.20, forward P/E 17.92, P/S 6.32, P/B 7.30 | EV/Sales 6.76, EV/EBITDA 20.51 |
...
- **Volatility risk:** Beta 1.79, ATR 4.7% of price, short float 3.66%. Size positions accordingly.
...
|---|---|---|---|
| Price | $315.88 | EV/Sales | 6.76 |
| Market cap | $79.75B | EV/EBITDA | 20.51 |
| Beta | 1.79 | Gross margin | 55.63% |
| RSI(14) | 57.5 | Operating margin | 27.66% |
| ATR(14) | 14.96 | Profit margin | 21.03% |
| SMA20 dist | +1.77% | ROA | 8.14% |
| SMA50 dist | +15.04% | ROE | 25.81% |
| SMA200 dist | +36.43% | Revenue (ttm) | $12.62B |
| 52W high | $332.67 | Revenue growth y/y | 12.20% |
| 52W low | $182.42 | Inst. ownership | 100.73% |
| P/E (ttm) | 30.20 | Insider ownership | 0.11% |
| Forward P/E | 17.92 | Short float | 3.66% |
| PEG (trailing) | 0.78 | Avg volume | 3,606,030 |
| P/S | 6.32 | Employees | 32,169 |
| P/B | 7.30 | Analyst rec (1=buy..5=sell) | 1.7 |
