...
Signed file: `NXPI.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $226.35 (2026-09-15, ~15-min delayed) |
| Market cap | $57.08B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +5.28%; price -7.13% vs SMA200. |
| Fresh setup quality | Poor / broken | -31.73% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 22.56%, revenue growth 19.50%. |
| Value attractiveness | Reasonable | Forward P/E 12.51, EV/Sales 4.90. |
...
| NXP Semiconductors (NXPI) Leans Into Physical AI Following A Fair Value Debate | Simply Wall St. | 2026-09-14 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $226.35; 52w high $331.55 (-31.73%); 52w low $181.81 (+24.50%) |
| Trend | -7.13% vs SMA200, -7.27% vs SMA50, +0.33% vs SMA20 |
| Momentum | RSI(14) 45.6 (neutral) |
| Volatility | ATR(14) 7.77 (~3.4% of price); beta 1.82 |
| Setup perspective | -31.73% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 19.30, forward P/E 12.51, P/S 4.33, P/B 5.01 | EV/Sales 4.90, EV/EBITDA 12.76 |
...
- **Volatility risk:** Beta 1.82, ATR 3.4% of price, short float 3.80%. Size positions accordingly.
...
|---|---|---|---|
| Price | $226.35 | EV/Sales | 4.90 |
| Market cap | $57.08B | EV/EBITDA | 12.76 |
| Beta | 1.82 | Gross margin | 56.10% |
| RSI(14) | 45.6 | Operating margin | 30.41% |
| ATR(14) | 7.77 | Profit margin | 22.56% |
| SMA20 dist | +0.33% | ROA | 10.46% |
| SMA50 dist | -7.27% | ROE | 27.92% |
| SMA200 dist | -7.13% | Revenue (ttm) | $13.19B |
| 52W high | $331.55 | Revenue growth y/y | 19.50% |
| 52W low | $181.81 | Inst. ownership | 99.37% |
| P/E (ttm) | 19.30 | Insider ownership | 0.14% |
| Forward P/E | 12.51 | Short float | 3.80% |
| PEG (trailing) | 0.45 | Avg volume | 3,974,796 |
| P/S | 4.33 | Employees | 32,169 |
| P/B | 5.01 | Analyst rec (1=buy..5=sell) | 1.8 |
