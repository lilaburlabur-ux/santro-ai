...
Signed file: `NXPI.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $218.98 (2026-09-16, ~15-min delayed) |
| Market cap | $55.22B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +1.64%; price -10.21% vs SMA200. |
| Fresh setup quality | Poor / broken | -33.95% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 22.56%, revenue growth 19.50%. |
| Value attractiveness | Reasonable | Forward P/E 12.10, EV/Sales 4.95. |
| Risk level | Elevated | Beta 1.82, ATR 3.7% of price, short float 3.80%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $218.98; 52w high $331.55 (-33.95%); 52w low $181.81 (+20.45%) |
| Trend | -10.21% vs SMA200, -9.89% vs SMA50, -2.73% vs SMA20 |
| Momentum | RSI(14) 40.5 (neutral) |
| Volatility | ATR(14) 8.05 (~3.7% of price); beta 1.82 |
| Setup perspective | -33.95% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 18.68, forward P/E 12.10, P/S 4.19, P/B 4.85 | EV/Sales 4.95, EV/EBITDA 12.86 |
...
- **Volatility risk:** Beta 1.82, ATR 3.7% of price, short float 3.80%. Size positions accordingly.
...
|---|---|---|---|
| Price | $218.98 | EV/Sales | 4.95 |
| Market cap | $55.22B | EV/EBITDA | 12.86 |
| Beta | 1.82 | Gross margin | 56.10% |
| RSI(14) | 40.5 | Operating margin | 30.41% |
| ATR(14) | 8.05 | Profit margin | 22.56% |
| SMA20 dist | -2.73% | ROA | 10.46% |
| SMA50 dist | -9.89% | ROE | 27.92% |
| SMA200 dist | -10.21% | Revenue (ttm) | $13.19B |
| 52W high | $331.55 | Revenue growth y/y | 19.50% |
| 52W low | $181.81 | Inst. ownership | 99.37% |
| P/E (ttm) | 18.68 | Insider ownership | 0.14% |
| Forward P/E | 12.10 | Short float | 3.80% |
| PEG (trailing) | 0.45 | Avg volume | 3,940,638 |
| P/S | 4.19 | Employees | 32,169 |
| P/B | 4.85 | Analyst rec (1=buy..5=sell) | 1.8 |
