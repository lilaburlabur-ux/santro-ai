...
Signed file: `NXPI.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $232.72 (2026-08-17, ~15-min delayed) |
| Market cap | $58.68B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-3.39%) with negative half-year (-3.97%). |
| Fresh setup quality | Poor / broken | -29.81% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 22.56%, revenue growth 19.50%. |
| Value attractiveness | Reasonable | Forward P/E 12.86, EV/Sales 5.10. |
| Risk level | Elevated | Beta 1.82, ATR 4.5% of price, short float 3.92%. |
...
|---|---|---|
| NXP Semiconductors Sees Demand Rebound as Auto, AI and Data Center Growth Accelerate | MarketBeat | 2026-08-16 |
| Prediction: This Chipmaker Could Be a Bigger Winner Than Investors Think | 24/7 Wall St. | 2026-08-12 |
| 1 Semiconductor Stock for Long-Term Investors and 2 Facing Challenges | StockStory | 2026-08-12 |
| Where Analysts Pushed Back On NXPI's Latest Call | Trefis | 2026-08-12 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $232.72; 52w high $331.55 (-29.81%); 52w low $181.81 (+28.00%) |
| Trend | -3.39% vs SMA200, -14.34% vs SMA50, -5.16% vs SMA20 |
| Momentum | RSI(14) 38.4 (neutral) |
| Volatility | ATR(14) 10.41 (~4.5% of price); beta 1.82 |
| Setup perspective | -29.81% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 46.36, forward P/E 12.86, P/S 4.45, P/B 5.15 | EV/Sales 5.10, EV/EBITDA 13.28 |
...
- **Volatility risk:** Beta 1.82, ATR 4.5% of price, short float 3.92%. Size positions accordingly.
...
|---|---|---|---|
| Price | $232.72 | EV/Sales | 5.10 |
| Market cap | $58.68B | EV/EBITDA | 13.28 |
| Beta | 1.82 | Gross margin | 56.10% |
| RSI(14) | 38.4 | Operating margin | 30.41% |
| ATR(14) | 10.41 | Profit margin | 22.56% |
| SMA20 dist | -5.16% | ROA | 10.46% |
| SMA50 dist | -14.34% | ROE | 27.92% |
| SMA200 dist | -3.39% | Revenue (ttm) | $13.19B |
| 52W high | $331.55 | Revenue growth y/y | 19.50% |
| 52W low | $181.81 | Inst. ownership | 99.37% |
| P/E (ttm) | 46.36 | Insider ownership | 0.14% |
| Forward P/E | 12.86 | Short float | 3.92% |
| PEG (trailing) | 0.57 | Avg volume | 4,241,412 |
| P/S | 4.45 | Employees | 32,169 |
| P/B | 5.15 | Analyst rec (1=buy..5=sell) | 1.8 |
...
## 9. Conclusion
NXPI: Low momentum / strong fundamentals / reasonable value / elevated risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.
