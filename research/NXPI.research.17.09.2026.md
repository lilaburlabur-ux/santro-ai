...
Signed file: `NXPI.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $227.95 (2026-09-17, ~15-min delayed) |
| Market cap | $57.48B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $227.95; 52w high $330.06 (-30.94%); 52w low $180.99 (+25.94%) |
| Trend | -6.18% vs SMA200, -5.36% vs SMA50, +1.62% vs SMA20 |
| Momentum | RSI(14) 48.8 (neutral) |
| Volatility | ATR(14) 8.11 (~3.6% of price); beta 1.82 |
| Setup perspective | -30.94% from 52w high — base needs to rebuild. |
...
| SMA20 dist | +1.62% | ROA | 10.46% |
| SMA50 dist | -5.36% | ROE | 27.92% |
| SMA200 dist | -6.18% | Revenue (ttm) | $13.19B |
...
| PEG (trailing) | 0.44 | Avg volume | 3,947,482 |
