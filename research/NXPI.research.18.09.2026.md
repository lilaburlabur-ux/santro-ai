...
Signed file: `NXPI.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $227.99 (2026-09-18, ~15-min delayed) |
| Market cap | $57.49B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +4.56%; price -6.23% vs SMA200. |
| Fresh setup quality | Poor / broken | -30.92% from 52w high — base needs to rebuild. |
...
| Risk level | Elevated | Beta 1.82, ATR 3.5% of price, short float 3.80%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $227.99; 52w high $330.06 (-30.92%); 52w low $180.99 (+25.97%) |
| Trend | -6.23% vs SMA200, -4.86% vs SMA50, +1.50% vs SMA20 |
| Momentum | RSI(14) 48.8 (neutral) |
| Volatility | ATR(14) 7.99 (~3.5% of price); beta 1.82 |
| Setup perspective | -30.92% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 19.45, forward P/E 12.60, P/S 4.36, P/B 5.05 | EV/Sales 4.97, EV/EBITDA 12.94 |
...
- **Volatility risk:** Beta 1.82, ATR 3.5% of price, short float 3.80%. Size positions accordingly.
...
|---|---|---|---|
| Price | $227.99 | EV/Sales | 4.97 |
| Market cap | $57.49B | EV/EBITDA | 12.94 |
| Beta | 1.82 | Gross margin | 56.10% |
| RSI(14) | 48.8 | Operating margin | 30.41% |
| ATR(14) | 7.99 | Profit margin | 22.56% |
| SMA20 dist | +1.50% | ROA | 10.46% |
| SMA50 dist | -4.86% | ROE | 27.92% |
| SMA200 dist | -6.23% | Revenue (ttm) | $13.19B |
| 52W high | $330.06 | Revenue growth y/y | 19.50% |
| 52W low | $180.99 | Inst. ownership | 99.37% |
| P/E (ttm) | 19.45 | Insider ownership | 0.14% |
| Forward P/E | 12.60 | Short float | 3.80% |
| PEG (trailing) | 0.45 | Avg volume | 3,900,453 |
| P/S | 4.36 | Employees | 32,169 |
| P/B | 5.05 | Analyst rec (1=buy..5=sell) | 1.8 |
