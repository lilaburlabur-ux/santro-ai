...
Signed file: `NXPI.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $222.97 (2026-08-20, ~15-min delayed) |
| Market cap | $56.23B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-7.56%) with negative half-year (-3.11%). |
| Fresh setup quality | Poor / broken | -32.75% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 22.56%, revenue growth 19.50%. |
| Value attractiveness | Reasonable | Forward P/E 12.32, EV/Sales 4.94. |
| Risk level | Elevated | Beta 1.82, ATR 4.4% of price, short float 3.92%. |
...
| Valuation | P/E 44.42, forward P/E 12.32, P/S 4.26, P/B 4.93 | EV/Sales 4.94, EV/EBITDA 12.85 |
...
- **Volatility risk:** Beta 1.82, ATR 4.4% of price, short float 3.92%. Size positions accordingly.
...
| P/E (ttm) | 44.42 | Insider ownership | 0.14% |
| Forward P/E | 12.32 | Short float | 3.92% |
| PEG (trailing) | 0.55 | Avg volume | 4,258,161 |
| P/S | 4.26 | Employees | 32,169 |
| P/B | 4.93 | Analyst rec (1=buy..5=sell) | — |
