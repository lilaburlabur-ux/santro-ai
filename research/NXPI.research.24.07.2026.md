...
Signed file: `NXPI.research.24.07.2026`

| Field | Value |
|---|---|
| Current price | $269.24 (2026-07-24, ~15-min delayed) |
| Market cap | $67.98B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +21.95%; price +12.63% vs SMA200. |
| Fresh setup quality | Moderate / wait | -18.79% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 21.03%, revenue growth 12.20%. |
| Value attractiveness | Reasonable | Forward P/E 15.04, EV/Sales 6.21. |
| Risk level | Elevated | Beta 1.80, ATR 4.8% of price, short float 3.87%. |
...
|---|---|---|
| NXPI to Report Q2 Earnings: What's in Store for the Stock? | Zacks | 2026-07-24 |
| Countdown to NXP (NXPI) Q2 Earnings: A Look at Estimates Beyond Revenue and EPS | Zacks | 2026-07-23 |
| TXN Keeps Climbing. Should You Climb On? | Trefis | 2026-07-23 |
| 3 Cash-Producing Stocks We Find Risky | StockStory | 2026-07-22 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $269.24; 52w high $331.55 (-18.79%); 52w low $181.81 (+48.09%) |
| Trend | +12.63% vs SMA200, -8.71% vs SMA50, -3.04% vs SMA20 |
| Momentum | RSI(14) 42.7 (neutral) |
| Volatility | ATR(14) 12.97 (~4.8% of price); beta 1.80 |
| Setup perspective | -18.79% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 25.76, forward P/E 15.04, P/S 5.39, P/B 6.22 | EV/Sales 6.21, EV/EBITDA 18.84 |
| Growth expectations | Earnings growth 130.70%, EPS q/q 129.00% | Analyst mean target $314.10 (29 analysts) |
...
- **Volatility risk:** Beta 1.80, ATR 4.8% of price, short float 3.87%. Size positions accordingly.
...
|---|---|---|---|
| Price | $269.24 | EV/Sales | 6.21 |
| Market cap | $67.98B | EV/EBITDA | 18.84 |
| Beta | 1.80 | Gross margin | 55.63% |
| RSI(14) | 42.7 | Operating margin | 27.66% |
| ATR(14) | 12.97 | Profit margin | 21.03% |
| SMA20 dist | -3.04% | ROA | 8.14% |
| SMA50 dist | -8.71% | ROE | 25.81% |
| SMA200 dist | +12.63% | Revenue (ttm) | $12.62B |
| 52W high | $331.55 | Revenue growth y/y | 12.20% |
| 52W low | $181.81 | Inst. ownership | 103.02% |
| P/E (ttm) | 25.76 | Insider ownership | 0.14% |
| Forward P/E | 15.04 | Short float | 3.87% |
| PEG (trailing) | 0.70 | Avg volume | 4,205,706 |
| P/S | 5.39 | Employees | 32,169 |
| P/B | 6.22 | Analyst rec (1=buy..5=sell) | 1.8 |
