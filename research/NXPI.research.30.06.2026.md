...
Signed file: `NXPI.research.30.06.2026`

| Field | Value |
|---|---|
| Current price | $278.37 (2026-06-30, ~15-min delayed) |
| Market cap | $70.28B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +29.78%; price +18.94% vs SMA200. |
| Fresh setup quality | Moderate / wait | -16.04% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 21.03%, revenue growth 12.20%. |
| Value attractiveness | Reasonable | Forward P/E 15.72, EV/Sales 6.23. |
| Risk level | High | Beta 1.79, ATR 5.7% of price, short float 4.05%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $278.37; 52w high $331.55 (-16.04%); 52w low $181.81 (+53.11%) |
| Trend | +18.94% vs SMA200, -4.16% vs SMA50, -8.00% vs SMA20 |
| Momentum | RSI(14) 42.5 (neutral) |
| Volatility | ATR(14) 15.94 (~5.7% of price); beta 1.79 |
| Setup perspective | -16.04% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.59, forward P/E 15.72, P/S 5.57, P/B 6.44 | EV/Sales 6.23, EV/EBITDA 18.90 |
...
- **Volatility risk:** Beta 1.79, ATR 5.7% of price, short float 4.05%. Size positions accordingly.
...
|---|---|---|---|
| Price | $278.37 | EV/Sales | 6.23 |
| Market cap | $70.28B | EV/EBITDA | 18.90 |
| Beta | 1.79 | Gross margin | 55.63% |
| RSI(14) | 42.5 | Operating margin | 27.66% |
| ATR(14) | 15.94 | Profit margin | 21.03% |
| SMA20 dist | -8.00% | ROA | 8.14% |
| SMA50 dist | -4.16% | ROE | 25.81% |
| SMA200 dist | +18.94% | Revenue (ttm) | $12.62B |
| 52W high | $331.55 | Revenue growth y/y | 12.20% |
| 52W low | $181.81 | Inst. ownership | 100.75% |
| P/E (ttm) | 26.59 | Insider ownership | 0.14% |
| Forward P/E | 15.72 | Short float | 4.05% |
| PEG (trailing) | 0.71 | Avg volume | 3,973,017 |
