...
Signed file: `NXPI.research.30.07.2026`

| Field | Value |
|---|---|
| Current price | $245.16 (2026-07-30, ~15-min delayed) |
| Market cap | $61.82B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +10.05%; price +2.23% vs SMA200. |
| Fresh setup quality | Poor / broken | -26.06% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 22.56%, revenue growth 19.50%. |
| Value attractiveness | Reasonable | Forward P/E 13.49, EV/Sales 5.22. |
| Risk level | High | Beta 1.80, ATR 5.3% of price, short float 3.86%. |
...
|---|---|---|
| NXPI Q2 Deep Dive: Broad-Based Revenue Growth and Strong Guidance Across All End Markets | StockStory | 2026-07-30 |
...
| NXP Semiconductors N.V. Q2 2026 Earnings Call Summary | Moby | 2026-07-29 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $245.16; 52w high $331.55 (-26.06%); 52w low $181.81 (+34.85%) |
| Trend | +2.23% vs SMA200, -15.97% vs SMA50, -10.04% vs SMA20 |
| Momentum | RSI(14) 34.1 (neutral) |
| Volatility | ATR(14) 13.06 (~5.3% of price); beta 1.80 |
| Setup perspective | -26.06% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 1.80, ATR 5.3% of price, short float 3.86%. Size positions accordingly.
...
|---|---|---|---|
| Price | $245.16 | EV/Sales | 5.22 |
| Market cap | $61.82B | EV/EBITDA | 13.59 |
| Beta | 1.80 | Gross margin | 56.10% |
| RSI(14) | 34.1 | Operating margin | 30.41% |
| ATR(14) | 13.06 | Profit margin | 22.56% |
| SMA20 dist | -10.04% | ROA | 10.46% |
| SMA50 dist | -15.97% | ROE | 27.92% |
| SMA200 dist | +2.23% | Revenue (ttm) | $13.19B |
| 52W high | $331.55 | Revenue growth y/y | 19.50% |
| 52W low | $181.81 | Inst. ownership | 100.98% |
| P/E (ttm) | 48.93 | Insider ownership | 0.14% |
| Forward P/E | 13.49 | Short float | 3.86% |
| PEG (trailing) | 0.61 | Avg volume | 4,170,280 |
| P/S | 4.69 | Employees | 32,169 |
| P/B | 5.67 | Analyst rec (1=buy..5=sell) | 1.8 |
