...
Signed file: `QCOM.research.03.08.2026`

| Field | Value |
|---|---|
| Current price | $151.57 (2026-08-03, ~15-min delayed) |
| Market cap | $159.15B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +5.45%; price -9.69% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 14.72, EV/Sales 3.67. |
| Risk level | High | Beta 1.66, ATR 6.3% of price, short float 3.84%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $151.57; 52w high $250.10 (-39.40%); 52w low $123.61 (+22.62%) |
| Trend | -9.69% vs SMA200, -23.19% vs SMA50, -11.60% vs SMA20 |
| Momentum | RSI(14) 32.8 (neutral) |
| Volatility | ATR(14) 9.54 (~6.3% of price); beta 1.66 |
...
| Valuation | P/E 17.32, forward P/E 14.72, P/S 3.61, P/B 5.88 | EV/Sales 3.67, EV/EBITDA 13.50 |
...
- **Volatility risk:** Beta 1.66, ATR 6.3% of price, short float 3.84%. Size positions accordingly.
...
|---|---|---|---|
| Price | $151.57 | EV/Sales | 3.67 |
| Market cap | $159.15B | EV/EBITDA | 13.50 |
| Beta | 1.66 | Gross margin | 54.23% |
| RSI(14) | 32.8 | Operating margin | 18.53% |
| ATR(14) | 9.54 | Profit margin | 21.01% |
| SMA20 dist | -11.60% | ROA | 11.61% |
| SMA50 dist | -23.19% | ROE | 33.75% |
| SMA200 dist | -9.69% | Revenue (ttm) | $44.07B |
| 52W high | $250.10 | Revenue growth y/y | -4.00% |
| 52W low | $123.61 | Inst. ownership | 84.53% |
| P/E (ttm) | 17.32 | Insider ownership | 0.12% |
| Forward P/E | 14.72 | Short float | 3.84% |
| PEG (trailing) | 0.63 | Avg volume | 21,664,000 |
| P/S | 3.61 | Employees | 52,000 |
| P/B | 5.88 | Analyst rec (1=buy..5=sell) | 2.6 |
