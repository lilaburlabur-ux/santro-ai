...
Signed file: `QCOM.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $168.57 (2026-09-03, ~15-min delayed) |
| Market cap | $180.04B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +9.44%; price +0.95% vs SMA200. |
| Fresh setup quality | Poor / broken | -32.60% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 16.52, EV/Sales 4.21. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $168.57; 52w high $250.10 (-32.60%); 52w low $123.61 (+36.37%) |
| Trend | +0.95% vs SMA200, -0.86% vs SMA50, +2.80% vs SMA20 |
| Momentum | RSI(14) 52.9 (neutral) |
| Volatility | ATR(14) 6.19 (~3.7% of price); beta 1.66 |
| Setup perspective | -32.60% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 19.27, forward P/E 16.52, P/S 4.09, P/B 6.44 | EV/Sales 4.21, EV/EBITDA 15.46 |
...
|---|---|---|---|
| Price | $168.57 | EV/Sales | 4.21 |
| Market cap | $180.04B | EV/EBITDA | 15.46 |
| Beta | 1.66 | Gross margin | 54.23% |
| RSI(14) | 52.9 | Operating margin | 18.53% |
| ATR(14) | 6.19 | Profit margin | 21.01% |
| SMA20 dist | +2.80% | ROA | 11.61% |
| SMA50 dist | -0.86% | ROE | 33.75% |
| SMA200 dist | +0.95% | Revenue (ttm) | $44.07B |
| 52W high | $250.10 | Revenue growth y/y | -4.00% |
| 52W low | $123.61 | Inst. ownership | 83.16% |
| P/E (ttm) | 19.27 | Insider ownership | 0.12% |
| Forward P/E | 16.52 | Short float | 3.48% |
| PEG (trailing) | 0.74 | Avg volume | 15,002,028 |
| P/S | 4.09 | Employees | 52,000 |
| P/B | 6.44 | Analyst rec (1=buy..5=sell) | — |
