...
Signed file: `QCOM.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $162.67 (2026-08-04, ~15-min delayed) |
| Market cap | $170.80B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +12.08%; price -3.08% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 15.80, EV/Sales 3.77. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $162.67; 52w high $250.10 (-34.96%); 52w low $123.61 (+31.60%) |
| Trend | -3.08% vs SMA200, -17.15% vs SMA50, -4.56% vs SMA20 |
| Momentum | RSI(14) 42.4 (neutral) |
| Volatility | ATR(14) 9.71 (~6.0% of price); beta 1.66 |
...
| P/B | 6.22 | Analyst rec (1=buy..5=sell) | 2.6 |
