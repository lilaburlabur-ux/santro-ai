...
Signed file: `QCOM.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $157.53 (2026-08-05, ~15-min delayed) |
| Market cap | $165.41B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +9.04%; price -6.13% vs SMA200. |
| Fresh setup quality | Poor / broken | -37.01% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 15.30, EV/Sales 3.77. |
| Risk level | High | Beta 1.66, ATR 6.0% of price, short float 3.83%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $157.53; 52w high $250.10 (-37.01%); 52w low $123.61 (+27.44%) |
| Trend | -6.13% vs SMA200, -19.11% vs SMA50, -6.78% vs SMA20 |
| Momentum | RSI(14) 39.6 (neutral) |
| Volatility | ATR(14) 9.42 (~6.0% of price); beta 1.66 |
| Setup perspective | -37.01% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 1.66, ATR 6.0% of price, short float 3.83%. Size positions accordingly.
...
| SMA20 dist | -6.78% | ROA | 11.61% |
| SMA50 dist | -19.11% | ROE | 33.75% |
| SMA200 dist | -6.13% | Revenue (ttm) | $44.07B |
| 52W high | $250.10 | Revenue growth y/y | -4.00% |
| 52W low | $123.61 | Inst. ownership | 84.04% |
| P/E (ttm) | 18.00 | Insider ownership | 0.12% |
| Forward P/E | 15.30 | Short float | 3.83% |
| PEG (trailing) | 0.63 | Avg volume | 21,302,957 |
| P/S | 3.75 | Employees | 52,000 |
| P/B | 6.02 | Analyst rec (1=buy..5=sell) | 2.6 |
