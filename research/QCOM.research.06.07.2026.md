...
Signed file: `QCOM.research.06.07.2026`

| Field | Value |
|---|---|
| Current price | $186.48 (2026-07-06, ~15-min delayed) |
| Market cap | $196.55B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +17.31%; price +11.60% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 16.93, EV/Sales 4.30. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $186.48; 52w high $250.10 (-25.44%); 52w low $123.61 (+50.86%) |
| Trend | +11.60% vs SMA200, -8.16% vs SMA50, -8.02% vs SMA20 |
| Momentum | RSI(14) 43.4 (neutral) |
| Volatility | ATR(14) 15.62 (~8.4% of price); beta 1.64 |
...
| Valuation | P/E 20.03, forward P/E 16.93, P/S 4.42, P/B 7.24 | EV/Sales 4.30, EV/EBITDA 14.71 |
...
|---|---|---|---|
| Price | $186.48 | EV/Sales | 4.30 |
| Market cap | $196.55B | EV/EBITDA | 14.71 |
| Beta | 1.64 | Gross margin | 54.80% |
| RSI(14) | 43.4 | Operating margin | 22.06% |
| ATR(14) | 15.62 | Profit margin | 22.31% |
| SMA20 dist | -8.02% | ROA | 12.69% |
| SMA50 dist | -8.16% | ROE | 36.08% |
| SMA200 dist | +11.60% | Revenue (ttm) | $44.49B |
