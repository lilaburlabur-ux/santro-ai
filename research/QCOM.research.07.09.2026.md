...
Signed file: `QCOM.research.07.09.2026`

| Field | Value |
|---|---|
| Current price | $168.74 (2026-09-07, ~15-min delayed) |
| Market cap | $180.22B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +7.85%; price +1.58% vs SMA200. |
| Fresh setup quality | Poor / broken | -32.16% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 16.51, EV/Sales 4.18. |
| Risk level | Elevated | Beta 1.68, ATR 3.5% of price, short float 3.48%. |
...
| MarketBeat Week in Review – 08/31 - 09/04 | MarketBeat | 2026-09-05 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $168.74; 52w high $248.74 (-32.16%); 52w low $122.94 (+37.25%) |
| Trend | +1.58% vs SMA200, +0.18% vs SMA50, +3.38% vs SMA20 |
| Momentum | RSI(14) 54.2 (neutral) |
| Volatility | ATR(14) 5.97 (~3.5% of price); beta 1.68 |
| Setup perspective | -32.16% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 19.26, forward P/E 16.51, P/S 4.09, P/B 6.45 | EV/Sales 4.18, EV/EBITDA 15.35 |
...
- **Volatility risk:** Beta 1.68, ATR 3.5% of price, short float 3.48%. Size positions accordingly.
...
|---|---|---|---|
| Price | $168.74 | EV/Sales | 4.18 |
| Market cap | $180.22B | EV/EBITDA | 15.35 |
| Beta | 1.68 | Gross margin | 54.23% |
| RSI(14) | 54.2 | Operating margin | 18.53% |
| ATR(14) | 5.97 | Profit margin | 21.01% |
| SMA20 dist | +3.38% | ROA | 11.61% |
| SMA50 dist | +0.18% | ROE | 33.75% |
| SMA200 dist | +1.58% | Revenue (ttm) | $44.07B |
| 52W high | $248.74 | Revenue growth y/y | -4.00% |
| 52W low | $122.94 | Inst. ownership | 83.24% |
| P/E (ttm) | 19.26 | Insider ownership | 0.12% |
| Forward P/E | 16.51 | Short float | 3.48% |
| PEG (trailing) | 0.75 | Avg volume | 14,639,307 |
| P/S | 4.09 | Employees | 52,000 |
| P/B | 6.45 | Analyst rec (1=buy..5=sell) | 2.6 |
