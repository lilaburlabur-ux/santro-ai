...
Signed file: `QCOM.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $174.09 (2026-09-08, ~15-min delayed) |
| Market cap | $185.94B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +11.18%; price +4.76% vs SMA200. |
| Fresh setup quality | Poor / broken | -30.01% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 17.04, EV/Sales 4.18. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $174.09; 52w high $248.74 (-30.01%); 52w low $122.94 (+41.60%) |
| Trend | +4.76% vs SMA200, +3.54% vs SMA50, +6.24% vs SMA20 |
| Momentum | RSI(14) 60.1 (neutral) |
| Volatility | ATR(14) 6.60 (~3.8% of price); beta 1.68 |
| Setup perspective | -30.01% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 19.87, forward P/E 17.04, P/S 4.22, P/B 6.65 | EV/Sales 4.18, EV/EBITDA 15.35 |
...
|---|---|---|---|
| Price | $174.09 | EV/Sales | 4.18 |
| Market cap | $185.94B | EV/EBITDA | 15.35 |
| Beta | 1.68 | Gross margin | 54.23% |
| RSI(14) | 60.1 | Operating margin | 18.53% |
| ATR(14) | 6.60 | Profit margin | 21.01% |
| SMA20 dist | +6.24% | ROA | 11.61% |
| SMA50 dist | +3.54% | ROE | 33.75% |
| SMA200 dist | +4.76% | Revenue (ttm) | $44.07B |
| 52W high | $248.74 | Revenue growth y/y | -4.00% |
| 52W low | $122.94 | Inst. ownership | 83.25% |
| P/E (ttm) | 19.87 | Insider ownership | 0.12% |
| Forward P/E | 17.04 | Short float | 3.48% |
| PEG (trailing) | 0.75 | Avg volume | 14,598,319 |
| P/S | 4.22 | Employees | 52,000 |
| P/B | 6.65 | Analyst rec (1=buy..5=sell) | 2.6 |
