...
Signed file: `QCOM.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $176.40 (2026-09-09, ~15-min delayed) |
| Market cap | $188.41B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +12.38%; price +6.11% vs SMA200. |
| Fresh setup quality | Poor / broken | -29.08% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 17.26, EV/Sales 4.31. |
| Risk level | Elevated | Beta 1.68, ATR 3.8% of price, short float 3.48%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $176.40; 52w high $248.74 (-29.08%); 52w low $122.94 (+43.48%) |
| Trend | +6.11% vs SMA200, +5.05% vs SMA50, +7.17% vs SMA20 |
| Momentum | RSI(14) 62.3 (neutral) |
| Volatility | ATR(14) 6.67 (~3.8% of price); beta 1.68 |
| Setup perspective | -29.08% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 20.14, forward P/E 17.26, P/S 4.28, P/B 6.74 | EV/Sales 4.31, EV/EBITDA 15.82 |
...
- **Volatility risk:** Beta 1.68, ATR 3.8% of price, short float 3.48%. Size positions accordingly.
...
|---|---|---|---|
| Price | $176.40 | EV/Sales | 4.31 |
| Market cap | $188.41B | EV/EBITDA | 15.82 |
| Beta | 1.68 | Gross margin | 54.23% |
| RSI(14) | 62.3 | Operating margin | 18.53% |
| ATR(14) | 6.67 | Profit margin | 21.01% |
| SMA20 dist | +7.17% | ROA | 11.61% |
| SMA50 dist | +5.05% | ROE | 33.75% |
| SMA200 dist | +6.11% | Revenue (ttm) | $44.07B |
| 52W high | $248.74 | Revenue growth y/y | -4.00% |
| 52W low | $122.94 | Inst. ownership | 83.22% |
| P/E (ttm) | 20.14 | Insider ownership | 0.12% |
| Forward P/E | 17.26 | Short float | 3.48% |
| PEG (trailing) | 0.77 | Avg volume | 14,536,622 |
| P/S | 4.28 | Employees | 52,000 |
| P/B | 6.74 | Analyst rec (1=buy..5=sell) | 2.6 |
