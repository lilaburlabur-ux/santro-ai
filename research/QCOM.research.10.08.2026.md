...
Signed file: `QCOM.research.10.08.2026`

| Field | Value |
|---|---|
| Current price | $162.17 (2026-08-10, ~15-min delayed) |
| Market cap | $170.28B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +13.49%; price -3.36% vs SMA200. |
| Fresh setup quality | Poor / broken | -35.16% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 15.80, EV/Sales 4.16. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $162.17; 52w high $250.10 (-35.16%); 52w low $123.61 (+31.19%) |
| Trend | -3.36% vs SMA200, -14.69% vs SMA50, -1.89% vs SMA20 |
| Momentum | RSI(14) 44.1 (neutral) |
| Volatility | ATR(14) 8.99 (~5.5% of price); beta 1.66 |
| Setup perspective | -35.16% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 18.53, forward P/E 15.80, P/S 3.86, P/B 6.20 | EV/Sales 4.16, EV/EBITDA 15.27 |
...
|---|---|---|---|
| Price | $162.17 | EV/Sales | 4.16 |
| Market cap | $170.28B | EV/EBITDA | 15.27 |
| Beta | 1.66 | Gross margin | 54.23% |
| RSI(14) | 44.1 | Operating margin | 18.53% |
| ATR(14) | 8.99 | Profit margin | 21.01% |
| SMA20 dist | -1.89% | ROA | 11.61% |
| SMA50 dist | -14.69% | ROE | 33.75% |
| SMA200 dist | -3.36% | Revenue (ttm) | $44.07B |
...
| PEG (trailing) | 0.72 | Avg volume | 19,732,895 |
| P/S | 3.86 | Employees | 52,000 |
| P/B | 6.20 | Analyst rec (1=buy..5=sell) | 2.5 |
