...
Signed file: `QCOM.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $176.88 (2026-09-10, ~15-min delayed) |
| Market cap | $188.92B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +13.81%; price +6.33% vs SMA200. |
| Fresh setup quality | Poor / broken | -28.89% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 17.31, EV/Sales 4.36. |
| Risk level | Elevated | Beta 1.68, ATR 4.0% of price, short float 3.48%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $176.88; 52w high $248.74 (-28.89%); 52w low $122.94 (+43.87%) |
| Trend | +6.33% vs SMA200, +5.42% vs SMA50, +6.99% vs SMA20 |
| Momentum | RSI(14) 62.8 (neutral) |
| Volatility | ATR(14) 7.01 (~4.0% of price); beta 1.68 |
| Setup perspective | -28.89% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 20.21, forward P/E 17.31, P/S 4.29, P/B 6.76 | EV/Sales 4.36, EV/EBITDA 16.02 |
...
- **Volatility risk:** Beta 1.68, ATR 4.0% of price, short float 3.48%. Size positions accordingly.
...
|---|---|---|---|
| Price | $176.88 | EV/Sales | 4.36 |
| Market cap | $188.92B | EV/EBITDA | 16.02 |
| Beta | 1.68 | Gross margin | 54.23% |
| RSI(14) | 62.8 | Operating margin | 18.53% |
| ATR(14) | 7.01 | Profit margin | 21.01% |
| SMA20 dist | +6.99% | ROA | 11.61% |
| SMA50 dist | +5.42% | ROE | 33.75% |
| SMA200 dist | +6.33% | Revenue (ttm) | $44.07B |
| 52W high | $248.74 | Revenue growth y/y | -4.00% |
| 52W low | $122.94 | Inst. ownership | 83.22% |
| P/E (ttm) | 20.21 | Insider ownership | 0.12% |
| Forward P/E | 17.31 | Short float | 3.48% |
| PEG (trailing) | 0.78 | Avg volume | 14,478,937 |
| P/S | 4.29 | Employees | 52,000 |
| P/B | 6.76 | Analyst rec (1=buy..5=sell) | 2.6 |
