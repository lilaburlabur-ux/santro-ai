...
Signed file: `QCOM.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $181.97 (2026-09-11, ~15-min delayed) |
| Market cap | $194.35B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +16.87%; price +9.32% vs SMA200. |
| Fresh setup quality | Poor / broken | -26.84% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 17.84, EV/Sales 4.37. |
| Risk level | Elevated | Beta 1.68, ATR 4.0% of price, short float 3.53%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $181.97; 52w high $248.74 (-26.84%); 52w low $122.94 (+48.01%) |
| Trend | +9.32% vs SMA200, +8.44% vs SMA50, +9.47% vs SMA20 |
| Momentum | RSI(14) 67.4 (neutral) |
| Volatility | ATR(14) 7.20 (~4.0% of price); beta 1.68 |
| Setup perspective | -26.84% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 1.68, ATR 4.0% of price, short float 3.53%. Size positions accordingly.
...
|---|---|---|---|
| Price | $181.97 | EV/Sales | 4.37 |
| Market cap | $194.35B | EV/EBITDA | 16.06 |
| Beta | 1.68 | Gross margin | 54.23% |
| RSI(14) | 67.4 | Operating margin | 18.53% |
| ATR(14) | 7.20 | Profit margin | 21.01% |
| SMA20 dist | +9.47% | ROA | 11.61% |
| SMA50 dist | +8.44% | ROE | 33.75% |
| SMA200 dist | +9.32% | Revenue (ttm) | $44.07B |
| 52W high | $248.74 | Revenue growth y/y | -4.00% |
| 52W low | $122.94 | Inst. ownership | 83.08% |
| P/E (ttm) | 20.77 | Insider ownership | 0.12% |
| Forward P/E | 17.84 | Short float | 3.53% |
| PEG (trailing) | 0.79 | Avg volume | 14,424,875 |
| P/S | 4.41 | Employees | 52,000 |
| P/B | 6.95 | Analyst rec (1=buy..5=sell) | 2.6 |
