...
Signed file: `QCOM.research.12.06.2026`

| Field | Value |
|---|---|
| Current price | $211.72 (2026-06-12, ~15-min delayed) |
| Market cap | $223.15B |
...
|---|---|---|
| Technical momentum | High | 1Y +35.55%; price +29.04% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 19.85, EV/Sales 4.93. |
| Risk level | High | Beta 1.60, ATR 8.1% of price, short float 4.78%. |
...
| Micron Stock And The Supply-Demand Tightrope | Trefis | 2026-06-12 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $211.72; 52w high $250.10 (-15.34%); 52w low $123.61 (+71.28%) |
| Trend | +29.04% vs SMA200, +15.40% vs SMA50, -4.37% vs SMA20 |
| Momentum | RSI(14) 50.8 (neutral) |
| Volatility | ATR(14) 17.17 (~8.1% of price); beta 1.60 |
...
| Valuation | P/E 22.77, forward P/E 19.85, P/S 5.02, P/B 8.22 | EV/Sales 4.93, EV/EBITDA 16.88 |
...
- **Volatility risk:** Beta 1.60, ATR 8.1% of price, short float 4.78%. Size positions accordingly.
...
|---|---|---|---|
| Price | $211.72 | EV/Sales | 4.93 |
| Market cap | $223.15B | EV/EBITDA | 16.88 |
| Beta | 1.60 | Gross margin | 54.80% |
| RSI(14) | 50.8 | Operating margin | 22.06% |
| ATR(14) | 17.17 | Profit margin | 22.31% |
| SMA20 dist | -4.37% | ROA | 12.69% |
| SMA50 dist | +15.40% | ROE | 36.08% |
| SMA200 dist | +29.04% | Revenue (ttm) | $44.49B |
| 52W high | $250.10 | Revenue growth y/y | -3.50% |
| 52W low | $123.61 | Inst. ownership | 84.81% |
| P/E (ttm) | 22.77 | Insider ownership | 0.13% |
| Forward P/E | 19.85 | Short float | 4.78% |
| PEG (trailing) | 0.86 | Avg volume | 20,714,314 |
| P/S | 5.02 | Employees | 52,000 |
| P/B | 8.22 | Analyst rec (1=buy..5=sell) | 2.6 |
