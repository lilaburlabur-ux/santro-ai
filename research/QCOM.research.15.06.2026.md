...
Signed file: `QCOM.research.15.06.2026`

| Field | Value |
|---|---|
| Current price | $220.81 (2026-06-15, ~15-min delayed) |
| Market cap | $232.73B |
...
|---|---|---|
| Technical momentum | High | 1Y +42.07%; price +34.32% vs SMA200. |
| Fresh setup quality | Moderate / wait | -11.71% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 22.31%, revenue growth -3.50%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 20.70, EV/Sales 5.14. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $220.81; 52w high $250.10 (-11.71%); 52w low $123.61 (+78.63%) |
| Trend | +34.32% vs SMA200, +19.13% vs SMA50, -0.71% vs SMA20 |
| Momentum | RSI(14) 53.7 (neutral) |
| Volatility | ATR(14) 16.99 (~7.7% of price); beta 1.60 |
| Setup perspective | -11.71% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 23.77, forward P/E 20.70, P/S 5.23, P/B 8.57 | EV/Sales 5.14, EV/EBITDA 17.59 |
...
- **Valuation risk:** Forward P/E 20.70, EV/Sales 5.14. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $220.81 | EV/Sales | 5.14 |
| Market cap | $232.73B | EV/EBITDA | 17.59 |
| Beta | 1.60 | Gross margin | 54.80% |
| RSI(14) | 53.7 | Operating margin | 22.06% |
| ATR(14) | 16.99 | Profit margin | 22.31% |
| SMA20 dist | -0.71% | ROA | 12.69% |
| SMA50 dist | +19.13% | ROE | 36.08% |
| SMA200 dist | +34.32% | Revenue (ttm) | $44.49B |
| 52W high | $250.10 | Revenue growth y/y | -3.50% |
| 52W low | $123.61 | Inst. ownership | 84.80% |
| P/E (ttm) | 23.77 | Insider ownership | 0.13% |
| Forward P/E | 20.70 | Short float | 4.78% |
| PEG (trailing) | 0.90 | Avg volume | 20,815,477 |
| P/S | 5.23 | Employees | 52,000 |
| P/B | 8.57 | Analyst rec (1=buy..5=sell) | 2.6 |
