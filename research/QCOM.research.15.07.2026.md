...
Signed file: `QCOM.research.15.07.2026`

| Field | Value |
|---|---|
| Current price | $177.98 (2026-07-15, ~15-min delayed) |
| Market cap | $187.59B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +17.79%; price +6.12% vs SMA200. |
| Fresh setup quality | Poor / broken | -28.84% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 22.31%, revenue growth -3.50%. |
| Value attractiveness | Reasonable | Forward P/E 16.12, EV/Sales 4.34. |
| Risk level | High | Beta 1.64, ATR 7.0% of price, short float 4.27%. |
...
| Micron Stock Offers More Than Market Momentum | Trefis | 2026-07-15 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $177.98; 52w high $250.10 (-28.84%); 52w low $123.61 (+43.98%) |
| Trend | +6.12% vs SMA200, -14.03% vs SMA50, -8.23% vs SMA20 |
| Momentum | RSI(14) 40.5 (neutral) |
| Volatility | ATR(14) 12.49 (~7.0% of price); beta 1.64 |
| Setup perspective | -28.84% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 19.14, forward P/E 16.12, P/S 4.22, P/B 6.91 | EV/Sales 4.34, EV/EBITDA 14.86 |
| Growth expectations | Earnings growth 173.00%, EPS q/q 162.10% | Analyst mean target $221.90 (30 analysts) |
...
- **Volatility risk:** Beta 1.64, ATR 7.0% of price, short float 4.27%. Size positions accordingly.
...
|---|---|---|---|
| Price | $177.98 | EV/Sales | 4.34 |
| Market cap | $187.59B | EV/EBITDA | 14.86 |
| Beta | 1.64 | Gross margin | 54.80% |
| RSI(14) | 40.5 | Operating margin | 22.06% |
| ATR(14) | 12.49 | Profit margin | 22.31% |
| SMA20 dist | -8.23% | ROA | 12.69% |
| SMA50 dist | -14.03% | ROE | 36.08% |
| SMA200 dist | +6.12% | Revenue (ttm) | $44.49B |
| 52W high | $250.10 | Revenue growth y/y | -3.50% |
| 52W low | $123.61 | Inst. ownership | 84.55% |
| P/E (ttm) | 19.14 | Insider ownership | 0.12% |
| Forward P/E | 16.12 | Short float | 4.27% |
| PEG (trailing) | 0.56 | Avg volume | 23,527,032 |
| P/S | 4.22 | Employees | 52,000 |
