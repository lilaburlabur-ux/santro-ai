...
Signed file: `QCOM.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $187.80 (2026-09-15, ~15-min delayed) |
| Market cap | $200.58B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $187.80; 52w high $248.74 (-24.50%); 52w low $122.94 (+52.75%) |
| Trend | +12.66% vs SMA200, +11.82% vs SMA50, +11.57% vs SMA20 |
| Momentum | RSI(14) 70.4 (overbought) |
| Volatility | ATR(14) 7.68 (~4.1% of price); beta 1.68 |
| Setup perspective | -24.50% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | +11.57% | ROA | 11.61% |
| SMA50 dist | +11.82% | ROE | 33.75% |
| SMA200 dist | +12.66% | Revenue (ttm) | $44.07B |
| 52W high | $248.74 | Revenue growth y/y | -4.00% |
| 52W low | $122.94 | Inst. ownership | 83.06% |
| P/E (ttm) | 21.44 | Insider ownership | 0.12% |
| Forward P/E | 18.40 | Short float | 3.53% |
| PEG (trailing) | 0.80 | Avg volume | 14,379,735 |
| P/S | 4.55 | Employees | 52,000 |
| P/B | 7.18 | Analyst rec (1=buy..5=sell) | 2.6 |
