...
Signed file: `QCOM.research.16.07.2026`

| Field | Value |
|---|---|
| Current price | $170.61 (2026-07-16, ~15-min delayed) |
| Market cap | $179.82B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +12.90%; price +1.71% vs SMA200. |
| Fresh setup quality | Poor / broken | -31.78% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 22.31%, revenue growth -3.50%. |
| Value attractiveness | Reasonable | Forward P/E 15.44, EV/Sales 4.34. |
| Risk level | High | Beta 1.64, ATR 7.2% of price, short float 4.27%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $170.61; 52w high $250.10 (-31.78%); 52w low $123.61 (+38.02%) |
| Trend | +1.71% vs SMA200, -17.61% vs SMA50, -11.03% vs SMA20 |
| Momentum | RSI(14) 37.2 (neutral) |
| Volatility | ATR(14) 12.24 (~7.2% of price); beta 1.64 |
| Setup perspective | -31.78% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 18.33, forward P/E 15.44, P/S 4.04, P/B 6.62 | EV/Sales 4.34, EV/EBITDA 14.85 |
...
- **Volatility risk:** Beta 1.64, ATR 7.2% of price, short float 4.27%. Size positions accordingly.
...
|---|---|---|---|
| Price | $170.61 | EV/Sales | 4.34 |
| Market cap | $179.82B | EV/EBITDA | 14.85 |
| Beta | 1.64 | Gross margin | 54.80% |
| RSI(14) | 37.2 | Operating margin | 22.06% |
| ATR(14) | 12.24 | Profit margin | 22.31% |
| SMA20 dist | -11.03% | ROA | 12.69% |
| SMA50 dist | -17.61% | ROE | 36.08% |
| SMA200 dist | +1.71% | Revenue (ttm) | $44.49B |
| 52W high | $250.10 | Revenue growth y/y | -3.50% |
| 52W low | $123.61 | Inst. ownership | 84.69% |
| P/E (ttm) | 18.33 | Insider ownership | 0.12% |
| Forward P/E | 15.44 | Short float | 4.27% |
| PEG (trailing) | 0.56 | Avg volume | 23,548,252 |
| P/S | 4.04 | Employees | 52,000 |
| P/B | 6.62 | Analyst rec (1=buy..5=sell) | 2.6 |
