...
Signed file: `QCOM.research.17.07.2026`

| Field | Value |
|---|---|
| Current price | $171.78 (2026-07-17, ~15-min delayed) |
| Market cap | $181.06B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +13.84%; price +2.38% vs SMA200. |
| Fresh setup quality | Poor / broken | -31.31% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 22.31%, revenue growth -3.50%. |
| Value attractiveness | Reasonable | Forward P/E 15.54, EV/Sales 4.17. |
| Risk level | High | Beta 1.64, ATR 6.9% of price, short float 4.27%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $171.78; 52w high $250.10 (-31.31%); 52w low $123.61 (+38.97%) |
| Trend | +2.38% vs SMA200, -16.93% vs SMA50, -9.45% vs SMA20 |
| Momentum | RSI(14) 38.1 (neutral) |
| Volatility | ATR(14) 11.91 (~6.9% of price); beta 1.64 |
| Setup perspective | -31.31% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 18.47, forward P/E 15.54, P/S 4.07, P/B 6.67 | EV/Sales 4.17, EV/EBITDA 14.25 |
...
- **Volatility risk:** Beta 1.64, ATR 6.9% of price, short float 4.27%. Size positions accordingly.
...
|---|---|---|---|
| Price | $171.78 | EV/Sales | 4.17 |
| Market cap | $181.06B | EV/EBITDA | 14.25 |
| Beta | 1.64 | Gross margin | 54.80% |
| RSI(14) | 38.1 | Operating margin | 22.06% |
| ATR(14) | 11.91 | Profit margin | 22.31% |
| SMA20 dist | -9.45% | ROA | 12.69% |
| SMA50 dist | -16.93% | ROE | 36.08% |
| SMA200 dist | +2.38% | Revenue (ttm) | $44.49B |
| 52W high | $250.10 | Revenue growth y/y | -3.50% |
| 52W low | $123.61 | Inst. ownership | 85.68% |
| P/E (ttm) | 18.47 | Insider ownership | 0.12% |
| Forward P/E | 15.54 | Short float | 4.27% |
| PEG (trailing) | 0.54 | Avg volume | 23,650,947 |
| P/S | 4.07 | Employees | 52,000 |
| P/B | 6.67 | Analyst rec (1=buy..5=sell) | 2.6 |
