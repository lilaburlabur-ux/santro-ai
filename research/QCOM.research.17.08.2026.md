...
Signed file: `QCOM.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $162.18 (2026-08-17, ~15-min delayed) |
| Market cap | $170.29B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +4.75%; price -3.23% vs SMA200. |
| Fresh setup quality | Poor / broken | -35.15% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 15.90, EV/Sales 4.11. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $162.18; 52w high $250.10 (-35.15%); 52w low $123.61 (+31.20%) |
| Trend | -3.23% vs SMA200, -11.02% vs SMA50, -0.37% vs SMA20 |
| Momentum | RSI(14) 44.3 (neutral) |
| Volatility | ATR(14) 7.57 (~4.7% of price); beta 1.66 |
| Setup perspective | -35.15% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 18.53, forward P/E 15.90, P/S 3.86, P/B 6.20 | EV/Sales 4.11, EV/EBITDA 15.09 |
| Growth expectations | Earnings growth -23.00%, EPS q/q -24.90% | Analyst mean target $193.10 (30 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 83.51% |
...
- **Volatility risk:** Beta 1.66, ATR 4.7% of price, short float 3.69%. Size positions accordingly.
...
|---|---|---|---|
| Price | $162.18 | EV/Sales | 4.11 |
| Market cap | $170.29B | EV/EBITDA | 15.09 |
| Beta | 1.66 | Gross margin | 54.23% |
| RSI(14) | 44.3 | Operating margin | 18.53% |
| ATR(14) | 7.57 | Profit margin | 21.01% |
| SMA20 dist | -0.37% | ROA | 11.61% |
| SMA50 dist | -11.02% | ROE | 33.75% |
| SMA200 dist | -3.23% | Revenue (ttm) | $44.07B |
| 52W high | $250.10 | Revenue growth y/y | -4.00% |
| 52W low | $123.61 | Inst. ownership | 83.51% |
| P/E (ttm) | 18.53 | Insider ownership | 0.12% |
| Forward P/E | 15.90 | Short float | 3.69% |
| PEG (trailing) | 0.71 | Avg volume | 17,729,567 |
| P/S | 3.86 | Employees | 52,000 |
| P/B | 6.20 | Analyst rec (1=buy..5=sell) | 2.6 |
