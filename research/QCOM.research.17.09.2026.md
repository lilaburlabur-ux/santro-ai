...
Signed file: `QCOM.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $188.71 (2026-09-17, ~15-min delayed) |
| Market cap | $201.55B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +17.36%; price +13.05% vs SMA200. |
| Fresh setup quality | Moderate / wait | -24.13% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 18.49, EV/Sales 4.66. |
...
|---|---|---|
| Trump-Xi Dinner Next Week Brings AI Titans To The Table — OpenAI, NVDA, and QCOM CEOs To Attend, Says Report | Stocktwits | 2026-09-17 |
| Qualcomm (QCOM) Outpaces Stock Market Gains: What You Should Know | Zacks | 2026-09-17 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $188.71; 52w high $248.74 (-24.13%); 52w low $122.94 (+53.49%) |
| Trend | +13.05% vs SMA200, +12.28% vs SMA50, +10.37% vs SMA20 |
| Momentum | RSI(14) 68.7 (neutral) |
| Volatility | ATR(14) 7.65 (~4.1% of price); beta 1.68 |
| Setup perspective | -24.13% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 21.59, forward P/E 18.49, P/S 4.57, P/B 7.21 | EV/Sales 4.66, EV/EBITDA 17.10 |
...
- **Volatility risk:** Beta 1.68, ATR 4.1% of price, short float 3.53%. Size positions accordingly.
...
|---|---|---|---|
| Price | $188.71 | EV/Sales | 4.66 |
| Market cap | $201.55B | EV/EBITDA | 17.10 |
| Beta | 1.68 | Gross margin | 54.23% |
| RSI(14) | 68.7 | Operating margin | 18.53% |
| ATR(14) | 7.65 | Profit margin | 21.01% |
| SMA20 dist | +10.37% | ROA | 11.61% |
| SMA50 dist | +12.28% | ROE | 33.75% |
| SMA200 dist | +13.05% | Revenue (ttm) | $44.07B |
| 52W high | $248.74 | Revenue growth y/y | -4.00% |
| 52W low | $122.94 | Inst. ownership | 83.05% |
| P/E (ttm) | 21.59 | Insider ownership | 0.12% |
| Forward P/E | 18.49 | Short float | 3.53% |
| PEG (trailing) | 0.82 | Avg volume | 14,250,382 |
| P/S | 4.57 | Employees | 52,000 |
| P/B | 7.21 | Analyst rec (1=buy..5=sell) | 2.6 |

## 8. Analyst Actions
| Date | Action | Firm | Rating change |
|---|---|---|---|
| 2026-09-10 | init | Piper Sandler | — → Neutral |
| 2026-09-09 | main | RBC Capital | Sector Perform → Sector Perform |
| 2026-09-09 | main | Rosenblatt | Buy → Buy |
...
## 9. Conclusion
QCOM: Moderate momentum / mixed fundamentals / reasonable value / elevated risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.
