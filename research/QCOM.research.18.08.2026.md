...
Signed file: `QCOM.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $160.19 (2026-08-18, ~15-min delayed) |
| Market cap | $168.24B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +3.62%; price -4.37% vs SMA200. |
| Fresh setup quality | Poor / broken | -35.95% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 15.70, EV/Sales 4.02. |
| Risk level | Elevated | Beta 1.66, ATR 4.6% of price, short float 3.69%. |
...
|---|---|---|
| SCHD’s 27% Year Is Embarrassing Every Growth ETF in Your Portfolio | 24/7 Wall St. | 2026-08-18 |
| ARM Stock: The $2 Billion AI Signal Investors Shouldn’t Ignore | 24/7 Wall St. | 2026-08-18 |
| The Gap Between MRVL Stock And Its Own Numbers | Trefis | 2026-08-18 |
| Where Will Qualcomm Stock Be in 5 Years? | Motley Fool | 2026-08-18 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $160.19; 52w high $250.10 (-35.95%); 52w low $123.61 (+29.59%) |
| Trend | -4.37% vs SMA200, -11.57% vs SMA50, -1.19% vs SMA20 |
| Momentum | RSI(14) 42.8 (neutral) |
| Volatility | ATR(14) 7.42 (~4.6% of price); beta 1.66 |
| Setup perspective | -35.95% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 18.29, forward P/E 15.70, P/S 3.82, P/B 6.12 | EV/Sales 4.02, EV/EBITDA 14.78 |
| Growth expectations | Earnings growth -23.00%, EPS q/q -24.90% | Analyst mean target $193.10 (30 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 83.48% |
...
- **Volatility risk:** Beta 1.66, ATR 4.6% of price, short float 3.69%. Size positions accordingly.
...
|---|---|---|---|
| Price | $160.19 | EV/Sales | 4.02 |
| Market cap | $168.24B | EV/EBITDA | 14.78 |
| Beta | 1.66 | Gross margin | 54.23% |
| RSI(14) | 42.8 | Operating margin | 18.53% |
| ATR(14) | 7.42 | Profit margin | 21.01% |
| SMA20 dist | -1.19% | ROA | 11.61% |
| SMA50 dist | -11.57% | ROE | 33.75% |
| SMA200 dist | -4.37% | Revenue (ttm) | $44.07B |
| 52W high | $250.10 | Revenue growth y/y | -4.00% |
| 52W low | $123.61 | Inst. ownership | 83.48% |
| P/E (ttm) | 18.29 | Insider ownership | 0.12% |
| Forward P/E | 15.70 | Short float | 3.69% |
| PEG (trailing) | 0.71 | Avg volume | 17,534,016 |
| P/S | 3.82 | Employees | 52,000 |
| P/B | 6.12 | Analyst rec (1=buy..5=sell) | 2.6 |
