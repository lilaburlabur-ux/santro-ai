...
Signed file: `QCOM.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $161.91 (2026-08-19, ~15-min delayed) |
| Market cap | $170.04B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +4.04%; price -3.30% vs SMA200. |
| Fresh setup quality | Poor / broken | -35.26% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 15.87, EV/Sales 3.98. |
| Risk level | Elevated | Beta 1.66, ATR 4.5% of price, short float 3.69%. |
...
| INTC's Client Computing Business Gains Momentum: Is More Growth Ahead? | Zacks | 2026-08-19 |
| Dividend Stocks Lost the Yield War But May Still Beat the Market | 24/7 Wall St. | 2026-08-19 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $161.91; 52w high $250.10 (-35.26%); 52w low $123.61 (+30.98%) |
| Trend | -3.30% vs SMA200, -10.07% vs SMA50, +0.29% vs SMA20 |
| Momentum | RSI(14) 44.6 (neutral) |
| Volatility | ATR(14) 7.34 (~4.5% of price); beta 1.66 |
| Setup perspective | -35.26% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 18.50, forward P/E 15.87, P/S 3.86, P/B 6.19 | EV/Sales 3.98, EV/EBITDA 14.60 |
...
- **Volatility risk:** Beta 1.66, ATR 4.5% of price, short float 3.69%. Size positions accordingly.
...
|---|---|---|---|
| Price | $161.91 | EV/Sales | 3.98 |
| Market cap | $170.04B | EV/EBITDA | 14.60 |
| Beta | 1.66 | Gross margin | 54.23% |
| RSI(14) | 44.6 | Operating margin | 18.53% |
| ATR(14) | 7.34 | Profit margin | 21.01% |
| SMA20 dist | +0.29% | ROA | 11.61% |
| SMA50 dist | -10.07% | ROE | 33.75% |
| SMA200 dist | -3.30% | Revenue (ttm) | $44.07B |
| 52W high | $250.10 | Revenue growth y/y | -4.00% |
| 52W low | $123.61 | Inst. ownership | 83.49% |
| P/E (ttm) | 18.50 | Insider ownership | 0.12% |
| Forward P/E | 15.87 | Short float | 3.69% |
| PEG (trailing) | 0.70 | Avg volume | 17,396,385 |
| P/S | 3.86 | Employees | 52,000 |
| P/B | 6.19 | Analyst rec (1=buy..5=sell) | 2.6 |
