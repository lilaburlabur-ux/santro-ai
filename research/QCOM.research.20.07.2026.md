...
Signed file: `QCOM.research.20.07.2026`

| Field | Value |
|---|---|
| Current price | $170.32 (2026-07-20, ~15-min delayed) |
| Market cap | $179.52B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +13.96%; price +1.49% vs SMA200. |
| Fresh setup quality | Poor / broken | -31.90% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 22.31%, revenue growth -3.50%. |
| Value attractiveness | Reasonable | Forward P/E 15.48, EV/Sales 4.19. |
| Risk level | High | Beta 1.64, ATR 6.8% of price, short float 4.27%. |
...
| Tesla Is Still Down 17% in 2026. Can Wednesday’s Earnings Event Get TSLA Stock Back on Track? | 24/7 Wall St. | 2026-07-20 |
| ARM, QCOM, KLAC Stocks Rise Despite Price Target Cuts By UBS Amid Chip Stocks’ Pullback | Stocktwits | 2026-07-20 |
| The Real Engine Driving Qualcomm Stock Isn't A Smartphone | Trefis | 2026-07-20 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $170.32; 52w high $250.10 (-31.90%); 52w low $123.61 (+37.78%) |
| Trend | +1.49% vs SMA200, -17.47% vs SMA50, -8.88% vs SMA20 |
| Momentum | RSI(14) 37.4 (neutral) |
| Volatility | ATR(14) 11.52 (~6.8% of price); beta 1.64 |
| Setup perspective | -31.90% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 18.33, forward P/E 15.48, P/S 4.04, P/B 6.61 | EV/Sales 4.19, EV/EBITDA 14.35 |
| Growth expectations | Earnings growth 173.00%, EPS q/q 162.10% | Analyst mean target $222.73 (30 analysts) |
...
- **Volatility risk:** Beta 1.64, ATR 6.8% of price, short float 4.27%. Size positions accordingly.
...
|---|---|---|---|
| Price | $170.32 | EV/Sales | 4.19 |
| Market cap | $179.52B | EV/EBITDA | 14.35 |
| Beta | 1.64 | Gross margin | 54.80% |
| RSI(14) | 37.4 | Operating margin | 22.06% |
| ATR(14) | 11.52 | Profit margin | 22.31% |
| SMA20 dist | -8.88% | ROA | 12.69% |
| SMA50 dist | -17.47% | ROE | 36.08% |
| SMA200 dist | +1.49% | Revenue (ttm) | $44.49B |
| 52W high | $250.10 | Revenue growth y/y | -3.50% |
| 52W low | $123.61 | Inst. ownership | 85.65% |
| P/E (ttm) | 18.33 | Insider ownership | 0.12% |
| Forward P/E | 15.48 | Short float | 4.27% |
| PEG (trailing) | 0.54 | Avg volume | 23,787,967 |
| P/S | 4.04 | Employees | 52,000 |
| P/B | 6.61 | Analyst rec (1=buy..5=sell) | 2.6 |
