...
Signed file: `QCOM.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $160.74 (2026-08-20, ~15-min delayed) |
| Market cap | $168.81B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +5.04%; price -3.95% vs SMA200. |
| Fresh setup quality | Poor / broken | -35.73% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 15.76, EV/Sales 4.02. |
...
| We Told You to Forget SCHD. It Just Beat the S&P by 12 Points, Its Biggest Win Ever | 24/7 Wall St. | 2026-08-20 |
| NVIDIA Looks Expensive Until You Ask What Has To Ship | Trefis | 2026-08-20 |
| Micron's Biggest Risk Is Written In Its Construction Budget | Trefis | 2026-08-20 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $160.74; 52w high $250.10 (-35.73%); 52w low $123.61 (+30.03%) |
| Trend | -3.95% vs SMA200, -10.27% vs SMA50, -0.11% vs SMA20 |
| Momentum | RSI(14) 43.6 (neutral) |
| Volatility | ATR(14) 7.18 (~4.5% of price); beta 1.66 |
| Setup perspective | -35.73% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 18.39, forward P/E 15.76, P/S 3.83, P/B 6.14 | EV/Sales 4.02, EV/EBITDA 14.75 |
...
|---|---|---|---|
| Price | $160.74 | EV/Sales | 4.02 |
| Market cap | $168.81B | EV/EBITDA | 14.75 |
| Beta | 1.66 | Gross margin | 54.23% |
| RSI(14) | 43.6 | Operating margin | 18.53% |
| ATR(14) | 7.18 | Profit margin | 21.01% |
| SMA20 dist | -0.11% | ROA | 11.61% |
| SMA50 dist | -10.27% | ROE | 33.75% |
| SMA200 dist | -3.95% | Revenue (ttm) | $44.07B |
