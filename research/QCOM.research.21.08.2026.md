...
Signed file: `QCOM.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $160.75 (2026-08-21, ~15-min delayed) |
| Market cap | $168.83B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +5.60%; price -3.90% vs SMA200. |
| Fresh setup quality | Poor / broken | -35.72% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 15.76, EV/Sales 3.99. |
| Risk level | Elevated | Beta 1.66, ATR 4.4% of price, short float 3.69%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $160.75; 52w high $250.10 (-35.72%); 52w low $123.61 (+30.04%) |
| Trend | -3.90% vs SMA200, -9.96% vs SMA50, +0.09% vs SMA20 |
| Momentum | RSI(14) 43.6 (neutral) |
| Volatility | ATR(14) 7.01 (~4.4% of price); beta 1.66 |
| Setup perspective | -35.72% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 18.39, forward P/E 15.76, P/S 3.83, P/B 6.14 | EV/Sales 3.99, EV/EBITDA 14.65 |
...
- **Volatility risk:** Beta 1.66, ATR 4.4% of price, short float 3.69%. Size positions accordingly.
...
|---|---|---|---|
| Price | $160.75 | EV/Sales | 3.99 |
| Market cap | $168.83B | EV/EBITDA | 14.65 |
| Beta | 1.66 | Gross margin | 54.23% |
| RSI(14) | 43.6 | Operating margin | 18.53% |
| ATR(14) | 7.01 | Profit margin | 21.01% |
| SMA20 dist | +0.09% | ROA | 11.61% |
| SMA50 dist | -9.96% | ROE | 33.75% |
| SMA200 dist | -3.90% | Revenue (ttm) | $44.07B |
...
| PEG (trailing) | 0.71 | Avg volume | 16,903,038 |
