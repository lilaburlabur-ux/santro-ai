...
Signed file: `QCOM.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $194.23 (2026-09-21, ~15-min delayed) |
| Market cap | $207.45B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +17.93%; price +16.22% vs SMA200. |
| Fresh setup quality | Moderate / wait | -21.92% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 19.03, EV/Sales 4.39. |
| Risk level | Elevated | Beta 1.68, ATR 4.6% of price, short float 3.53%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $194.23; 52w high $248.74 (-21.92%); 52w low $122.94 (+57.98%) |
| Trend | +16.22% vs SMA200, +15.65% vs SMA50, +11.89% vs SMA20 |
| Momentum | RSI(14) 65.9 (neutral) |
| Volatility | ATR(14) 8.92 (~4.6% of price); beta 1.68 |
| Setup perspective | -21.92% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 22.22, forward P/E 19.03, P/S 4.71, P/B 7.42 | EV/Sales 4.39, EV/EBITDA 16.14 |
...
- **Volatility risk:** Beta 1.68, ATR 4.6% of price, short float 3.53%. Size positions accordingly.
...
|---|---|---|---|
| Price | $194.23 | EV/Sales | 4.39 |
| Market cap | $207.45B | EV/EBITDA | 16.14 |
| Beta | 1.68 | Gross margin | 54.23% |
| RSI(14) | 65.9 | Operating margin | 18.53% |
| ATR(14) | 8.92 | Profit margin | 21.01% |
| SMA20 dist | +11.89% | ROA | 11.61% |
| SMA50 dist | +15.65% | ROE | 33.75% |
| SMA200 dist | +16.22% | Revenue (ttm) | $44.07B |
