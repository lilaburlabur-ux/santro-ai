...
Signed file: `QCOM.research.23.07.2026`

| Field | Value |
|---|---|
| Current price | $171.11 (2026-07-23, ~15-min delayed) |
| Market cap | $180.35B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +10.59%; price +1.89% vs SMA200. |
| Fresh setup quality | Poor / broken | -31.58% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 22.31%, revenue growth -3.50%. |
| Value attractiveness | Reasonable | Forward P/E 15.59, EV/Sales 4.28. |
| Risk level | High | Beta 1.64, ATR 6.2% of price, short float 4.27%. |
...
|---|---|---|
| Marvell Technology Stock And The Forecast It Kept Outgrowing | Trefis | 2026-07-23 |
| Qualcomm (QCOM) Stock Gets Fair Value Boost After Investor Day Reset | Simply Wall St. | 2026-07-23 |
| Which Stocks Are Getting Hit Hardest on the Nasdaq Today? | The Wall Street Journal | 2026-07-23 |
| Qualcomm deepens ties with major Apple rival | TheStreet | 2026-07-23 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $171.11; 52w high $250.10 (-31.58%); 52w low $123.61 (+38.42%) |
| Trend | +1.89% vs SMA200, -15.97% vs SMA50, -5.86% vs SMA20 |
| Momentum | RSI(14) 39.1 (neutral) |
| Volatility | ATR(14) 10.61 (~6.2% of price); beta 1.64 |
| Setup perspective | -31.58% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 18.38, forward P/E 15.59, P/S 4.05, P/B 6.64 | EV/Sales 4.28, EV/EBITDA 14.66 |
...
| Invesco Ltd. | 35,245,336 | 3.34% | 2026-03-31 |
...
- **Volatility risk:** Beta 1.64, ATR 6.2% of price, short float 4.27%. Size positions accordingly.
...
|---|---|---|---|
| Price | $171.11 | EV/Sales | 4.28 |
| Market cap | $180.35B | EV/EBITDA | 14.66 |
| Beta | 1.64 | Gross margin | 54.80% |
| RSI(14) | 39.1 | Operating margin | 22.06% |
| ATR(14) | 10.61 | Profit margin | 22.31% |
| SMA20 dist | -5.86% | ROA | 12.69% |
| SMA50 dist | -15.97% | ROE | 36.08% |
| SMA200 dist | +1.89% | Revenue (ttm) | $44.49B |
| 52W high | $250.10 | Revenue growth y/y | -3.50% |
| 52W low | $123.61 | Inst. ownership | 86.51% |
| P/E (ttm) | 18.38 | Insider ownership | 0.12% |
| Forward P/E | 15.59 | Short float | 4.27% |
| PEG (trailing) | 0.55 | Avg volume | 23,774,796 |
| P/S | 4.05 | Employees | 52,000 |
| P/B | 6.64 | Analyst rec (1=buy..5=sell) | 2.6 |

## 8. Analyst Actions
| Date | Action | Firm | Rating change |
|---|---|---|---|
| 2026-07-13 | main | TD Cowen | Buy → Buy |
| 2026-06-29 | main | Mizuho | Neutral → Neutral |
