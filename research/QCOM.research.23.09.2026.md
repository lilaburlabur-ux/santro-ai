...
Signed file: `QCOM.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $197.24 (2026-09-23, ~15-min delayed) |
| Market cap | $210.66B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $197.24; 52w high $248.74 (-20.71%); 52w low $122.94 (+60.43%) |
| Trend | +17.83% vs SMA200, +16.95% vs SMA50, +11.12% vs SMA20 |
| Momentum | RSI(14) 66.8 (neutral) |
| Volatility | ATR(14) 8.65 (~4.4% of price); beta 1.68 |
| Setup perspective | -20.71% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | +11.12% | ROA | 11.61% |
| SMA50 dist | +16.95% | ROE | 33.75% |
| SMA200 dist | +17.83% | Revenue (ttm) | $44.07B |
| 52W high | $248.74 | Revenue growth y/y | -4.00% |
| 52W low | $122.94 | Inst. ownership | 83.08% |
| P/E (ttm) | 22.57 | Insider ownership | 0.12% |
| Forward P/E | 19.33 | Short float | 3.53% |
| PEG (trailing) | 0.88 | Avg volume | 14,146,558 |
| P/S | 4.78 | Employees | 52,000 |
| P/B | 7.54 | Analyst rec (1=buy..5=sell) | 2.6 |
