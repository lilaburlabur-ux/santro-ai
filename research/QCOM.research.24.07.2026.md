...
Signed file: `QCOM.research.24.07.2026`

| Field | Value |
|---|---|
| Current price | $166.97 (2026-07-24, ~15-min delayed) |
| Market cap | $175.99B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +6.64%; price -0.58% vs SMA200. |
| Fresh setup quality | Poor / broken | -33.24% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 22.31%, revenue growth -3.50%. |
| Value attractiveness | Reasonable | Forward P/E 15.22, EV/Sales 4.18. |
| Risk level | High | Beta 1.64, ATR 6.1% of price, short float 4.27%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $166.97; 52w high $250.10 (-33.24%); 52w low $123.61 (+35.07%) |
| Trend | -0.58% vs SMA200, -17.66% vs SMA50, -7.17% vs SMA20 |
| Momentum | RSI(14) 36.9 (neutral) |
| Volatility | ATR(14) 10.23 (~6.1% of price); beta 1.64 |
| Setup perspective | -33.24% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 17.93, forward P/E 15.22, P/S 3.96, P/B 6.48 | EV/Sales 4.18, EV/EBITDA 14.29 |
...
- **Volatility risk:** Beta 1.64, ATR 6.1% of price, short float 4.27%. Size positions accordingly.
...
|---|---|---|---|
| Price | $166.97 | EV/Sales | 4.18 |
| Market cap | $175.99B | EV/EBITDA | 14.29 |
| Beta | 1.64 | Gross margin | 54.80% |
| RSI(14) | 36.9 | Operating margin | 22.06% |
| ATR(14) | 10.23 | Profit margin | 22.31% |
| SMA20 dist | -7.17% | ROA | 12.69% |
| SMA50 dist | -17.66% | ROE | 36.08% |
| SMA200 dist | -0.58% | Revenue (ttm) | $44.49B |
| 52W high | $250.10 | Revenue growth y/y | -3.50% |
| 52W low | $123.61 | Inst. ownership | 86.54% |
| P/E (ttm) | 17.93 | Insider ownership | 0.12% |
| Forward P/E | 15.22 | Short float | 4.27% |
| PEG (trailing) | 0.54 | Avg volume | 23,469,437 |
| P/S | 3.96 | Employees | 52,000 |
| P/B | 6.48 | Analyst rec (1=buy..5=sell) | 2.6 |
