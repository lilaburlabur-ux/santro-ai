...
Signed file: `QCOM.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $158.53 (2026-08-24, ~15-min delayed) |
| Market cap | $166.49B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +5.02%; price -5.19% vs SMA200. |
| Fresh setup quality | Poor / broken | -36.61% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 15.54, EV/Sales 3.99. |
| Risk level | Elevated | Beta 1.66, ATR 4.3% of price, short float 3.69%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $158.53; 52w high $250.10 (-36.61%); 52w low $123.61 (+28.25%) |
| Trend | -5.19% vs SMA200, -10.76% vs SMA50, -0.94% vs SMA20 |
| Momentum | RSI(14) 41.5 (neutral) |
| Volatility | ATR(14) 6.83 (~4.3% of price); beta 1.66 |
| Setup perspective | -36.61% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 18.14, forward P/E 15.54, P/S 3.78, P/B 6.06 | EV/Sales 3.99, EV/EBITDA 14.65 |
...
- **Volatility risk:** Beta 1.66, ATR 4.3% of price, short float 3.69%. Size positions accordingly.
...
|---|---|---|---|
| Price | $158.53 | EV/Sales | 3.99 |
| Market cap | $166.49B | EV/EBITDA | 14.65 |
| Beta | 1.66 | Gross margin | 54.23% |
| RSI(14) | 41.5 | Operating margin | 18.53% |
| ATR(14) | 6.83 | Profit margin | 21.01% |
| SMA20 dist | -0.94% | ROA | 11.61% |
| SMA50 dist | -10.76% | ROE | 33.75% |
| SMA200 dist | -5.19% | Revenue (ttm) | $44.07B |
| 52W high | $250.10 | Revenue growth y/y | -4.00% |
| 52W low | $123.61 | Inst. ownership | 83.39% |
| P/E (ttm) | 18.14 | Insider ownership | 0.12% |
| Forward P/E | 15.54 | Short float | 3.69% |
| PEG (trailing) | 0.71 | Avg volume | 16,550,582 |
| P/S | 3.78 | Employees | 52,000 |
| P/B | 6.06 | Analyst rec (1=buy..5=sell) | 2.6 |
