...
Signed file: `QCOM.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $194.26 (2026-09-24, ~15-min delayed) |
| Market cap | $207.48B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +16.97%; price +15.98% vs SMA200. |
| Fresh setup quality | Moderate / wait | -21.90% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 19.04, EV/Sales 4.79. |
| Risk level | Elevated | Beta 1.68, ATR 4.3% of price, short float 3.53%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $194.26; 52w high $248.74 (-21.90%); 52w low $122.94 (+58.01%) |
| Trend | +15.98% vs SMA200, +14.95% vs SMA50, +8.48% vs SMA20 |
| Momentum | RSI(14) 63.5 (neutral) |
| Volatility | ATR(14) 8.42 (~4.3% of price); beta 1.68 |
| Setup perspective | -21.90% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 22.18, forward P/E 19.04, P/S 4.71, P/B 7.42 | EV/Sales 4.79, EV/EBITDA 17.58 |
...
- **Volatility risk:** Beta 1.68, ATR 4.3% of price, short float 3.53%. Size positions accordingly.
...
|---|---|---|---|
| Price | $194.26 | EV/Sales | 4.79 |
| Market cap | $207.48B | EV/EBITDA | 17.58 |
| Beta | 1.68 | Gross margin | 54.23% |
| RSI(14) | 63.5 | Operating margin | 18.53% |
| ATR(14) | 8.42 | Profit margin | 21.01% |
| SMA20 dist | +8.48% | ROA | 11.61% |
| SMA50 dist | +14.95% | ROE | 33.75% |
| SMA200 dist | +15.98% | Revenue (ttm) | $44.07B |
| 52W high | $248.74 | Revenue growth y/y | -4.00% |
| 52W low | $122.94 | Inst. ownership | 83.09% |
| P/E (ttm) | 22.18 | Insider ownership | 0.12% |
| Forward P/E | 19.04 | Short float | 3.53% |
| PEG (trailing) | 0.88 | Avg volume | 13,896,223 |
