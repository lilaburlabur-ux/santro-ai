...
Signed file: `QCOM.research.27.06.2026`

| Field | Value |
|---|---|
| Current price | $189.39 (2026-06-27, ~15-min delayed) |
| Market cap | $199.62B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +24.02%; price +13.76% vs SMA200. |
| Fresh setup quality | Moderate / wait | -24.27% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 22.31%, revenue growth -3.50%. |
| Value attractiveness | Reasonable | Forward P/E 17.26, EV/Sales 4.61. |
| Risk level | High | Beta 1.60, ATR 9.3% of price, short float 4.74%. |
...
| Qualcomm Just Nearly Doubled Its Most Important Growth Target, Confirming Its Place as a Key AI Stock | Motley Fool | 2026-06-27 |
| What If The Real Power Behind Marvell Stock Isn't Just Growth? | Trefis | 2026-06-26 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $189.39; 52w high $250.10 (-24.27%); 52w low $123.61 (+53.21%) |
| Trend | +13.76% vs SMA200, -4.46% vs SMA50, -12.86% vs SMA20 |
| Momentum | RSI(14) 42.6 (neutral) |
| Volatility | ATR(14) 17.52 (~9.3% of price); beta 1.60 |
| Setup perspective | -24.27% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.36, forward P/E 17.26, P/S 4.49, P/B 7.35 | EV/Sales 4.61, EV/EBITDA 15.78 |
...
- **Volatility risk:** Beta 1.60, ATR 9.3% of price, short float 4.74%. Size positions accordingly.
...
|---|---|---|---|
| Price | $189.39 | EV/Sales | 4.61 |
| Market cap | $199.62B | EV/EBITDA | 15.78 |
| Beta | 1.60 | Gross margin | 54.80% |
| RSI(14) | 42.6 | Operating margin | 22.06% |
| ATR(14) | 17.52 | Profit margin | 22.31% |
| SMA20 dist | -12.86% | ROA | 12.69% |
| SMA50 dist | -4.46% | ROE | 36.08% |
| SMA200 dist | +13.76% | Revenue (ttm) | $44.49B |
| 52W high | $250.10 | Revenue growth y/y | -3.50% |
| 52W low | $123.61 | Inst. ownership | 84.89% |
| P/E (ttm) | 20.36 | Insider ownership | 0.13% |
| Forward P/E | 17.26 | Short float | 4.74% |
| PEG (trailing) | 0.60 | Avg volume | 22,001,022 |
| P/S | 4.49 | Employees | 52,000 |
| P/B | 7.35 | Analyst rec (1=buy..5=sell) | 2.6 |
