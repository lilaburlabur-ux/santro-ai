...
Signed file: `QCOM.research.30.07.2026`

| Field | Value |
|---|---|
| Current price | $151.60 (2026-07-30, ~15-min delayed) |
| Market cap | $159.79B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y -4.49%; price -9.72% vs SMA200. |
| Fresh setup quality | Poor / broken | -39.38% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 22.31%, revenue growth -3.50%. |
| Value attractiveness | Reasonable | Forward P/E 14.56, EV/Sales 3.81. |
| Risk level | High | Beta 1.64, ATR 6.4% of price, short float 3.84%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $151.60; 52w high $250.10 (-39.38%); 52w low $123.61 (+22.64%) |
| Trend | -9.72% vs SMA200, -23.93% vs SMA50, -13.19% vs SMA20 |
| Momentum | RSI(14) 30.6 (neutral) |
| Volatility | ATR(14) 9.75 (~6.4% of price); beta 1.64 |
| Setup perspective | -39.38% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 17.33, forward P/E 14.56, P/S 3.59, P/B 5.89 | EV/Sales 3.81, EV/EBITDA 13.04 |
...
- **Volatility risk:** Beta 1.64, ATR 6.4% of price, short float 3.84%. Size positions accordingly.
...
|---|---|---|---|
| Price | $151.60 | EV/Sales | 3.81 |
| Market cap | $159.79B | EV/EBITDA | 13.04 |
| Beta | 1.64 | Gross margin | 54.80% |
| RSI(14) | 30.6 | Operating margin | 22.06% |
| ATR(14) | 9.75 | Profit margin | 22.31% |
| SMA20 dist | -13.19% | ROA | 12.69% |
| SMA50 dist | -23.93% | ROE | 36.08% |
| SMA200 dist | -9.72% | Revenue (ttm) | $44.49B |
| 52W high | $250.10 | Revenue growth y/y | -3.50% |
| 52W low | $123.61 | Inst. ownership | 84.34% |
| P/E (ttm) | 17.33 | Insider ownership | 0.12% |
| Forward P/E | 14.56 | Short float | 3.84% |
| PEG (trailing) | 0.49 | Avg volume | 21,735,872 |
| P/S | 3.59 | Employees | 52,000 |
| P/B | 5.89 | Analyst rec (1=buy..5=sell) | 2.6 |
