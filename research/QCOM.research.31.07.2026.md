...
Signed file: `QCOM.research.31.07.2026`

| Field | Value |
|---|---|
| Current price | $147.61 (2026-07-31, ~15-min delayed) |
| Market cap | $154.99B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-12.07%) with negative half-year (-2.05%). |
| Fresh setup quality | Poor / broken | -40.98% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 21.01%, revenue growth -4.00%. |
| Value attractiveness | Reasonable | Forward P/E 14.34, EV/Sales 3.77. |
| Risk level | High | Beta 1.64, ATR 6.5% of price, short float 3.84%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $147.61; 52w high $250.10 (-40.98%); 52w low $123.61 (+19.41%) |
| Trend | -12.07% vs SMA200, -25.58% vs SMA50, -14.78% vs SMA20 |
| Momentum | RSI(14) 28.9 (oversold) |
| Volatility | ATR(14) 9.60 (~6.5% of price); beta 1.64 |
| Setup perspective | -40.98% from 52w high — base needs to rebuild. |
...
|---|---|---|---|
| Blackrock Inc. | 106,015,881 | 10.10% | 2026-03-31 |
| Vanguard Capital Management LLC | 69,341,312 | 6.60% | 2026-03-31 |
| State Street Corporation | 52,091,726 | 4.96% | 2026-03-31 |
| Invesco Ltd. | 35,245,336 | 3.36% | 2026-03-31 |
| Vanguard Portfolio Management LLC | 34,192,863 | 3.26% | 2026-03-31 |
| Charles Schwab Investment Management, Inc. | 30,864,702 | 2.94% | 2026-03-31 |
| Geode Capital Management, LLC | 29,734,061 | 2.83% | 2026-03-31 |
| Morgan Stanley | 19,991,313 | 1.90% | 2026-03-31 |
| Van Eck Associates Corporation | 14,022,899 | 1.34% | 2026-03-31 |
| UBS AM, a distinct business unit of UBS ASSET MANAGEMENT AMERICAS LLC | 12,113,406 | 1.15% | 2026-03-31 |

## 6. Risk Review and Setup Plan
- **Volatility risk:** Beta 1.64, ATR 6.5% of price, short float 3.84%. Size positions accordingly.
...
|---|---|---|---|
| Price | $147.61 | EV/Sales | 3.77 |
| Market cap | $154.99B | EV/EBITDA | 13.85 |
| Beta | 1.64 | Gross margin | 54.23% |
| RSI(14) | 28.9 | Operating margin | 18.53% |
| ATR(14) | 9.60 | Profit margin | 21.01% |
| SMA20 dist | -14.78% | ROA | 11.61% |
| SMA50 dist | -25.58% | ROE | 33.75% |
...
|---|---|---|---|
| 2026-07-30 | main | Benchmark | Buy → Buy |
| 2026-07-30 | main | UBS | Neutral → Neutral |
| 2026-07-30 | main | Susquehanna | Neutral → Neutral |
| 2026-07-30 | main | RBC Capital | Sector Perform → Sector Perform |
...
| 2026-07-30 | main | Evercore ISI Group | In-Line → In-Line |

## 9. Conclusion
QCOM: Low momentum / mixed fundamentals / reasonable value / high risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.
