...
Signed file: `SYNA.research.03.08.2026`

| Field | Value |
|---|---|
| Current price | $105.72 (2026-08-03, ~15-min delayed) |
| Market cap | $4.13B |
...
|---|---|---|
| Technical momentum | High | 1Y +68.61%; price +14.44% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 20.05, EV/Sales 3.94. |
| Risk level | High | Beta 1.96, ATR 6.8% of price, short float 14.96%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $105.72; 52w high $147.57 (-28.36%); 52w low $58.52 (+80.66%) |
| Trend | +14.44% vs SMA200, -16.78% vs SMA50, -9.22% vs SMA20 |
| Momentum | RSI(14) 39.2 (neutral) |
| Volatility | ATR(14) 7.24 (~6.8% of price); beta 1.96 |
...
| Valuation | P/E —, forward P/E 20.05, P/S 3.52, P/B 3.01 | EV/Sales 3.94, EV/EBITDA 52.46 |
...
- **Valuation risk:** Forward P/E 20.05, EV/Sales 3.94. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.96, ATR 6.8% of price, short float 14.96%. Size positions accordingly.
...
|---|---|---|---|
| Price | $105.72 | EV/Sales | 3.94 |
| Market cap | $4.13B | EV/EBITDA | 52.46 |
| Beta | 1.96 | Gross margin | 43.61% |
| RSI(14) | 39.2 | Operating margin | -4.32% |
| ATR(14) | 7.24 | Profit margin | -4.10% |
| SMA20 dist | -9.22% | ROA | -1.75% |
| SMA50 dist | -16.78% | ROE | -3.50% |
| SMA200 dist | +14.44% | Revenue (ttm) | $1.17B |
| 52W high | $147.57 | Revenue growth y/y | 10.40% |
| 52W low | $58.52 | Inst. ownership | 111.15% |
| P/E (ttm) | — | Insider ownership | 1.95% |
| Forward P/E | 20.05 | Short float | 14.96% |
| PEG (trailing) | — | Avg volume | 1,088,724 |
| P/S | 3.52 | Employees | 1,700 |
| P/B | 3.01 | Analyst rec (1=buy..5=sell) | 2.7 |
