...
Signed file: `SYNA.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $97.68 (2026-09-03, ~15-min delayed) |
| Market cap | $3.82B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +43.99%; price +1.73% vs SMA200. |
| Fresh setup quality | Poor / broken | -33.81% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-41.00%). |
| Value attractiveness | Reasonable | Forward P/E 14.85, EV/Sales 3.55. |
| Risk level | High | Beta 1.96, ATR 4.4% of price, short float 11.83%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $97.68; 52w high $147.57 (-33.81%); 52w low $58.52 (+66.92%) |
| Trend | +1.73% vs SMA200, -11.44% vs SMA50, -3.21% vs SMA20 |
| Momentum | RSI(14) 42.5 (neutral) |
| Volatility | ATR(14) 4.34 (~4.4% of price); beta 1.96 |
| Setup perspective | -33.81% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 14.85, P/S 3.19, P/B 4.11 | EV/Sales 3.55, EV/EBITDA 45.84 |
...
- **Volatility risk:** Beta 1.96, ATR 4.4% of price, short float 11.83%. Size positions accordingly.
...
|---|---|---|---|
| Price | $97.68 | EV/Sales | 3.55 |
| Market cap | $3.82B | EV/EBITDA | 45.84 |
| Beta | 1.96 | Gross margin | 44.72% |
| RSI(14) | 42.5 | Operating margin | -2.79% |
| ATR(14) | 4.34 | Profit margin | -41.00% |
| SMA20 dist | -3.21% | ROA | -1.52% |
| SMA50 dist | -11.44% | ROE | -42.23% |
| SMA200 dist | +1.73% | Revenue (ttm) | $1.20B |
| 52W high | $147.57 | Revenue growth y/y | 8.90% |
| 52W low | $58.52 | Inst. ownership | 108.23% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 14.85 | Short float | 11.83% |
| PEG (trailing) | — | Avg volume | 973,546 |
| P/S | 3.19 | Employees | 1,700 |
| P/B | 4.11 | Analyst rec (1=buy..5=sell) | — |
