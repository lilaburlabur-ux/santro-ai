...
Signed file: `SYNA.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $100.12 (2026-08-05, ~15-min delayed) |
| Market cap | $3.91B |
...
|---|---|---|
| Technical momentum | High | 1Y +61.22%; price +7.99% vs SMA200. |
| Fresh setup quality | Poor / broken | -32.15% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-4.10%). |
| Value attractiveness | Reasonable | Forward P/E 18.99, EV/Sales 3.89. |
| Risk level | High | Beta 1.96, ATR 7.1% of price, short float 14.96%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $100.12; 52w high $147.57 (-32.15%); 52w low $58.52 (+71.09%) |
| Trend | +7.99% vs SMA200, -20.31% vs SMA50, -12.68% vs SMA20 |
| Momentum | RSI(14) 35.6 (neutral) |
| Volatility | ATR(14) 7.13 (~7.1% of price); beta 1.96 |
| Setup perspective | -32.15% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 18.99, P/S 3.34, P/B 2.85 | EV/Sales 3.89, EV/EBITDA 51.76 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $143.67 (9 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 111.91% |
...
- **Volatility risk:** Beta 1.96, ATR 7.1% of price, short float 14.96%. Size positions accordingly.
...
|---|---|---|---|
| Price | $100.12 | EV/Sales | 3.89 |
| Market cap | $3.91B | EV/EBITDA | 51.76 |
| Beta | 1.96 | Gross margin | 43.61% |
| RSI(14) | 35.6 | Operating margin | -4.32% |
| ATR(14) | 7.13 | Profit margin | -4.10% |
| SMA20 dist | -12.68% | ROA | -1.75% |
| SMA50 dist | -20.31% | ROE | -3.50% |
| SMA200 dist | +7.99% | Revenue (ttm) | $1.17B |
| 52W high | $147.57 | Revenue growth y/y | 10.40% |
| 52W low | $58.52 | Inst. ownership | 111.91% |
| P/E (ttm) | — | Insider ownership | 1.95% |
| Forward P/E | 18.99 | Short float | 14.96% |
| PEG (trailing) | — | Avg volume | 1,075,655 |
| P/S | 3.34 | Employees | 1,700 |
| P/B | 2.85 | Analyst rec (1=buy..5=sell) | 2.7 |
