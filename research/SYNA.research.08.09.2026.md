...
Signed file: `SYNA.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $94.72 (2026-09-08, ~15-min delayed) |
| Market cap | $3.70B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +35.51%; price -1.73% vs SMA200. |
| Fresh setup quality | Poor / broken | -35.81% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-41.00%). |
| Value attractiveness | Reasonable | Forward P/E 14.40, EV/Sales 3.60. |
| Risk level | High | Beta 1.94, ATR 4.6% of price, short float 11.83%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $94.72; 52w high $147.57 (-35.81%); 52w low $58.52 (+61.86%) |
| Trend | -1.73% vs SMA200, -13.29% vs SMA50, -5.33% vs SMA20 |
| Momentum | RSI(14) 39.3 (neutral) |
| Volatility | ATR(14) 4.33 (~4.6% of price); beta 1.94 |
| Setup perspective | -35.81% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 14.40, P/S 3.09, P/B 3.98 | EV/Sales 3.60, EV/EBITDA 46.40 |
...
- **Volatility risk:** Beta 1.94, ATR 4.6% of price, short float 11.83%. Size positions accordingly.
...
|---|---|---|---|
| Price | $94.72 | EV/Sales | 3.60 |
| Market cap | $3.70B | EV/EBITDA | 46.40 |
| Beta | 1.94 | Gross margin | 44.72% |
| RSI(14) | 39.3 | Operating margin | -2.79% |
| ATR(14) | 4.33 | Profit margin | -41.00% |
| SMA20 dist | -5.33% | ROA | -1.52% |
| SMA50 dist | -13.29% | ROE | -42.23% |
...
| Forward P/E | 14.40 | Short float | 11.83% |
| PEG (trailing) | — | Avg volume | 953,959 |
| P/S | 3.09 | Employees | 1,700 |
| P/B | 3.98 | Analyst rec (1=buy..5=sell) | — |
