...
Signed file: `SYNA.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $93.93 (2026-09-09, ~15-min delayed) |
| Market cap | $3.67B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +33.10%; price -2.71% vs SMA200. |
| Fresh setup quality | Poor / broken | -36.35% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-41.00%). |
| Value attractiveness | Reasonable | Forward P/E 14.28, EV/Sales 3.46. |
| Risk level | High | Beta 1.94, ATR 4.5% of price, short float 11.83%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $93.93; 52w high $147.57 (-36.35%); 52w low $58.52 (+60.51%) |
| Trend | -2.71% vs SMA200, -13.64% vs SMA50, -5.51% vs SMA20 |
| Momentum | RSI(14) 38.4 (neutral) |
| Volatility | ATR(14) 4.21 (~4.5% of price); beta 1.94 |
| Setup perspective | -36.35% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 14.28, P/S 3.07, P/B 3.95 | EV/Sales 3.46, EV/EBITDA 44.60 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $130.33 (9 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 108.23% |
...
- **Volatility risk:** Beta 1.94, ATR 4.5% of price, short float 11.83%. Size positions accordingly.
...
|---|---|---|---|
| Price | $93.93 | EV/Sales | 3.46 |
| Market cap | $3.67B | EV/EBITDA | 44.60 |
| Beta | 1.94 | Gross margin | 44.72% |
| RSI(14) | 38.4 | Operating margin | -2.79% |
| ATR(14) | 4.21 | Profit margin | -41.00% |
| SMA20 dist | -5.51% | ROA | -1.52% |
| SMA50 dist | -13.64% | ROE | -42.23% |
| SMA200 dist | -2.71% | Revenue (ttm) | $1.20B |
| 52W high | $147.57 | Revenue growth y/y | 8.90% |
| 52W low | $58.52 | Inst. ownership | 108.23% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 14.28 | Short float | 11.83% |
| PEG (trailing) | — | Avg volume | 945,212 |
| P/S | 3.07 | Employees | 1,700 |
| P/B | 3.95 | Analyst rec (1=buy..5=sell) | — |
