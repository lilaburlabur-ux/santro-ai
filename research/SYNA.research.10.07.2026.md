...
Signed file: `SYNA.research.10.07.2026`

| Field | Value |
|---|---|
| Current price | $126.76 (2026-07-10, ~15-min delayed) |
| Market cap | $4.95B |
...
|---|---|---|
| Technical momentum | High | 1Y +83.74%; price +42.96% vs SMA200. |
| Fresh setup quality | Moderate / wait | -14.10% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Weak | Negative profit margin (-4.10%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 24.04, EV/Sales 4.67. |
| Risk level | High | Beta 1.98, ATR 7.1% of price, short float 18.89%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $126.76; 52w high $147.57 (-14.10%); 52w low $58.52 (+116.61%) |
| Trend | +42.96% vs SMA200, -0.21% vs SMA50, -2.12% vs SMA20 |
| Momentum | RSI(14) 49.7 (neutral) |
| Volatility | ATR(14) 8.94 (~7.1% of price); beta 1.98 |
| Setup perspective | -14.10% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E 24.04, P/S 4.22, P/B 3.61 | EV/Sales 4.67, EV/EBITDA 62.19 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $145.33 (9 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 110.36% |
...
- **Valuation risk:** Forward P/E 24.04, EV/Sales 4.67. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.98, ATR 7.1% of price, short float 18.89%. Size positions accordingly.
...
|---|---|---|---|
| Price | $126.76 | EV/Sales | 4.67 |
| Market cap | $4.95B | EV/EBITDA | 62.19 |
| Beta | 1.98 | Gross margin | 43.61% |
| RSI(14) | 49.7 | Operating margin | -4.32% |
| ATR(14) | 8.94 | Profit margin | -4.10% |
| SMA20 dist | -2.12% | ROA | -1.75% |
| SMA50 dist | -0.21% | ROE | -3.50% |
| SMA200 dist | +42.96% | Revenue (ttm) | $1.17B |
| 52W high | $147.57 | Revenue growth y/y | 10.40% |
| 52W low | $58.52 | Inst. ownership | 110.36% |
| P/E (ttm) | — | Insider ownership | 2.01% |
| Forward P/E | 24.04 | Short float | 18.89% |
| PEG (trailing) | — | Avg volume | 1,118,783 |
| P/S | 4.22 | Employees | 1,700 |
| P/B | 3.61 | Analyst rec (1=buy..5=sell) | 2.7 |
