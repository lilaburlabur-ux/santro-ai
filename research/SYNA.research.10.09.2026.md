...
Signed file: `SYNA.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $93.47 (2026-09-10, ~15-min delayed) |
| Market cap | $3.66B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +33.68%; price -3.37% vs SMA200. |
| Fresh setup quality | Poor / broken | -36.66% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-41.00%). |
| Value attractiveness | Reasonable | Forward P/E 14.21, EV/Sales 3.42. |
| Risk level | High | Beta 1.94, ATR 4.4% of price, short float 11.83%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $93.47; 52w high $147.57 (-36.66%); 52w low $58.52 (+59.72%) |
| Trend | -3.37% vs SMA200, -13.58% vs SMA50, -5.18% vs SMA20 |
| Momentum | RSI(14) 37.9 (neutral) |
| Volatility | ATR(14) 4.11 (~4.4% of price); beta 1.94 |
| Setup perspective | -36.66% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 14.21, P/S 3.05, P/B 3.93 | EV/Sales 3.42, EV/EBITDA 44.07 |
...
- **Volatility risk:** Beta 1.94, ATR 4.4% of price, short float 11.83%. Size positions accordingly.
...
|---|---|---|---|
| Price | $93.47 | EV/Sales | 3.42 |
| Market cap | $3.66B | EV/EBITDA | 44.07 |
| Beta | 1.94 | Gross margin | 44.72% |
| RSI(14) | 37.9 | Operating margin | -2.79% |
| ATR(14) | 4.11 | Profit margin | -41.00% |
| SMA20 dist | -5.18% | ROA | -1.52% |
| SMA50 dist | -13.58% | ROE | -42.23% |
| SMA200 dist | -3.37% | Revenue (ttm) | $1.20B |
| 52W high | $147.57 | Revenue growth y/y | 8.90% |
| 52W low | $58.52 | Inst. ownership | 108.23% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 14.21 | Short float | 11.83% |
| PEG (trailing) | — | Avg volume | 944,750 |
| P/S | 3.05 | Employees | 1,700 |
| P/B | 3.93 | Analyst rec (1=buy..5=sell) | — |
