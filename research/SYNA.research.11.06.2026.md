...
Signed file: `SYNA.research.11.06.2026`

| Field | Value |
|---|---|
| Current price | $128.82 (2026-06-11, ~15-min delayed) |
| Market cap | $4.98B |
...
|---|---|---|
| Technical momentum | High | 1Y +100.16%; price +55.61% vs SMA200. |
| Fresh setup quality | Moderate / wait | -12.71% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Weak | Negative profit margin (-4.10%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 24.43, EV/Sales 4.65. |
| Risk level | High | Beta 1.96, ATR 7.5% of price, short float 19.77%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $128.82; 52w high $147.57 (-12.71%); 52w low $58.52 (+120.13%) |
| Trend | +55.61% vs SMA200, +20.42% vs SMA50, -4.33% vs SMA20 |
| Momentum | RSI(14) 51.7 (neutral) |
| Volatility | ATR(14) 9.68 (~7.5% of price); beta 1.96 |
| Setup perspective | -12.71% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E 24.43, P/S 4.25, P/B 3.67 | EV/Sales 4.65, EV/EBITDA 61.89 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $126.45 (11 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 110.17% |
...
- **Valuation risk:** Forward P/E 24.43, EV/Sales 4.65. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.96, ATR 7.5% of price, short float 19.77%. Size positions accordingly.
...
|---|---|---|---|
| Price | $128.82 | EV/Sales | 4.65 |
| Market cap | $4.98B | EV/EBITDA | 61.89 |
| Beta | 1.96 | Gross margin | 43.61% |
| RSI(14) | 51.7 | Operating margin | -4.32% |
| ATR(14) | 9.68 | Profit margin | -4.10% |
| SMA20 dist | -4.33% | ROA | -1.75% |
| SMA50 dist | +20.42% | ROE | -3.50% |
| SMA200 dist | +55.61% | Revenue (ttm) | $1.17B |
| 52W high | $147.57 | Revenue growth y/y | 10.40% |
| 52W low | $58.52 | Inst. ownership | 110.17% |
| P/E (ttm) | — | Insider ownership | 2.03% |
| Forward P/E | 24.43 | Short float | 19.77% |
| PEG (trailing) | — | Avg volume | 866,385 |
| P/S | 4.25 | Employees | 1,700 |
| P/B | 3.67 | Analyst rec (1=buy..5=sell) | — |
