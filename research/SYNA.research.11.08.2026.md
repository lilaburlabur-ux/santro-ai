...
Signed file: `SYNA.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $106.92 (2026-08-11, ~15-min delayed) |
| Market cap | $4.18B |
...
|---|---|---|
| Technical momentum | High | 1Y +68.32%; price +14.48% vs SMA200. |
| Fresh setup quality | Poor / broken | -27.55% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-41.00%). |
| Value attractiveness | Reasonable | Forward P/E 16.26, EV/Sales 3.72. |
| Risk level | High | Beta 1.96, ATR 6.0% of price, short float 14.96%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $106.92; 52w high $147.57 (-27.55%); 52w low $58.52 (+82.71%) |
| Trend | +14.48% vs SMA200, -12.82% vs SMA50, -3.45% vs SMA20 |
| Momentum | RSI(14) 43.9 (neutral) |
| Volatility | ATR(14) 6.42 (~6.0% of price); beta 1.96 |
| Setup perspective | -27.55% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 16.26, P/S 3.49, P/B 4.46 | EV/Sales 3.72, EV/EBITDA 60.65 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $130.33 (9 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 109.73% |
...
| Blackrock Inc. | 4,983,061 | 12.90% | 2026-06-30 |
| Vanguard Portfolio Management LLC | 2,663,664 | 6.89% | 2026-03-31 |
| State Street Corporation | 2,114,506 | 5.47% | 2026-06-30 |
...
- **Volatility risk:** Beta 1.96, ATR 6.0% of price, short float 14.96%. Size positions accordingly.
...
|---|---|---|---|
| Price | $106.92 | EV/Sales | 3.72 |
| Market cap | $4.18B | EV/EBITDA | 60.65 |
| Beta | 1.96 | Gross margin | 53.63% |
| RSI(14) | 43.9 | Operating margin | 7.86% |
| ATR(14) | 6.42 | Profit margin | -41.00% |
| SMA20 dist | -3.45% | ROA | 1.63% |
| SMA50 dist | -12.82% | ROE | -42.23% |
| SMA200 dist | +14.48% | Revenue (ttm) | $1.20B |
| 52W high | $147.57 | Revenue growth y/y | 8.90% |
| 52W low | $58.52 | Inst. ownership | 109.73% |
| P/E (ttm) | — | Insider ownership | 1.95% |
| Forward P/E | 16.26 | Short float | 14.96% |
| PEG (trailing) | — | Avg volume | 1,033,888 |
| P/S | 3.49 | Employees | 0 |
| P/B | 4.46 | Analyst rec (1=buy..5=sell) | 2.7 |
