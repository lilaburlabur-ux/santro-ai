...
Signed file: `SYNA.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $101.03 (2026-09-11, ~15-min delayed) |
| Market cap | $3.95B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +46.21%; price +4.25% vs SMA200. |
| Fresh setup quality | Poor / broken | -31.54% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-41.00%). |
| Value attractiveness | Reasonable | Forward P/E 15.36, EV/Sales 3.42. |
| Risk level | High | Beta 1.94, ATR 4.3% of price, short float 10.53%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $101.03; 52w high $147.57 (-31.54%); 52w low $58.52 (+72.64%) |
| Trend | +4.25% vs SMA200, -6.14% vs SMA50, +2.81% vs SMA20 |
| Momentum | RSI(14) 50.5 (neutral) |
| Volatility | ATR(14) 4.36 (~4.3% of price); beta 1.94 |
| Setup perspective | -31.54% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 15.36, P/S 3.30, P/B 4.25 | EV/Sales 3.42, EV/EBITDA 44.07 |
...
- **Volatility risk:** Beta 1.94, ATR 4.3% of price, short float 10.53%. Size positions accordingly.
...
|---|---|---|---|
| Price | $101.03 | EV/Sales | 3.42 |
| Market cap | $3.95B | EV/EBITDA | 44.07 |
| Beta | 1.94 | Gross margin | 44.72% |
| RSI(14) | 50.5 | Operating margin | -2.79% |
| ATR(14) | 4.36 | Profit margin | -41.00% |
| SMA20 dist | +2.81% | ROA | -1.52% |
| SMA50 dist | -6.14% | ROE | -42.23% |
| SMA200 dist | +4.25% | Revenue (ttm) | $1.20B |
| 52W high | $147.57 | Revenue growth y/y | 8.90% |
| 52W low | $58.52 | Inst. ownership | 108.16% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 15.36 | Short float | 10.53% |
| PEG (trailing) | — | Avg volume | 933,954 |
| P/S | 3.30 | Employees | 1,700 |
| P/B | 4.25 | Analyst rec (1=buy..5=sell) | — |
