...
Signed file: `SYNA.research.13.07.2026`

| Field | Value |
|---|---|
| Current price | $119.15 (2026-07-13, ~15-min delayed) |
| Market cap | $4.65B |
...
|---|---|---|
| Technical momentum | High | 1Y +71.24%; price +34.02% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 22.60, EV/Sales 4.58. |
| Risk level | High | Beta 1.98, ATR 7.5% of price, short float 16.64%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $119.15; 52w high $147.57 (-19.26%); 52w low $58.52 (+103.61%) |
| Trend | +34.02% vs SMA200, -6.65% vs SMA50, -7.39% vs SMA20 |
| Momentum | RSI(14) 44.5 (neutral) |
| Volatility | ATR(14) 8.91 (~7.5% of price); beta 1.98 |
...
| Valuation | P/E —, forward P/E 22.60, P/S 3.97, P/B 3.40 | EV/Sales 4.58, EV/EBITDA 60.98 |
...
- **Valuation risk:** Forward P/E 22.60, EV/Sales 4.58. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.98, ATR 7.5% of price, short float 16.64%. Size positions accordingly.
...
|---|---|---|---|
| Price | $119.15 | EV/Sales | 4.58 |
| Market cap | $4.65B | EV/EBITDA | 60.98 |
| Beta | 1.98 | Gross margin | 43.61% |
| RSI(14) | 44.5 | Operating margin | -4.32% |
| ATR(14) | 8.91 | Profit margin | -4.10% |
| SMA20 dist | -7.39% | ROA | -1.75% |
| SMA50 dist | -6.65% | ROE | -3.50% |
| SMA200 dist | +34.02% | Revenue (ttm) | $1.17B |
| 52W high | $147.57 | Revenue growth y/y | 10.40% |
| 52W low | $58.52 | Inst. ownership | 110.40% |
| P/E (ttm) | — | Insider ownership | 2.01% |
| Forward P/E | 22.60 | Short float | 16.64% |
| PEG (trailing) | — | Avg volume | 1,126,114 |
| P/S | 3.97 | Employees | 1,700 |
| P/B | 3.40 | Analyst rec (1=buy..5=sell) | 2.7 |
