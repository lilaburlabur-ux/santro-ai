...
Signed file: `SYNA.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $95.06 (2026-09-14, ~15-min delayed) |
| Market cap | $3.72B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +33.06%; price -2.06% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 14.45, EV/Sales 3.66. |
| Risk level | High | Beta 1.94, ATR 4.7% of price, short float 10.53%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $95.06; 52w high $147.57 (-35.58%); 52w low $58.52 (+62.44%) |
| Trend | -2.06% vs SMA200, -11.29% vs SMA50, -2.59% vs SMA20 |
| Momentum | RSI(14) 43.1 (neutral) |
| Volatility | ATR(14) 4.50 (~4.7% of price); beta 1.94 |
...
| Valuation | P/E —, forward P/E 14.45, P/S 3.11, P/B 3.99 | EV/Sales 3.66, EV/EBITDA 47.26 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $130.33 (9 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 108.02% |
...
- **Volatility risk:** Beta 1.94, ATR 4.7% of price, short float 10.53%. Size positions accordingly.
...
|---|---|---|---|
| Price | $95.06 | EV/Sales | 3.66 |
| Market cap | $3.72B | EV/EBITDA | 47.26 |
| Beta | 1.94 | Gross margin | 44.72% |
| RSI(14) | 43.1 | Operating margin | -2.79% |
| ATR(14) | 4.50 | Profit margin | -41.00% |
| SMA20 dist | -2.59% | ROA | -1.52% |
| SMA50 dist | -11.29% | ROE | -42.23% |
| SMA200 dist | -2.06% | Revenue (ttm) | $1.20B |
| 52W high | $147.57 | Revenue growth y/y | 8.90% |
| 52W low | $58.52 | Inst. ownership | 108.02% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 14.45 | Short float | 10.53% |
| PEG (trailing) | — | Avg volume | 934,225 |
| P/S | 3.11 | Employees | 1,700 |
| P/B | 3.99 | Analyst rec (1=buy..5=sell) | — |
