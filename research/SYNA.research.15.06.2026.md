...
Signed file: `SYNA.research.15.06.2026`

| Field | Value |
|---|---|
| Current price | $140.23 (2026-06-15, ~15-min delayed) |
| Market cap | $5.42B |
...
|---|---|---|
| Technical momentum | High | 1Y +118.63%; price +67.34% vs SMA200. |
| Fresh setup quality | Watch | -4.97% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Weak | Negative profit margin (-4.10%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 26.59, EV/Sales 4.97. |
| Risk level | High | Beta 1.96, ATR 6.5% of price, short float 19.77%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $140.23; 52w high $147.57 (-4.97%); 52w low $58.52 (+139.63%) |
| Trend | +67.34% vs SMA200, +26.40% vs SMA50, +3.16% vs SMA20 |
| Momentum | RSI(14) 58.2 (neutral) |
| Volatility | ATR(14) 9.14 (~6.5% of price); beta 1.96 |
| Setup perspective | -4.97% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E —, forward P/E 26.59, P/S 4.62, P/B 4.00 | EV/Sales 4.97, EV/EBITDA 66.11 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $129.64 (11 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 110.19% |
...
- **Valuation risk:** Forward P/E 26.59, EV/Sales 4.97. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.96, ATR 6.5% of price, short float 19.77%. Size positions accordingly.
...
|---|---|---|---|
| Price | $140.23 | EV/Sales | 4.97 |
| Market cap | $5.42B | EV/EBITDA | 66.11 |
| Beta | 1.96 | Gross margin | 43.61% |
| RSI(14) | 58.2 | Operating margin | -4.32% |
| ATR(14) | 9.14 | Profit margin | -4.10% |
| SMA20 dist | +3.16% | ROA | -1.75% |
| SMA50 dist | +26.40% | ROE | -3.50% |
| SMA200 dist | +67.34% | Revenue (ttm) | $1.17B |
| 52W high | $147.57 | Revenue growth y/y | 10.40% |
| 52W low | $58.52 | Inst. ownership | 110.19% |
| P/E (ttm) | — | Insider ownership | 2.03% |
| Forward P/E | 26.59 | Short float | 19.77% |
| PEG (trailing) | — | Avg volume | 876,644 |
| P/S | 4.62 | Employees | 1,700 |
| P/B | 4.00 | Analyst rec (1=buy..5=sell) | 1.7 |
