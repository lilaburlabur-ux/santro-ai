...
Signed file: `SYNA.research.15.07.2026`

| Field | Value |
|---|---|
| Current price | $121.59 (2026-07-15, ~15-min delayed) |
| Market cap | $4.75B |
...
|---|---|---|
| Technical momentum | High | 1Y +80.03%; price +35.97% vs SMA200. |
| Fresh setup quality | Moderate / wait | -17.61% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Weak | Negative profit margin (-4.10%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 23.06, EV/Sales 4.46. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $121.59; 52w high $147.57 (-17.61%); 52w low $58.52 (+107.78%) |
| Trend | +35.97% vs SMA200, -5.54% vs SMA50, -4.22% vs SMA20 |
| Momentum | RSI(14) 46.5 (neutral) |
| Volatility | ATR(14) 8.47 (~7.0% of price); beta 1.98 |
| Setup perspective | -17.61% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E 23.06, P/S 4.05, P/B 3.47 | EV/Sales 4.46, EV/EBITDA 59.27 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $145.33 (9 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 110.45% |
...
- **Valuation risk:** Forward P/E 23.06, EV/Sales 4.46. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $121.59 | EV/Sales | 4.46 |
| Market cap | $4.75B | EV/EBITDA | 59.27 |
| Beta | 1.98 | Gross margin | 43.61% |
| RSI(14) | 46.5 | Operating margin | -4.32% |
| ATR(14) | 8.47 | Profit margin | -4.10% |
| SMA20 dist | -4.22% | ROA | -1.75% |
| SMA50 dist | -5.54% | ROE | -3.50% |
| SMA200 dist | +35.97% | Revenue (ttm) | $1.17B |
| 52W high | $147.57 | Revenue growth y/y | 10.40% |
| 52W low | $58.52 | Inst. ownership | 110.45% |
| P/E (ttm) | — | Insider ownership | 2.01% |
| Forward P/E | 23.06 | Short float | 16.64% |
| PEG (trailing) | — | Avg volume | 1,125,463 |
| P/S | 4.05 | Employees | 1,700 |
| P/B | 3.47 | Analyst rec (1=buy..5=sell) | 2.7 |
