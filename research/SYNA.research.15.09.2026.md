...
Signed file: `SYNA.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $97.32 (2026-09-15, ~15-min delayed) |
| Market cap | $3.81B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +38.30%; price +0.11% vs SMA200. |
| Fresh setup quality | Poor / broken | -34.05% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-41.00%). |
| Value attractiveness | Reasonable | Forward P/E 14.80, EV/Sales 3.47. |
| Risk level | High | Beta 1.94, ATR 4.6% of price, short float 10.53%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $97.32; 52w high $147.57 (-34.05%); 52w low $58.52 (+66.30%) |
| Trend | +0.11% vs SMA200, -8.72% vs SMA50, +0.41% vs SMA20 |
| Momentum | RSI(14) 46.3 (neutral) |
| Volatility | ATR(14) 4.49 (~4.6% of price); beta 1.94 |
| Setup perspective | -34.05% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 14.80, P/S 3.18, P/B 4.09 | EV/Sales 3.47, EV/EBITDA 44.74 |
...
- **Volatility risk:** Beta 1.94, ATR 4.6% of price, short float 10.53%. Size positions accordingly.
...
|---|---|---|---|
| Price | $97.32 | EV/Sales | 3.47 |
| Market cap | $3.81B | EV/EBITDA | 44.74 |
| Beta | 1.94 | Gross margin | 44.72% |
| RSI(14) | 46.3 | Operating margin | -2.79% |
| ATR(14) | 4.49 | Profit margin | -41.00% |
| SMA20 dist | +0.41% | ROA | -1.52% |
| SMA50 dist | -8.72% | ROE | -42.23% |
| SMA200 dist | +0.11% | Revenue (ttm) | $1.20B |
| 52W high | $147.57 | Revenue growth y/y | 8.90% |
| 52W low | $58.52 | Inst. ownership | 108.16% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 14.80 | Short float | 10.53% |
| PEG (trailing) | — | Avg volume | 932,958 |
| P/S | 3.18 | Employees | 1,700 |
| P/B | 4.09 | Analyst rec (1=buy..5=sell) | — |
