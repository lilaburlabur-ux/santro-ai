...
Signed file: `SYNA.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $110.58 (2026-08-17, ~15-min delayed) |
| Market cap | $4.32B |
...
|---|---|---|
| Technical momentum | High | 1Y +62.55%; price +17.46% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 16.81, EV/Sales 3.91. |
| Risk level | High | Beta 1.96, ATR 5.3% of price, short float 12.52%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $110.58; 52w high $147.57 (-25.07%); 52w low $58.52 (+88.96%) |
| Trend | +17.46% vs SMA200, -7.88% vs SMA50, +1.15% vs SMA20 |
| Momentum | RSI(14) 48.6 (neutral) |
| Volatility | ATR(14) 5.85 (~5.3% of price); beta 1.96 |
...
| Valuation | P/E —, forward P/E 16.81, P/S 3.61, P/B 4.65 | EV/Sales 3.91, EV/EBITDA 50.46 |
...
- **Volatility risk:** Beta 1.96, ATR 5.3% of price, short float 12.52%. Size positions accordingly.
...
|---|---|---|---|
| Price | $110.58 | EV/Sales | 3.91 |
| Market cap | $4.32B | EV/EBITDA | 50.46 |
| Beta | 1.96 | Gross margin | 44.72% |
| RSI(14) | 48.6 | Operating margin | -2.79% |
| ATR(14) | 5.85 | Profit margin | -41.00% |
| SMA20 dist | +1.15% | ROA | -1.52% |
| SMA50 dist | -7.88% | ROE | -42.23% |
| SMA200 dist | +17.46% | Revenue (ttm) | $1.20B |
| 52W high | $147.57 | Revenue growth y/y | 8.90% |
| 52W low | $58.52 | Inst. ownership | 107.91% |
| P/E (ttm) | — | Insider ownership | 1.95% |
| Forward P/E | 16.81 | Short float | 12.52% |
| PEG (trailing) | — | Avg volume | 998,725 |
| P/S | 3.61 | Employees | 1,700 |
| P/B | 4.65 | Analyst rec (1=buy..5=sell) | 2.7 |
