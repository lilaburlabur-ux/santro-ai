...
Signed file: `SYNA.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $91.12 (2026-09-17, ~15-min delayed) |
| Market cap | $3.62B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +25.80%; price -6.48% vs SMA200. |
| Fresh setup quality | Poor / broken | -38.25% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-41.00%). |
| Value attractiveness | Reasonable | Forward P/E 13.85, EV/Sales 3.34. |
| Risk level | High | Beta 1.94, ATR 5.4% of price, short float 10.53%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $91.12; 52w high $147.57 (-38.25%); 52w low $58.52 (+55.71%) |
| Trend | -6.48% vs SMA200, -13.52% vs SMA50, -4.74% vs SMA20 |
| Momentum | RSI(14) 40.7 (neutral) |
| Volatility | ATR(14) 4.93 (~5.4% of price); beta 1.94 |
| Setup perspective | -38.25% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 13.85, P/S 3.02, P/B 3.83 | EV/Sales 3.34, EV/EBITDA 43.08 |
...
- **Volatility risk:** Beta 1.94, ATR 5.4% of price, short float 10.53%. Size positions accordingly.
...
|---|---|---|---|
| Price | $91.12 | EV/Sales | 3.34 |
| Market cap | $3.62B | EV/EBITDA | 43.08 |
| Beta | 1.94 | Gross margin | 44.72% |
| RSI(14) | 40.7 | Operating margin | -2.79% |
| ATR(14) | 4.93 | Profit margin | -41.00% |
| SMA20 dist | -4.74% | ROA | -1.52% |
| SMA50 dist | -13.52% | ROE | -42.23% |
| SMA200 dist | -6.48% | Revenue (ttm) | $1.20B |
| 52W high | $147.57 | Revenue growth y/y | 8.90% |
| 52W low | $58.52 | Inst. ownership | 106.57% |
| P/E (ttm) | — | Insider ownership | 1.18% |
| Forward P/E | 13.85 | Short float | 10.53% |
| PEG (trailing) | — | Avg volume | 942,095 |
| P/S | 3.02 | Employees | 1,700 |
| P/B | 3.83 | Analyst rec (1=buy..5=sell) | — |
