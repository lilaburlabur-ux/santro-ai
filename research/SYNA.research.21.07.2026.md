...
Signed file: `SYNA.research.21.07.2026`

| Field | Value |
|---|---|
| Current price | $119.32 (2026-07-21, ~15-min delayed) |
| Market cap | $4.66B |
...
|---|---|---|
| Technical momentum | High | 1Y +80.19%; price +32.04% vs SMA200. |
| Fresh setup quality | Moderate / wait | -19.14% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Weak | Negative profit margin (-4.10%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 22.63, EV/Sales 4.15. |
| Risk level | High | Beta 1.98, ATR 6.6% of price, short float 16.64%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $119.32; 52w high $147.57 (-19.14%); 52w low $58.52 (+103.90%) |
| Trend | +32.04% vs SMA200, -7.94% vs SMA50, -2.53% vs SMA20 |
| Momentum | RSI(14) 46.5 (neutral) |
| Volatility | ATR(14) 7.86 (~6.6% of price); beta 1.98 |
| Setup perspective | -19.14% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E 22.63, P/S 3.98, P/B 3.40 | EV/Sales 4.15, EV/EBITDA 55.21 |
...
- **Valuation risk:** Forward P/E 22.63, EV/Sales 4.15. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.98, ATR 6.6% of price, short float 16.64%. Size positions accordingly.
...
|---|---|---|---|
| Price | $119.32 | EV/Sales | 4.15 |
| Market cap | $4.66B | EV/EBITDA | 55.21 |
| Beta | 1.98 | Gross margin | 43.61% |
| RSI(14) | 46.5 | Operating margin | -4.32% |
| ATR(14) | 7.86 | Profit margin | -4.10% |
| SMA20 dist | -2.53% | ROA | -1.75% |
| SMA50 dist | -7.94% | ROE | -3.50% |
| SMA200 dist | +32.04% | Revenue (ttm) | $1.17B |
| 52W high | $147.57 | Revenue growth y/y | 10.40% |
| 52W low | $58.52 | Inst. ownership | 110.38% |
| P/E (ttm) | — | Insider ownership | 2.01% |
| Forward P/E | 22.63 | Short float | 16.64% |
| PEG (trailing) | — | Avg volume | 1,117,095 |
| P/S | 3.98 | Employees | 1,700 |
| P/B | 3.40 | Analyst rec (1=buy..5=sell) | — |
