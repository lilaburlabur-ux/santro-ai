...
Signed file: `SYNA.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $97.66 (2026-08-21, ~15-min delayed) |
| Market cap | $3.82B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +46.29%; price +3.08% vs SMA200. |
| Fresh setup quality | Poor / broken | -33.82% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-41.00%). |
| Value attractiveness | Reasonable | Forward P/E 14.85, EV/Sales 3.56. |
| Risk level | High | Beta 1.96, ATR 5.7% of price, short float 12.52%. |
...
|---|---|---|
| Synaptics CFO Resigns, Company Skips Successor Search Before Merger | Benzinga | 2026-08-21 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $97.66; 52w high $147.57 (-33.82%); 52w low $58.52 (+66.88%) |
| Trend | +3.08% vs SMA200, -17.02% vs SMA50, -7.76% vs SMA20 |
| Momentum | RSI(14) 36.7 (neutral) |
| Volatility | ATR(14) 5.60 (~5.7% of price); beta 1.96 |
| Setup perspective | -33.82% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 14.85, P/S 3.19, P/B 4.10 | EV/Sales 3.56, EV/EBITDA 45.98 |
...
- **Volatility risk:** Beta 1.96, ATR 5.7% of price, short float 12.52%. Size positions accordingly.
...
|---|---|---|---|
| Price | $97.66 | EV/Sales | 3.56 |
| Market cap | $3.82B | EV/EBITDA | 45.98 |
| Beta | 1.96 | Gross margin | 44.72% |
| RSI(14) | 36.7 | Operating margin | -2.79% |
| ATR(14) | 5.60 | Profit margin | -41.00% |
| SMA20 dist | -7.76% | ROA | -1.52% |
| SMA50 dist | -17.02% | ROE | -42.23% |
| SMA200 dist | +3.08% | Revenue (ttm) | $1.20B |
| 52W high | $147.57 | Revenue growth y/y | 8.90% |
| 52W low | $58.52 | Inst. ownership | 108.38% |
| P/E (ttm) | — | Insider ownership | 2.20% |
| Forward P/E | 14.85 | Short float | 12.52% |
| PEG (trailing) | — | Avg volume | 959,829 |
| P/S | 3.19 | Employees | 1,700 |
| P/B | 4.10 | Analyst rec (1=buy..5=sell) | 2.7 |
