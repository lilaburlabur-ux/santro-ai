...
Signed file: `SYNA.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $95.36 (2026-09-21, ~15-min delayed) |
| Market cap | $3.79B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +28.26%; price -2.38% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 14.50, EV/Sales 3.40. |
| Risk level | High | Beta 1.94, ATR 5.0% of price, short float 10.53%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $95.36; 52w high $147.57 (-35.38%); 52w low $58.52 (+62.95%) |
| Trend | -2.38% vs SMA200, -8.32% vs SMA50, +0.07% vs SMA20 |
| Momentum | RSI(14) 46.5 (neutral) |
| Volatility | ATR(14) 4.81 (~5.0% of price); beta 1.94 |
| Setup perspective | -35.38% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 14.50, P/S 3.16, P/B 4.01 | EV/Sales 3.40, EV/EBITDA 43.92 |
...
- **Volatility risk:** Beta 1.94, ATR 5.0% of price, short float 10.53%. Size positions accordingly.
...
|---|---|---|---|
| Price | $95.36 | EV/Sales | 3.40 |
| Market cap | $3.79B | EV/EBITDA | 43.92 |
| Beta | 1.94 | Gross margin | 44.72% |
| RSI(14) | 46.5 | Operating margin | -2.79% |
| ATR(14) | 4.81 | Profit margin | -41.00% |
| SMA20 dist | +0.07% | ROA | -1.52% |
| SMA50 dist | -8.32% | ROE | -42.23% |
| SMA200 dist | -2.38% | Revenue (ttm) | $1.20B |
| 52W high | $147.57 | Revenue growth y/y | 8.90% |
| 52W low | $58.52 | Inst. ownership | 106.57% |
| P/E (ttm) | — | Insider ownership | 0.84% |
| Forward P/E | 14.50 | Short float | 10.53% |
| PEG (trailing) | — | Avg volume | 936,477 |
| P/S | 3.16 | Employees | 1,700 |
| P/B | 4.01 | Analyst rec (1=buy..5=sell) | — |
