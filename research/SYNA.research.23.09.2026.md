...
Signed file: `SYNA.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $98.10 (2026-09-23, ~15-min delayed) |
| Market cap | $3.89B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +36.59%; price +0.31% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 14.91, EV/Sales 3.57. |
| Risk level | High | Beta 1.94, ATR 4.8% of price, short float 10.53%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $98.10; 52w high $147.57 (-33.52%); 52w low $58.52 (+67.63%) |
| Trend | +0.31% vs SMA200, -5.30% vs SMA50, +2.71% vs SMA20 |
| Momentum | RSI(14) 50.0 (neutral) |
| Volatility | ATR(14) 4.70 (~4.8% of price); beta 1.94 |
...
| Valuation | P/E —, forward P/E 14.91, P/S 3.25, P/B 4.12 | EV/Sales 3.57, EV/EBITDA 46.02 |
...
- **Volatility risk:** Beta 1.94, ATR 4.8% of price, short float 10.53%. Size positions accordingly.
...
|---|---|---|---|
| Price | $98.10 | EV/Sales | 3.57 |
| Market cap | $3.89B | EV/EBITDA | 46.02 |
| Beta | 1.94 | Gross margin | 44.72% |
| RSI(14) | 50.0 | Operating margin | -2.79% |
| ATR(14) | 4.70 | Profit margin | -41.00% |
| SMA20 dist | +2.71% | ROA | -1.52% |
| SMA50 dist | -5.30% | ROE | -42.23% |
| SMA200 dist | +0.31% | Revenue (ttm) | $1.20B |
| 52W high | $147.57 | Revenue growth y/y | 8.90% |
| 52W low | $58.52 | Inst. ownership | 106.57% |
| P/E (ttm) | — | Insider ownership | 0.83% |
| Forward P/E | 14.91 | Short float | 10.53% |
| PEG (trailing) | — | Avg volume | 933,693 |
| P/S | 3.25 | Employees | 1,700 |
| P/B | 4.12 | Analyst rec (1=buy..5=sell) | — |
