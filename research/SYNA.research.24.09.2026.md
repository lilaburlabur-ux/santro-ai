...
Signed file: `SYNA.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $96.82 (2026-09-24, ~15-min delayed) |
| Market cap | $3.84B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +32.59%; price -1.11% vs SMA200. |
| Fresh setup quality | Poor / broken | -34.39% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-41.00%). |
| Value attractiveness | Reasonable | Forward P/E 14.72, EV/Sales 3.52. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $96.82; 52w high $147.57 (-34.39%); 52w low $58.52 (+65.45%) |
| Trend | -1.11% vs SMA200, -6.06% vs SMA50, +1.27% vs SMA20 |
| Momentum | RSI(14) 48.4 (neutral) |
| Volatility | ATR(14) 4.60 (~4.7% of price); beta 1.94 |
| Setup perspective | -34.39% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 14.72, P/S 3.21, P/B 4.07 | EV/Sales 3.52, EV/EBITDA 45.48 |
...
|---|---|---|---|
| Price | $96.82 | EV/Sales | 3.52 |
| Market cap | $3.84B | EV/EBITDA | 45.48 |
| Beta | 1.94 | Gross margin | 44.72% |
| RSI(14) | 48.4 | Operating margin | -2.79% |
| ATR(14) | 4.60 | Profit margin | -41.00% |
| SMA20 dist | +1.27% | ROA | -1.52% |
| SMA50 dist | -6.06% | ROE | -42.23% |
| SMA200 dist | -1.11% | Revenue (ttm) | $1.20B |
| 52W high | $147.57 | Revenue growth y/y | 8.90% |
| 52W low | $58.52 | Inst. ownership | 106.59% |
| P/E (ttm) | — | Insider ownership | 0.83% |
| Forward P/E | 14.72 | Short float | 10.53% |
| PEG (trailing) | — | Avg volume | 928,622 |
| P/S | 3.21 | Employees | 1,700 |
| P/B | 4.07 | Analyst rec (1=buy..5=sell) | — |
