...
Signed file: `SYNA.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $102.72 (2026-09-25, ~15-min delayed) |
| Market cap | $4.08B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $102.72; 52w high $147.57 (-30.39%); 52w low $58.52 (+75.53%) |
| Trend | +4.68% vs SMA200, +0.38% vs SMA50, +7.04% vs SMA20 |
| Momentum | RSI(14) 55.9 (neutral) |
| Volatility | ATR(14) 4.60 (~4.5% of price); beta 1.94 |
| Setup perspective | -30.39% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 1.94, ATR 4.5% of price, short float 10.84%. Size positions accordingly.
...
| SMA20 dist | +7.04% | ROA | -1.52% |
| SMA50 dist | +0.38% | ROE | -42.23% |
| SMA200 dist | +4.68% | Revenue (ttm) | $1.20B |
| 52W high | $147.57 | Revenue growth y/y | 8.90% |
| 52W low | $58.52 | Inst. ownership | 106.59% |
| P/E (ttm) | — | Insider ownership | 0.83% |
| Forward P/E | 15.62 | Short float | 10.84% |
| PEG (trailing) | — | Avg volume | 918,171 |
| P/S | 3.41 | Employees | 1,700 |
| P/B | 4.32 | Analyst rec (1=buy..5=sell) | — |
