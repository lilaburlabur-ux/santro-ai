...
Signed file: `SYNA.research.27.08.2026`

| Field | Value |
|---|---|
| Current price | $95.70 (2026-08-27, ~15-min delayed) |
| Market cap | $3.74B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +35.96%; price +0.60% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 14.55, EV/Sales 3.49. |
| Risk level | High | Beta 1.96, ATR 5.2% of price, short float 11.83%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $95.70; 52w high $147.57 (-35.15%); 52w low $58.52 (+63.53%) |
| Trend | +0.60% vs SMA200, -16.85% vs SMA50, -7.57% vs SMA20 |
| Momentum | RSI(14) 36.6 (neutral) |
| Volatility | ATR(14) 5.00 (~5.2% of price); beta 1.96 |
...
| Valuation | P/E —, forward P/E 14.55, P/S 3.13, P/B 4.02 | EV/Sales 3.49, EV/EBITDA 45.01 |
...
- **Volatility risk:** Beta 1.96, ATR 5.2% of price, short float 11.83%. Size positions accordingly.
...
|---|---|---|---|
| Price | $95.70 | EV/Sales | 3.49 |
| Market cap | $3.74B | EV/EBITDA | 45.01 |
| Beta | 1.96 | Gross margin | 44.72% |
| RSI(14) | 36.6 | Operating margin | -2.79% |
| ATR(14) | 5.00 | Profit margin | -41.00% |
| SMA20 dist | -7.57% | ROA | -1.52% |
| SMA50 dist | -16.85% | ROE | -42.23% |
| SMA200 dist | +0.60% | Revenue (ttm) | $1.20B |
| 52W high | $147.57 | Revenue growth y/y | 8.90% |
| 52W low | $58.52 | Inst. ownership | 108.37% |
| P/E (ttm) | — | Insider ownership | 1.21% |
| Forward P/E | 14.55 | Short float | 11.83% |
| PEG (trailing) | — | Avg volume | 956,980 |
| P/S | 3.13 | Employees | 1,700 |
| P/B | 4.02 | Analyst rec (1=buy..5=sell) | — |
