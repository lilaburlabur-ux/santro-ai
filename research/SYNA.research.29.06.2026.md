...
Signed file: `SYNA.research.29.06.2026`

| Field | Value |
|---|---|
| Current price | $117.38 (2026-06-29, ~15-min delayed) |
| Market cap | $4.59B |
...
| Adobe downgraded, Roblox upgraded: Wall Street's top analyst calls | The Fly | 2026-06-29 |
| Company News for Jun 29, 2026 | Zacks | 2026-06-29 |
| Here Are Monday’s Best Wall Street Analyst Research Calls: Adobe, Applovin, Casey’s General Stores, CrowdStrike, Honeywell Aerospace, Salesforce, Synaptics, Terawulf, and More | 24/7 Wall St. | 2026-06-29 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $117.38; 52w high $147.57 (-20.46%); 52w low $58.52 (+100.58%) |
| Trend | +35.58% vs SMA200, -2.98% vs SMA50, -12.47% vs SMA20 |
| Momentum | RSI(14) 41.1 (neutral) |
| Volatility | ATR(14) 9.29 (~7.9% of price); beta 1.96 |
| Setup perspective | -20.46% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | -12.47% | ROA | -1.75% |
| SMA50 dist | -2.98% | ROE | -3.50% |
| SMA200 dist | +35.58% | Revenue (ttm) | $1.17B |
| 52W high | $147.57 | Revenue growth y/y | 10.40% |
| 52W low | $58.52 | Inst. ownership | 109.52% |
| P/E (ttm) | — | Insider ownership | 2.01% |
| Forward P/E | 22.26 | Short float | 18.89% |
| PEG (trailing) | — | Avg volume | 994,885 |
| P/S | 3.91 | Employees | 1,700 |
| P/B | 3.35 | Analyst rec (1=buy..5=sell) | 2.5 |
