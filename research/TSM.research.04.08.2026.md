...
Signed file: `TSM.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $417.17 (2026-08-04, ~15-min delayed) |
| Market cap | $2.16T |
...
|---|---|---|
| Technical momentum | High | 1Y +79.32%; price +16.81% vs SMA200. |
| Fresh setup quality | Moderate / wait | -12.65% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 49.92%, revenue growth 36.00%. |
| Value attractiveness | Reasonable | Forward P/E 19.31, EV/Sales 3.23. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $417.17; 52w high $477.57 (-12.65%); 52w low $224.84 (+85.54%) |
| Trend | +16.81% vs SMA200, -1.93% vs SMA50, +1.23% vs SMA20 |
| Momentum | RSI(14) 51.1 (neutral) |
| Volatility | ATR(14) 17.98 (~4.3% of price); beta 1.26 |
| Setup perspective | -12.65% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 36.82, forward P/E 19.31, P/S 0.49, P/B 87.00 | EV/Sales 3.23, EV/EBITDA 4.52 |
...
- **Volatility risk:** Beta 1.26, ATR 4.3% of price, short float 0.69%. Size positions accordingly.
...
|---|---|---|---|
| Price | $417.17 | EV/Sales | 3.23 |
| Market cap | $2.16T | EV/EBITDA | 4.52 |
| Beta | 1.26 | Gross margin | 64.23% |
| RSI(14) | 51.1 | Operating margin | 60.34% |
| ATR(14) | 17.98 | Profit margin | 49.92% |
| SMA20 dist | +1.23% | ROA | 19.01% |
| SMA50 dist | -1.93% | ROE | 39.97% |
| SMA200 dist | +16.81% | Revenue (ttm) | $4.44T |
| 52W high | $477.57 | Revenue growth y/y | 36.00% |
| 52W low | $224.84 | Inst. ownership | 15.48% |
| P/E (ttm) | 36.82 | Insider ownership | 0.04% |
| Forward P/E | 19.31 | Short float | 0.69% |
| PEG (trailing) | 0.98 | Avg volume | 14,444,350 |
| P/S | 0.49 | Employees | 76,907 |
| P/B | 87.00 | Analyst rec (1=buy..5=sell) | 1.4 |
