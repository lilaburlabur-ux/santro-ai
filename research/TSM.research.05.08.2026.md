...
Signed file: `TSM.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $414.00 (2026-08-05, ~15-min delayed) |
| Market cap | $2.15T |
...
|---|---|---|
| Taiwan Semiconductor Manufacturing (TSM) Eyes Faster 3 Nanometer Output, Is The Stock Expensive? | Simply Wall St. | 2026-08-05 |
| Sony's TSMC Sensor Venture Could Reshape Its Imaging Growth Story | Zacks | 2026-08-05 |
| Is TSMC (TSM) a Buy as Wall Street Analysts Look Optimistic? | Zacks | 2026-08-05 |
| Pinnacle West Capital Q2 Earnings Call Highlights | MarketBeat | 2026-08-05 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $414.00; 52w high $477.57 (-13.31%); 52w low $224.84 (+84.13%) |
| Trend | +15.73% vs SMA200, -2.72% vs SMA50, +0.75% vs SMA20 |
| Momentum | RSI(14) 49.9 (neutral) |
| Volatility | ATR(14) 17.64 (~4.3% of price); beta 1.26 |
...
| P/B | 86.34 | Analyst rec (1=buy..5=sell) | 1.4 |
