...
Signed file: `TSM.research.11.06.2026`

| Field | Value |
|---|---|
| Current price | $408.75 (2026-06-11, ~15-min delayed) |
| Market cap | $2.12T |
...
|---|---|---|
| Technical momentum | High | 1Y +99.91%; price +24.53% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 20.93, EV/Sales 3.58. |
| Risk level | Elevated | Beta 1.25, ATR 4.4% of price, short float 0.58%. |
...
|---|---|---|
| AI Stocks Underestimate the Technology’s Potential, Says This Tech Investor | Barrons.com | 2026-06-11 |
| Scoop: Republican lawmakers challenge TSMC's Washington clout | Axios | 2026-06-10 |
| Taiwan Semiconductor Sales Rise 30% In May, Remain On Target | Investor's Business Daily | 2026-06-10 |
| SoftBank tried to borrow $6B against its OpenAI stake — then shares plunged 9.7%. Is the AI boom running into reality? | Moneywise | 2026-06-10 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $408.75; 52w high $446.69 (-8.49%); 52w low $207.70 (+96.79%) |
| Trend | +24.53% vs SMA200, +3.50% vs SMA50, -2.03% vs SMA20 |
| Momentum | RSI(14) 48.3 (neutral) |
| Volatility | ATR(14) 18.16 (~4.4% of price); beta 1.25 |
...
| Valuation | P/E 35.09, forward P/E 20.93, P/S 0.52, P/B 62.53 | EV/Sales 3.58, EV/EBITDA 5.15 |
...
- **Valuation risk:** Forward P/E 20.93, EV/Sales 3.58. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.25, ATR 4.4% of price, short float 0.58%. Size positions accordingly.
...
|---|---|---|---|
| Price | $408.75 | EV/Sales | 3.58 |
| Market cap | $2.12T | EV/EBITDA | 5.15 |
| Beta | 1.25 | Gross margin | 61.87% |
| RSI(14) | 48.3 | Operating margin | 58.10% |
| ATR(14) | 18.16 | Profit margin | 46.51% |
| SMA20 dist | -2.03% | ROA | 17.32% |
| SMA50 dist | +3.50% | ROE | 36.21% |
| SMA200 dist | +24.53% | Revenue (ttm) | $4.10T |
| 52W high | $446.69 | Revenue growth y/y | 35.10% |
| 52W low | $207.70 | Inst. ownership | 15.64% |
| P/E (ttm) | 35.09 | Insider ownership | 0.04% |
| Forward P/E | 20.93 | Short float | 0.58% |
| PEG (trailing) | 1.27 | Avg volume | 13,662,382 |
| P/S | 0.52 | Employees | 76,907 |
| P/B | 62.53 | Analyst rec (1=buy..5=sell) | 1.5 |
