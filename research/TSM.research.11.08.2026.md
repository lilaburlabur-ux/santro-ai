...
Signed file: `TSM.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $422.06 (2026-08-11, ~15-min delayed) |
| Market cap | $2.19T |
...
|---|---|---|
| Technical momentum | High | 1Y +76.46%; price +17.15% vs SMA200. |
| Fresh setup quality | Moderate / wait | -11.62% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 49.92%, revenue growth 36.00%. |
| Value attractiveness | Reasonable | Forward P/E 19.39, EV/Sales 3.35. |
| Risk level | Elevated | Beta 1.26, ATR 3.8% of price, short float 0.69%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $422.06; 52w high $477.57 (-11.62%); 52w low $224.84 (+87.71%) |
| Trend | +17.15% vs SMA200, -0.85% vs SMA50, +3.14% vs SMA20 |
| Momentum | RSI(14) 53.1 (neutral) |
| Volatility | ATR(14) 15.86 (~3.8% of price); beta 1.26 |
| Setup perspective | -11.62% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 36.96, forward P/E 19.39, P/S 0.49, P/B 88.02 | EV/Sales 3.35, EV/EBITDA 4.68 |
...
- **Volatility risk:** Beta 1.26, ATR 3.8% of price, short float 0.69%. Size positions accordingly.
...
|---|---|---|---|
| Price | $422.06 | EV/Sales | 3.35 |
| Market cap | $2.19T | EV/EBITDA | 4.68 |
| Beta | 1.26 | Gross margin | 64.23% |
| RSI(14) | 53.1 | Operating margin | 60.34% |
| ATR(14) | 15.86 | Profit margin | 49.92% |
| SMA20 dist | +3.14% | ROA | 19.01% |
| SMA50 dist | -0.85% | ROE | 39.97% |
| SMA200 dist | +17.15% | Revenue (ttm) | $4.44T |
| 52W high | $477.57 | Revenue growth y/y | 36.00% |
| 52W low | $224.84 | Inst. ownership | 15.47% |
| P/E (ttm) | 36.96 | Insider ownership | 0.04% |
| Forward P/E | 19.39 | Short float | 0.69% |
| PEG (trailing) | 1.01 | Avg volume | 14,083,075 |
| P/S | 0.49 | Employees | 76,907 |
| P/B | 88.02 | Analyst rec (1=buy..5=sell) | 1.4 |
