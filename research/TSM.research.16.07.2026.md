...
Signed file: `TSM.research.16.07.2026`

| Field | Value |
|---|---|
| Current price | $409.74 (2026-07-16, ~15-min delayed) |
| Market cap | $2.13T |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $409.74; 52w high $477.57 (-14.20%); 52w low $224.84 (+82.23%) |
| Trend | +17.17% vs SMA200, -3.61% vs SMA50, -6.68% vs SMA20 |
| Momentum | RSI(14) 42.4 (neutral) |
| Volatility | ATR(14) 18.85 (~4.6% of price); beta 1.25 |
| Setup perspective | -14.20% from 52w high; no clean fresh pivot by default. |
...
- **Volatility risk:** Beta 1.25, ATR 4.6% of price, short float 0.57%. Size positions accordingly.
...
|---|---|---|---|
| Price | $409.74 | EV/Sales | 3.69 |
| Market cap | $2.13T | EV/EBITDA | 5.31 |
| Beta | 1.25 | Gross margin | 61.87% |
| RSI(14) | 42.4 | Operating margin | 58.10% |
| ATR(14) | 18.85 | Profit margin | 46.51% |
| SMA20 dist | -6.68% | ROA | 17.32% |
| SMA50 dist | -3.61% | ROE | 36.21% |
| SMA200 dist | +17.17% | Revenue (ttm) | $4.10T |
