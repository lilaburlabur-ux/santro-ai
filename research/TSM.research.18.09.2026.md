...
Signed file: `TSM.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $434.67 (2026-09-18, ~15-min delayed) |
| Market cap | $2.25T |
...
|---|---|---|
| Technical momentum | High | 1Y +67.16%; price +15.17% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 19.83, EV/Sales 3.48. |
| Risk level | Elevated | Beta 1.25, ATR 2.5% of price, short float 0.62%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $434.67; 52w high $476.29 (-8.74%); 52w low $262.10 (+65.84%) |
| Trend | +15.17% vs SMA200, +4.41% vs SMA50, +3.12% vs SMA20 |
| Momentum | RSI(14) 57.4 (neutral) |
| Volatility | ATR(14) 10.86 (~2.5% of price); beta 1.25 |
...
| Valuation | P/E 32.39, forward P/E 19.83, P/S 0.51, P/B 89.01 | EV/Sales 3.48, EV/EBITDA 4.88 |
...
- **Volatility risk:** Beta 1.25, ATR 2.5% of price, short float 0.62%. Size positions accordingly.
...
|---|---|---|---|
| Price | $434.67 | EV/Sales | 3.48 |
| Market cap | $2.25T | EV/EBITDA | 4.88 |
| Beta | 1.25 | Gross margin | 64.23% |
| RSI(14) | 57.4 | Operating margin | 60.34% |
| ATR(14) | 10.86 | Profit margin | 49.92% |
| SMA20 dist | +3.12% | ROA | 19.00% |
| SMA50 dist | +4.41% | ROE | 39.97% |
| SMA200 dist | +15.17% | Revenue (ttm) | $4.44T |
| 52W high | $476.29 | Revenue growth y/y | 36.00% |
| 52W low | $262.10 | Inst. ownership | 15.49% |
| P/E (ttm) | 32.39 | Insider ownership | 0.01% |
| Forward P/E | 19.83 | Short float | 0.62% |
| PEG (trailing) | 0.82 | Avg volume | 12,508,203 |
| P/S | 0.51 | Employees | 76,907 |
| P/B | 89.01 | Analyst rec (1=buy..5=sell) | 1.4 |
