...
Signed file: `TSM.research.22.07.2026`

| Field | Value |
|---|---|
| Current price | $421.21 (2026-07-22, ~15-min delayed) |
| Market cap | $2.18T |
...
|---|---|---|
| Technical momentum | High | 1Y +78.30%; price +19.55% vs SMA200. |
| Fresh setup quality | Moderate / wait | -11.80% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 49.92%, revenue growth 36.00%. |
| Value attractiveness | Reasonable | Forward P/E 19.78, EV/Sales 3.41. |
| Risk level | Elevated | Beta 1.25, ATR 4.4% of price, short float 0.57%. |
...
| Prediction: TSMC Stock Will Outperform the S&P 500 Over the Next Five Years | 24/7 Wall St. | 2026-07-22 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $421.21; 52w high $477.57 (-11.80%); 52w low $224.84 (+87.33%) |
| Trend | +19.55% vs SMA200, -0.96% vs SMA50, -2.38% vs SMA20 |
| Momentum | RSI(14) 48.3 (neutral) |
| Volatility | ATR(14) 18.37 (~4.4% of price); beta 1.25 |
| Setup perspective | -11.80% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 36.60, forward P/E 19.78, P/S 0.49, P/B 87.74 | EV/Sales 3.41, EV/EBITDA 4.76 |
| Growth expectations | Earnings growth 77.40%, EPS q/q 77.40% | Analyst mean target $527.26 (18 analysts) |
...
- **Volatility risk:** Beta 1.25, ATR 4.4% of price, short float 0.57%. Size positions accordingly.
...
|---|---|---|---|
| Price | $421.21 | EV/Sales | 3.41 |
| Market cap | $2.18T | EV/EBITDA | 4.76 |
| Beta | 1.25 | Gross margin | 64.23% |
| RSI(14) | 48.3 | Operating margin | 60.34% |
| ATR(14) | 18.37 | Profit margin | 49.92% |
| SMA20 dist | -2.38% | ROA | 19.01% |
| SMA50 dist | -0.96% | ROE | 39.97% |
| SMA200 dist | +19.55% | Revenue (ttm) | $4.44T |
| 52W high | $477.57 | Revenue growth y/y | 36.00% |
| 52W low | $224.84 | Inst. ownership | 15.55% |
| P/E (ttm) | 36.60 | Insider ownership | 0.04% |
| Forward P/E | 19.78 | Short float | 0.57% |
| PEG (trailing) | 1.07 | Avg volume | 14,246,508 |
| P/S | 0.49 | Employees | 76,907 |
| P/B | 87.74 | Analyst rec (1=buy..5=sell) | 1.4 |
