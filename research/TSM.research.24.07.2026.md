...
Signed file: `TSM.research.24.07.2026`

| Field | Value |
|---|---|
| Current price | $403.41 (2026-07-24, ~15-min delayed) |
| Market cap | $2.09T |
...
|---|---|---|
| Technical momentum | High | 1Y +69.71%; price +14.13% vs SMA200. |
| Fresh setup quality | Moderate / wait | -15.53% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 49.92%, revenue growth 36.00%. |
| Value attractiveness | Reasonable | Forward P/E 18.95, EV/Sales 3.32. |
| Risk level | Elevated | Beta 1.25, ATR 4.3% of price, short float 0.57%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $403.41; 52w high $477.57 (-15.53%); 52w low $224.84 (+79.42%) |
| Trend | +14.13% vs SMA200, -5.23% vs SMA50, -5.88% vs SMA20 |
| Momentum | RSI(14) 42.4 (neutral) |
| Volatility | ATR(14) 17.52 (~4.3% of price); beta 1.25 |
| Setup perspective | -15.53% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 35.42, forward P/E 18.95, P/S 0.47, P/B 84.03 | EV/Sales 3.32, EV/EBITDA 4.64 |
...
- **Volatility risk:** Beta 1.25, ATR 4.3% of price, short float 0.57%. Size positions accordingly.
...
|---|---|---|---|
| Price | $403.41 | EV/Sales | 3.32 |
| Market cap | $2.09T | EV/EBITDA | 4.64 |
| Beta | 1.25 | Gross margin | 64.23% |
| RSI(14) | 42.4 | Operating margin | 60.34% |
| ATR(14) | 17.52 | Profit margin | 49.92% |
| SMA20 dist | -5.88% | ROA | 19.01% |
| SMA50 dist | -5.23% | ROE | 39.97% |
| SMA200 dist | +14.13% | Revenue (ttm) | $4.44T |
| 52W high | $477.57 | Revenue growth y/y | 36.00% |
| 52W low | $224.84 | Inst. ownership | 15.55% |
| P/E (ttm) | 35.42 | Insider ownership | 0.04% |
| Forward P/E | 18.95 | Short float | 0.57% |
| PEG (trailing) | 1.06 | Avg volume | 14,041,481 |
| P/S | 0.47 | Employees | 76,907 |
| P/B | 84.03 | Analyst rec (1=buy..5=sell) | 1.4 |
