...
Signed file: `TSM.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $451.15 (2026-09-24, ~15-min delayed) |
| Market cap | $2.34T |
...
| TSMC Slips 1% as Packaging Moves Toward Supplier Validation | GuruFocus.com | 2026-09-24 |
| Trump, XI, and the Future of the AI Trade | Barrons.com | 2026-09-24 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $451.15; 52w high $476.29 (-5.28%); 52w low $270.37 (+66.86%) |
| Trend | +18.54% vs SMA200, +7.83% vs SMA50, +5.34% vs SMA20 |
| Momentum | RSI(14) 62.9 (neutral) |
| Volatility | ATR(14) 10.88 (~2.4% of price); beta 1.25 |
| Setup perspective | -5.28% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | +5.34% | ROA | 19.00% |
| SMA50 dist | +7.83% | ROE | 39.97% |
| SMA200 dist | +18.54% | Revenue (ttm) | $4.44T |
| 52W high | $476.29 | Revenue growth y/y | 36.00% |
| 52W low | $270.37 | Inst. ownership | 15.48% |
| P/E (ttm) | 33.57 | Insider ownership | 0.01% |
| Forward P/E | 20.58 | Short float | 0.62% |
| PEG (trailing) | 0.86 | Avg volume | 12,313,501 |
| P/S | 0.53 | Employees | 76,907 |
| P/B | 92.28 | Analyst rec (1=buy..5=sell) | 1.4 |
